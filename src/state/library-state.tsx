...
const CULTURE_EXTRA: LibraryEntry[] = [
  ...
  // ── French: Cardiology ────────────────────────────────────────────────────
  {
    ...
    available: true,
    sentences: [
      { en: "Good morning, Mr. Lefebvre. I have reviewed your electrocardiogram and I would like to discuss the results with you.", target: "Bonjour, monsieur Lefebvre. J'ai examiné votre électrocardiogramme et j'aimerais vous en expliquer les résultats." },
      { en: "Your ECG shows an irregular heart rhythm, which we call atrial fibrillation.", target: "Votre ECG montre un rythme cardiaque irrégulier, que l'on appelle fibrillation auriculaire." },
      { en: "This is a very common cardiac condition and there are several effective treatment options available.", target: "C'est une affection cardiaque très courante et il existe plusieurs options de traitement efficaces." },
      { en: "I am going to prescribe a medication called an anticoagulant to reduce the risk of blood clots.", target: "Je vais vous prescrire un médicament appelé anticoagulant pour réduire le risque de formation de caillots sanguins." },
      { en: "It is important that you take this medication every day at the same time.", target: "Il est important que vous preniez ce médicament tous les jours à la même heure." },
      { en: "I would also like to schedule an echocardiogram to assess your heart function more precisely.", target: "Je souhaite également programmer un échocardiogramme pour évaluer plus précisément la fonction de votre cœur." },
      { en: "Do you experience any chest pain, shortness of breath, or dizziness during physical activity?", target: "Ressentez-vous des douleurs thoraciques, un essoufflement ou des étourdissements lors d'une activité physique ?" },
      { en: "Your blood pressure today is slightly elevated — we will monitor this closely over the next few weeks.", target: "Votre tension artérielle est légèrement élevée aujourd'hui — nous la surveillerons de près au cours des prochaines semaines." },
      { en: "I recommend reducing your salt intake and avoiding alcohol while you are on this medication.", target: "Je vous recommande de réduire votre consommation de sel et d'éviter l'alcool pendant la durée de ce traitement." },
      { en: "Please come back for a follow-up appointment in four weeks, and call us immediately if you feel palpitations.", target: "Revenez pour une consultation de contrôle dans quatre semaines, et appelez-nous immédiatement si vous ressentez des palpitations." },
    ],
  },
  {
    ...
    available: true,
    sentences: [
      { en: "You have made excellent progress since your heart attack three weeks ago, and I am very pleased with your recovery.", target: "Vous avez fait d'excellents progrès depuis votre infarctus il y a trois semaines, et je suis très satisfait de votre rétablissement." },
      { en: "Cardiac rehabilitation will help you regain your strength and reduce the risk of a second cardiac event.", target: "La rééducation cardiaque vous aidera à retrouver vos forces et à réduire le risque d'un deuxième événement cardiaque." },
      { en: "The program consists of supervised exercise sessions three times per week for twelve weeks.", target: "Le programme comprend des séances d'exercice supervisées trois fois par semaine pendant douze semaines." },
      { en: "During each session, we will monitor your heart rate and blood pressure continuously.", target: "Lors de chaque séance, nous surveillerons votre fréquence cardiaque et votre tension artérielle en continu." },
      { en: "It is normal to feel some fatigue at the beginning — your heart muscle is healing and needs gradual conditioning.", target: "Il est normal de ressentir de la fatigue au début — votre muscle cardiaque guérit et a besoin d'un conditionnement progressif." },
      { en: "Your current medications include a beta-blocker, a statin, and aspirin — do not stop taking any of them without consulting me.", target: "Vos médicaments actuels comprennent un bêtabloquant, une statine et de l'aspirine — ne cessez jamais de les prendre sans me consulter." },
      { en: "A heart-healthy diet low in saturated fat and high in vegetables will support your recovery significantly.", target: "Une alimentation favorable à la santé cardiaque, pauvre en graisses saturées et riche en légumes, soutiendra considérablement votre rétablissement." },
      { en: "Your ejection fraction has improved from thirty-five percent to forty-two percent since your last echocardiogram.", target: "Votre fraction d'éjection est passée de trente-cinq pour cent à quarante-deux pour cent depuis votre dernier échocardiogramme." },
      { en: "If you experience chest pain, shortness of breath, or an irregular heartbeat during exercise, stop immediately and inform the nurse.", target: "Si vous ressentez une douleur thoracique, un essoufflement ou un rythme cardiaque irrégulier pendant l'effort, arrêtez immédiatement et prévenez l'infirmière." },
    ],
  },
  ...
  // ── French: OB-GYN ───────────────────────────────────────────────────────
  {
    ...
    available: true,
    sentences: [
      { en: "Congratulations on your pregnancy, madame. You are currently at ten weeks of gestation.", target: "Félicitations pour votre grossesse, madame. Vous êtes actuellement à dix semaines d'aménorrhée." },
      { en: "During this first trimester, it is normal to feel nausea, fatigue, and breast tenderness.", target: "Durant ce premier trimestre, il est normal de ressentir des nausées, de la fatigue et une sensibilité des seins." },
      { en: "I would like to schedule your first ultrasound for the twelfth week to confirm the due date.", target: "Je souhaite programmer votre première échographie à la douzième semaine pour confirmer la date d'accouchement prévue." },
      { en: "We will also order a blood panel today to check your iron levels, blood type, and screen for infections.", target: "Nous allons également prescrire un bilan sanguin aujourd'hui pour vérifier votre taux de fer, votre groupe sanguin et dépister d'éventuelles infections." },
      { en: "I recommend taking folic acid every day throughout the pregnancy to support the baby's neural development.", target: "Je vous recommande de prendre de l'acide folique chaque jour tout au long de la grossesse pour soutenir le développement neurologique du bébé." },
      { en: "Have you experienced any bleeding, cramping, or unusual discharge since you found out you were pregnant?", target: "Avez-vous eu des saignements, des crampes ou des pertes inhabituelles depuis que vous avez appris que vous étiez enceinte ?" },
      { en: "Your prenatal visits will be monthly until the seventh month, then every two weeks, and finally every week.", target: "Vos consultations prénatales se feront chaque mois jusqu'au septième mois, puis toutes les deux semaines, et enfin chaque semaine." },
      { en: "Please avoid alcohol, tobacco, and raw fish entirely during your pregnancy.", target: "Évitez totalement l'alcool, le tabac et les poissons crus pendant votre grossesse." },
      { en: "We also offer a prenatal preparation class at the clinic to help you prepare for labor and delivery.", target: "Nous proposons également des cours de préparation à l'accouchement à la clinique pour vous aider à vous préparer au travail et à l'accouchement." },
      { en: "Do not hesitate to call the maternity ward at any hour if you are worried — that is what we are here for.", target: "N'hésitez pas à appeler la maternité à toute heure si vous avez des inquiétudes — c'est pour cela que nous sommes là." },
    ],
  },
  {
    ...
    available: true,
    sentences: [
      { en: "You are now in active labor — your contractions are every five minutes and your cervix is six centimeters dilated.", target: "Vous êtes maintenant en travail actif — vos contractions surviennent toutes les cinq minutes et votre col est dilaté à six centimètres." },
      { en: "Would you like to discuss the option of an epidural for pain relief at this stage?", target: "Souhaitez-vous qu'on discute de l'option de la péridurale pour soulager la douleur à ce stade ?" },
      { en: "The fetal heart rate monitor shows that your baby is doing very well.", target: "Le moniteur de fréquence cardiaque fœtale montre que votre bébé se porte très bien." },
      { en: "When you feel the urge to push, breathe deeply and follow the midwife's guidance.", target: "Lorsque vous ressentez l'envie de pousser, respirez profondément et suivez les indications de la sage-femme." },
      { en: "Congratulations — your baby girl was born at 14:32 and weighs three kilograms two hundred grams.", target: "Félicitations — votre fille est née à 14 h 32 et pèse trois kilogrammes deux cents grammes." },
      { en: "We will place your baby on your chest for skin-to-skin contact immediately after birth.", target: "Nous placerons votre bébé sur votre poitrine pour un contact peau à peau immédiatement après la naissance." },
      { en: "Breastfeeding in the first hour after delivery is strongly encouraged and promotes maternal bonding.", target: "L'allaitement dans la première heure suivant l'accouchement est fortement encouragé et favorise le lien maternel." },
      { en: "I will check on you again this evening, and a pediatrician will examine the baby tomorrow morning.", target: "Je passerai vous voir ce soir, et un pédiatre examinera le bébé demain matin." },
      { en: "You will stay in the maternity ward for three days for monitoring before returning home.", target: "Vous resterez en maternité trois jours pour surveillance avant de rentrer à la maison." },
    ],
  },
  ...
  // ── French: K-12 Teacher ─────────────────────────────────────────────────
  {
    ...
    available: true,
    sentences: [
      { en: "Good morning, students! Welcome to class. Please take a seat and take out your notebooks.", target: "Bonjour, les élèves ! Bienvenue en cours. Veuillez vous asseoir et sortir vos cahiers." },
      { en: "My name is Madame Dupont, and I will be your French and literature teacher this year.", target: "Je m'appelle Madame Dupont, et je serai votre professeure de français et de littérature cette année." },
      { en: "Let me explain the classroom rules: respect your classmates, raise your hand before speaking, and arrive on time.", target: "Laissez-moi vous expliquer les règles de la classe : respectez vos camarades, levez la main avant de parler et arrivez à l'heure." },
      { en: "This semester we will read two novels, write four essays, and complete one oral presentation.", target: "Ce semestre, nous lirons deux romans, rédigerons quatre dissertations et réaliserons un exposé oral." },
      { en: "Homework is due at the beginning of each class — late work will lose one point per day.", target: "Les devoirs sont à rendre en début de cours — les travaux rendus en retard perdront un point par jour." },
      { en: "Is there anyone who needs special accommodations or has a learning plan we should be aware of?", target: "Y a-t-il des élèves qui ont besoin d'aménagements particuliers ou d'un plan personnalisé dont nous devrions être informés ?" },
      { en: "I encourage you to ask questions whenever you do not understand — there are no bad questions in this classroom.", target: "Je vous encourage à poser des questions dès que vous ne comprenez pas — il n'y a pas de mauvaises questions dans cette classe." },
      { en: "Our first lesson today will be a diagnostic exercise to help me understand what you already know.", target: "Notre première leçon aujourd'hui sera un exercice diagnostique pour m'aider à comprendre ce que vous savez déjà." },
      { en: "Please pair up with the student sitting next to you and introduce yourselves in two sentences.", target: "Faites équipe avec l'élève assis à côté de vous et présentez-vous en deux phrases." },
      { en: "I look forward to a wonderful year of learning together — your effort and curiosity are what matter most.", target: "Je me réjouis à l'idée d'une merveilleuse année d'apprentissage ensemble — votre effort et votre curiosité sont ce qui compte le plus." },
    ],
  },
  {
    ...
    available: true,
    sentences: [
      { en: "Thank you for coming in today, Madame Martin. I wanted to speak with you about Théo's progress.", target: "Merci d'être venue aujourd'hui, Madame Martin. Je souhaitais vous parler des progrès de Théo." },
      { en: "Théo is a very engaged student and his oral participation in class is excellent.", target: "Théo est un élève très impliqué et sa participation orale en classe est excellente." },
      { en: "However, I have noticed that he is struggling with written assignments and has missed three homework deadlines.", target: "Cependant, j'ai remarqué qu'il éprouve des difficultés avec les travaux écrits et a manqué trois délais pour ses devoirs." },
      { en: "Have you noticed any difficulties at home with reading or concentration?", target: "Avez-vous remarqué des difficultés à la maison en matière de lecture ou de concentration ?" },
      { en: "I would like to suggest a meeting with the school counselor to discuss whether additional support might be helpful.", target: "Je souhaite proposer une réunion avec le conseiller scolaire pour voir si un soutien supplémentaire pourrait être utile." },
      { en: "We also have a tutoring program available on Tuesdays and Thursdays after school, free of charge.", target: "Nous avons également un programme de tutorat disponible les mardis et jeudis après les cours, gratuitement." },
      { en: "Théo's grades in mathematics and science are strong — this shows he is capable of very good work.", target: "Les notes de Théo en mathématiques et en sciences sont solides — cela montre qu'il est capable d'un très bon travail." },
      { en: "With a little extra support in writing, I believe he can finish the semester with solid results.", target: "Avec un peu de soutien supplémentaire en rédaction, je crois qu'il peut terminer le semestre avec de bons résultats." },
      { en: "Please feel free to email me at any time if you have questions or concerns throughout the year.", target: "N'hésitez pas à m'envoyer un courriel à tout moment si vous avez des questions ou des préoccupations au cours de l'année." },
    ],
  },
  ...
  // ── French: International Travel ─────────────────────────────────────────
  {
    ...
    available: true,
    sentences: [
      { en: "Excuse me, could you tell me where gate F23 is, please?", target: "Excusez-moi, pourriez-vous m'indiquer où se trouve la porte F23, s'il vous plaît ?" },
      { en: "Your gate is at the end of terminal two — follow the signs for international departures.", target: "Votre porte se trouve au bout du terminal deux — suivez les panneaux pour les départs internationaux." },
      { en: "I would like to check in this suitcase and keep my carry-on bag with me.", target: "Je souhaite enregistrer cette valise et garder mon bagage à main avec moi." },
      { en: "I am sorry, but your bag exceeds the weight limit by three kilograms — there will be a surcharge of thirty euros.", target: "Je suis désolé, mais votre bagage dépasse la limite de poids de trois kilogrammes — il y aura un supplément de trente euros." },
      { en: "Do you have anything to declare at customs — food products, more than ten thousand euros in cash, or tobacco?", target: "Avez-vous quelque chose à déclarer à la douane — des produits alimentaires, plus de dix mille euros en espèces, ou du tabac ?" },
      { en: "No, I have nothing to declare. I am here on vacation for two weeks.", target: "Non, je n'ai rien à déclarer. Je suis ici en vacances pour deux semaines." },
      { en: "May I see your passport and boarding pass, please?", target: "Puis-je voir votre passeport et votre carte d'embarquement, s'il vous plaît ?" },
      { en: "My flight to Lyon is boarding in twenty minutes — I need to get to the gate quickly.", target: "Mon vol pour Lyon embarque dans vingt minutes — je dois rejoindre la porte rapidement." },
      { en: "The RER B train from the airport to the city center runs every fifteen minutes and takes about thirty-five minutes.", target: "Le RER B depuis l'aéroport jusqu'au centre-ville passe toutes les quinze minutes et prend environ trente-cinq minutes." },
      { en: "Have a pleasant journey, and welcome to France!", target: "Bon voyage, et bienvenue en France !" },
    ],
  },
  {
    ...
    available: true,
    sentences: [
      { en: "Good evening. I have a reservation under the name Johnson for three nights.", target: "Bonsoir. J'ai une réservation au nom de Johnson pour trois nuits." },
      { en: "Welcome, monsieur. I have found your reservation — you are in room 214 on the second floor.", target: "Bienvenue, monsieur. J'ai bien trouvé votre réservation — vous êtes dans la chambre 214 au deuxième étage." },
      { en: "Could I have a room that is quieter, away from the street? The noise bothers me.", target: "Pourrais-je avoir une chambre plus calme, loin de la rue ? Le bruit me dérange." },
      { en: "Of course — I can offer you room 318 at the back of the building, which overlooks the courtyard.", target: "Bien sûr — je peux vous proposer la chambre 318 à l'arrière du bâtiment, qui donne sur la cour intérieure." },
      { en: "Breakfast is served in the dining room from seven to ten o'clock every morning.", target: "Le petit-déjeuner est servi dans la salle à manger de sept heures à dix heures chaque matin." },
      { en: "Could you recommend a good restaurant nearby that is not too expensive?", target: "Pourriez-vous me recommander un bon restaurant à proximité qui ne soit pas trop cher ?" },
      { en: "I recommend Le Bistrot des Artistes, two streets from here — the set menu is excellent and very affordable.", target: "Je vous recommande Le Bistrot des Artistes, à deux rues d'ici — le menu du jour est excellent et très abordable." },
      { en: "To get to the Eiffel Tower, take line six on the metro from Trocadéro — it is about ten minutes.", target: "Pour aller à la Tour Eiffel, prenez la ligne six du métro depuis Trocadéro — c'est environ dix minutes." },
      { en: "Here is your key card. The Wi-Fi password is written on the back.", target: "Voici votre carte-clé. Le mot de passe Wi-Fi est inscrit au dos." },
      { en: "Please do not hesitate to contact reception at any time if you need anything.", target: "N'hésitez pas à contacter la réception à tout moment si vous avez besoin de quoi que ce soit." },
    ],
  },
];
...
const PAIN_MANAGEMENT_SEEDS: LibraryEntry[] = [
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target:
          "En una escala del cero al diez, ¿cómo calificaría su dolor en este momento?",
      },
      {
...
const FAMILY_MEDICINE_SEEDS: LibraryEntry[] = [
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target:
          "¿Está al día con su vacuna contra la influenza y su refuerzo contra el tétanos?",
      },
      {
        en: "I want to refer you to a cardiologist for a more detailed evaluation of your heart.",
        target:
          "Quiero referirlo a un cardiólogo para una evaluación más detallada de su corazón.",
      },
      {
  ...
  },
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target:
          "Vamos a comenzar con metformina; se toma dos veces al día con las comidas.",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "Buenas noches, ¡bienvenido! Me llamo Carlos y seré su mesero esta noche.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Nuestra cocina puede preparar la pasta sin gluten si lo necesita; sólo avíseme.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Cuando esté listo, puedo traerle la cuenta o ¿le gustaría ver el menú de postres?",
      },
      {
...
const SEEDS: LibraryEntry[] = [
  ...
  CULTURE_SEED,
  ...CULTURE_EXTRA,
  ...PAIN_MANAGEMENT_SEEDS,
  ...FAMILY_MEDICINE_SEEDS,
  ...CONSTRUCTION_SEEDS,
  ...RESTAURANT_SEEDS,
  ...(FAITH_SEEDS as LibraryEntry[]),
  ...(MEDICAL_A_SEEDS as LibraryEntry[]),
  ...(MEDICAL_B_SEEDS as LibraryEntry[]),
  ...(TRADES_SEEDS as LibraryEntry[]),
  ...(TRANSPORT_AGRI_SEEDS as LibraryEntry[]),
  ...(SERVICE_EDU_SEEDS as LibraryEntry[]),
  ...(SPORTS_A_SEEDS as LibraryEntry[]),
  ...(SPORTS_B_TRAVEL_SEEDS as LibraryEntry[]),
