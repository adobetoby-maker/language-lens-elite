...
import { Copy, RefreshCw, BookOpen, Sparkle, PenLine } from "lucide-react";
...
export function KanaPad() {
  ...
  return (
    <div className="fade-in mx-auto max-w-3xl space-y-6 py-4">
      ...
      {/* Top tabs: Converter / Writing Practice */}
