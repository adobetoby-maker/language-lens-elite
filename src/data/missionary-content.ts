...
export const MISSION_AREAS: MissionArea[] = [
  // North America
  { id: "utah", name: "Utah & Mountain West", region: "North America", languages: ["English", "Spanish"], cultureNote: "Heavy member presence; many part-member families and reactivation work." },
  { id: "us-northeast", name: "U.S. Northeast", region: "North America", languages: ["English", "Spanish", "Portuguese"], cultureNote: "Diverse urban populations; many immigrant communities." },
  { id: "us-southeast", name: "U.S. Southeast", region: "North America", languages: ["English", "Spanish"], cultureNote: "Strong Christian background; Bible-literate investigators." },
  { id: "us-west-coast", name: "U.S. West Coast", region: "North America", languages: ["English", "Spanish", "Mandarin", "Vietnamese"], cultureNote: "Highly secular; many language-specific branches." },
  { id: "canada", name: "Canada", region: "North America", languages: ["English", "French"], cultureNote: "Quebec missions teach in French; rest primarily English." },
  // Latin America
  { id: "mexico", name: "Mexico", region: "Latin America", languages: ["Spanish"], cultureNote: "Strong Catholic culture; family-centered teaching resonates deeply." },
  { id: "central-america", name: "Central America", region: "Latin America", languages: ["Spanish"], cultureNote: "Warm hospitality; door approaches usually welcomed." },
  { id: "brazil", name: "Brazil", region: "Latin America", languages: ["Portuguese"], cultureNote: "One of the largest mission fields; vibrant member culture." },
  { id: "south-america-south", name: "South America South", region: "Latin America", languages: ["Spanish"], cultureNote: "Argentina, Chile, Uruguay, Paraguay — strong member base." },
  { id: "south-america-northwest", name: "South America Northwest", region: "Latin America", languages: ["Spanish"], cultureNote: "Peru, Ecuador, Colombia, Bolivia, Venezuela — many Indigenous languages alongside Spanish." },
  // Europe
  { id: "europe-central", name: "Europe Central", region: "Europe", languages: ["German", "Czech", "Hungarian", "Polish"], cultureNote: "Highly secular; teaching often begins with belief in God." },
  { id: "europe-north", name: "Europe North", region: "Europe", languages: ["English", "Dutch", "Danish", "Swedish", "Norwegian", "Finnish"], cultureNote: "Reserved cultures; relationships built slowly." },
  { id: "europe-iberia", name: "Iberia & France", region: "Europe", languages: ["Spanish", "Portuguese", "French"], cultureNote: "Strong Catholic background; teaching the Restoration is central." },
  { id: "italy-greece", name: "Italy & Mediterranean", region: "Europe", languages: ["Italian", "Greek"], cultureNote: "Family-centered, Catholic-rooted; doors open through warmth." },
  // Africa
  { id: "africa-west", name: "Africa West", region: "Africa", languages: ["English", "French"], cultureNote: "Rapid Church growth; many investigators come prepared and eager." },
  { id: "africa-south-east", name: "Africa South / East", region: "Africa", languages: ["English", "Portuguese", "French"], cultureNote: "Mixed Anglophone / Lusophone areas; community-oriented teaching." },
  // Asia / Pacific
  { id: "philippines", name: "Philippines", region: "Asia / Pacific", languages: ["Tagalog", "Cebuano", "English"], cultureNote: "Warm, family-oriented; many local dialects in addition to Tagalog." },
  { id: "asia-east", name: "Asia (Japan/Korea/Taiwan)", region: "Asia / Pacific", languages: ["Japanese", "Korean", "Mandarin"], cultureNote: "Politeness levels and honorifics matter; teaching is patient and relational." },
  { id: "asia-southeast", name: "Southeast Asia", region: "Asia / Pacific", languages: ["Thai", "Khmer", "Vietnamese", "Indonesian"], cultureNote: "Buddhist majority in many areas; bridge to belief in a personal God." },
  { id: "pacific", name: "Pacific Islands", region: "Asia / Pacific", languages: ["English", "Samoan", "Tongan", "Tahitian", "Fijian"], cultureNote: "Deep member roots; many multi-generational LDS families." },
  { id: "australia-nz", name: "Australia & New Zealand", region: "Asia / Pacific", languages: ["English", "Maori"], cultureNote: "Mix of urban secular and Pacific Islander branches." },
];
