...
export const EM_AREAS: ModuleArea[] = [
  {
    ...
    name: "Triage",
    emoji: "🚑",
    blurb: "Rapid initial assessment — ESI level assignment, chief complaint, vitals, immediate interventions.",
    ...
    vocab: ["ESI level", "chief complaint", "tachycardic", "hypotensive", "diaphoretic", "altered mental status", "GCS", "mechanism of injury"],
    challenges: [
    ...
    sampleConversation: [
      { speaker: "ai", en: "Medic bringing in a 45-year-old male — chest pain, diaphoretic, started 20 minutes ago. BP 90/60, HR 112, O2 sat 94% on room air." },
      { speaker: "learner", en: "Activate the cath lab, get me a 12-lead now. Any radiation to the arm or jaw?" },
      { speaker: "ai", en: "He says it goes to his left arm. He's on aspirin and metoprolol at home." },
      { speaker: "learner", en: "Give 325 aspirin chewed, start oxygen, get a second IV. Room 1 — this is an ESI 1." },
    ],
  },
  {
    id: "resuscitation",
    ...
    toneNote: "Calm, authoritative, closed-loop communication. Name the person, state the task, confirm completion.",
    phrases: [
      { en: "Start CPR — I want compressions at 100 per minute, 2 inches deep.", intent: "Initiate CPR" },
      ...
      { en: "We have ROSC. Start a post-arrest protocol — targeted temperature, 12-lead, cath lab on standby.", intent: "Post-ROSC" },
    ],
    vocab: ["VF", "PEA", "asystole", "ROSC", "defibrillation", "epinephrine", "amiodarone", "compressions", "intubation", "closed-loop communication"],
    challenges: [
    ...
    sampleConversation: [
      { speaker: "learner", en: "Everyone listen up — I'm running this code. Start CPR. What time did arrest happen?" },
      { speaker: "ai", en: "CPR started two minutes ago. First rhythm check in 30 seconds." },
      { speaker: "learner", en: "James, you're on compressions. Sarah, I need IV access and push 1 mg epi. What's the rhythm on the monitor?" },
      { speaker: "ai", en: "Ventricular fibrillation." },
      { speaker: "learner", en: "Charge to 200. Everyone clear? Clear! Shock delivered. Resume CPR immediately." },
    ],
  },
  {
    id: "trauma",
    ...
    toneNote: "Rapid, ABCDE structured, all decisions communicated aloud. Surgeon is called when indicated — handoff is collaborative.",
    phrases: [
      ...
      { en: "Activate surgery — this is a positive FAST with hemodynamic instability.", intent: "Surgery handoff" },
      { en: "Get a trauma panel, type and cross, and portable CXR.", intent: "Labs and imaging" },
    ],
    vocab: ["primary survey", "ABCDE", "GCS", "FAST exam", "hemodynamic instability", "Morrison's pouch", "pneumothorax", "tension pneumo", "type and cross", "trauma panel"],
    challenges: [
    ...
    sampleConversation: [
      { speaker: "learner", en: "Starting primary survey. Airway open — he's speaking to me. Breath sounds equal. No tracheal deviation." },
      { speaker: "ai", en: "BP 88/60, HR 130. Two IVs in place, 1 liter NS running." },
      { speaker: "learner", en: "FAST exam — putting probe on Morrison's pouch now. There's fluid. Positive FAST." },
      { speaker: "ai", en: "Surgery is on the phone." },
      { speaker: "learner", en: "Tell them: 32-year-old MVC, hemodynamically unstable, positive FAST in Morrison's. I need them in the bay now." },
    ],
  },
  {
    ...
    emoji: "🔧",
    blurb: "RSI intubation, central line, chest tube, LP — obtaining consent, briefing the team, calling steps.",
    ...
    toneNote: "Brief, deliberate, safety-oriented. Call every step aloud. Confirm equipment before starting.",
    phrases: [
      { en: "I'm going to intubate — RSI. Give succinylcholine 1.5 mg per kilo and etomidate 0.3 mg per kilo.", intent: "RSI medications" },
      ...
      { en: "Confirm placement — capnography, bilateral breath sounds.", intent: "Tube confirmation" },
    ...
    vocab: ["RSI", "succinylcholine", "etomidate", "laryngoscopy", "capnography", "central line", "chest tube", "lumbar puncture", "time-out", "sterile field"],
    challenges: [
    ...
    sampleConversation: [
      { speaker: "learner", en: "We need to intubate. RSI protocol. Lisa — draw succinylcholine 100 mg and etomidate 20 mg." },
      { speaker: "ai", en: "Medications ready. Pre-oxygenation at 100% started." },
      { speaker: "learner", en: "Good. When I say go, push both meds. BVM team stays at the head in case I need a backup plan." },
      { speaker: "ai", en: "Pushing now. Cords visible on video laryngoscope." },
      { speaker: "learner", en: "Tube in. Inflate the cuff. Capnography — I need waveform confirmation." },
    ],
  },
  {
    ...
    emoji: "🗣️",
    blurb: "Explaining diagnoses, delivering bad news, discharge instructions in high-stakes ED encounters.",
    ...
    toneNote: "Direct but compassionate. Emergency patients are scared. Front-load the most important information. Use plain language.",
    phrases: [
      { en: "I have the results. I want to explain what we found.", intent: "Open bad news" },
      { en: "Your EKG shows a heart attack happening right now — we need to act fast.", intent: "STEMI disclosure" },
      { en: "I'm very sorry — we did everything we could.", intent: "Death notification" },
      { en: "You can go home today, but I need you to come back if any of these things happen:", intent: "Return precautions" },
    ...
    vocab: ["return precautions", "discharge instructions", "STEMI", "death notification", "informed consent", "capacity", "next of kin", "DNR/DNI"],
    challenges: [
    ...
    sampleConversation: [
      { speaker: "learner", en: "Mr. Garcia, I have your test results and I need to tell you something serious. Your EKG shows a heart attack happening right now." },
      { speaker: "ai", en: "Oh my God. Am I going to die?" },
      { speaker: "learner", en: "You came in at the right time. We're going to take you to the heart catheterization lab immediately to open the blocked artery. That's the best treatment we have." },
      { speaker: "ai", en: "Is my family here?" },
      { speaker: "learner", en: "We're calling them now. First I need your permission to proceed with this procedure. Every minute matters." },
    ],
  },
  {
    id: "handoffs",
    ...
    emoji: "🔄",
    blurb: "Admitting, transferring, or signing out patients — structured communication between teams.",
    ...
    toneNote: "SBAR format. Succinct, accurate, anticipate questions. 'Here is the patient, here is the plan, here is what worries me.'",
    phrases: [
      { en: "I have an admission for medicine — can I give you a quick SBAR?", intent: "Open admission call" },
      { en: "Situation: 68-year-old with CHF exacerbation, BNP 4,200, bilateral crackles.", intent: "S — Situation" },
      { en: "Background: known EF of 25%, last admission 3 months ago.", intent: "B — Background" },
      { en: "Assessment: acute decompensated heart failure, not in cardiogenic shock.", intent: "A — Assessment" },
      { en: "Recommendation: admit to telemetry, start IV diuresis, low-sodium diet.", intent: "R — Recommendation" },
      { en: "What I'm watching for: if he drops his pressure below 90, call me immediately.", intent: "Concern handoff" },
    ],
    vocab: ["SBAR", "admission", "disposition", "telemetry", "ICU", "transfer", "sign-out", "I-PASS", "pending results", "anticipatory guidance"],
    challenges: [
    ...
    sampleConversation: [
      { speaker: "learner", en: "Hi, it's Dr. Chen from the ED. I have an admission for you — quick SBAR?" },
      { speaker: "ai", en: "Go ahead." },
      { speaker: "learner", en: "68-year-old female, CHF exacerbation. BNP 4,200, O2 on 4L, bilateral crackles. EF is 25% at baseline." },
      { speaker: "ai", en: "What's her pressure and heart rate?" },
      { speaker: "learner", en: "BP 148/90, HR 88 — stable. Not in shock. I've started IV Lasix 80 mg already. She needs telemetry and diuresis continued." },
    ],
  },
];
