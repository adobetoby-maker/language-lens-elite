...
export function getPositionsForFormation(formation: string): FieldPosition[] {
  return SOCCER_POSITIONS.filter((p) =>
    p.formations.includes(formation as SoccerFormation),
  );
}
