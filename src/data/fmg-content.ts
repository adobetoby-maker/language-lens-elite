...
const roundsPresentationArea: FmgArea = {
  ...
  phrases: [
    {
      ...
      native: "El paciente es un hombre de 58 años con antecedentes de hipertensión y diabetes tipo 2 que consulta por dificultad respiratoria progresiva de tres días.",
    },
    {
      ...
      native: "En la revisión por sistemas, refiere fatiga e hinchazón en las piernas, pero niega fiebre, tos y dolor torácico.",
    },
    {
      ...
      native: "Los signos vitales son notables por una presión arterial de 168/92 y una saturación de oxígeno del 91% al aire ambiente.",
    },
    {
      ...
      native: "Al examen físico, el paciente se encuentra en dificultad respiratoria leve. En los pulmones se auscultan estertores bibasales. Hay edema con fóvea 2+ en ambos miembros inferiores.",
    },
    {
      ...
      native: "Mi evaluación es insuficiencia cardíaca descompensada aguda, probablemente desencadenada por transgresión dietética.",
    },
    {
      ...
      native: "Para el plan, quisiera iniciar furosemida IV, restringir líquidos a 1.5 litros por día y solicitar BNP y ecocardiograma de control.",
    },
    {
      ...
      native: "Haré seguimiento con cardiología y hablaré sobre los objetivos del tratamiento con el paciente y su familia.",
    },
    {
  ...
  vocab: [
    ...
    "physical exam", "assessment and plan", "vital signs", "bilateral",
    "pitting edema", "room air", "respiratory distress", "crackles",
    "differential diagnosis", "working diagnosis", "disposition",
  ],
  nativeGloss: {
  ...
  sampleConversation: [
    { speaker: "learner", en: "The patient is a 65-year-old female with a history of COPD and hypertension who presents with acute onset shortness of breath." },
    { speaker: "ai", en: "Good opening. I'd suggest adding when it started — 'acute onset this morning' gives me a timeline immediately. Try: '...who presents with acute onset shortness of breath that began this morning.' Go ahead with your physical exam findings." },
    { speaker: "learner", en: "She has decreased breath sounds on the right side. I think it could be pneumothorax." },
    { speaker: "ai", en: "That's the right instinct. Lead with the finding, then give your assessment: 'On exam, she has markedly decreased breath sounds on the right. My assessment is right-sided pneumothorax.' State the plan immediately after — attendings want assessment and plan together." },
  ],
};
...
const patientCommunicationArea: FmgArea = {
  ...
  phrases: [
    {
      ...
      native: "Hola, soy el Dr. [nombre], uno de los residentes que lo está atendiendo. ¿Cómo se siente hoy?",
    },
    {
      ...
      native: "Quiero explicarle lo que encontramos y lo que vamos a hacer al respecto. ¿Está bien para usted?",
    },
    {
      ...
      native: "Su corazón está trabajando más de lo que debería debido a la acumulación de líquido. Le vamos a dar un medicamento por su vía IV para ayudar a su cuerpo a eliminar ese líquido extra.",
    },
    {
      ...
      native: "Antes de realizar el procedimiento, necesito explicarle los riesgos y beneficios y obtener su firma en un formulario de consentimiento.",
    },
    {
      ...
      native: "Los riesgos incluyen sangrado, infección y en casos raros lesión de estructuras cercanas. ¿Tiene alguna pregunta hasta ahora?",
    },
    {
      ...
      native: "Hoy va a ser dado de alta. Quiero asegurarme de que entienda sus instrucciones antes de irse.",
    },
    {
      ...
      native: "Tome este medicamento una vez al día con comida. No deje de tomarlo sin llamarnos primero.",
    },
    {
      ...
      native: "Por favor regrese a urgencias si tiene dolor en el pecho, dificultad para respirar repentina, o siente que algo está muy mal.",
    },
  ],
  vocab: [
    "informed consent", "discharge instructions", "follow-up appointment",
    "return precautions", "medication side effects", "allergies",
    "primary care provider", "specialist referral", "advance directive",
    "do not resuscitate", "goals of care", "prognosis",
  ],
  nativeGloss: {
  ...
  sampleConversation: [
    { speaker: "learner", en: "The result of your test shows that your kidney function is not very good." },
    { speaker: "ai", en: "Good start, but 'not very good' is vague and can be alarming. Try something more specific and compassionate: 'Your blood test shows that your kidneys are not filtering as well as they should be. This is something we want to treat and monitor closely.' Also — always say the organ's job, not just that it's not working." },
    { speaker: "learner", en: "We will need to check your kidneys more and maybe refer you to a kidney doctor." },
    { speaker: "ai", en: "Almost there. In the US, say 'kidney specialist' or 'nephrologist' — 'kidney doctor' is understood but 'specialist' sounds more precise. Try: 'We're going to monitor your kidney function closely and refer you to a nephrologist — that's a kidney specialist — for further evaluation.' Great use of lay language." },
  ],
};
...
const clinicalDocumentationArea: FmgArea = {
  ...
  phrases: [
    ...
    },
    {
      ...
      native: "Continuar antibióticos actuales. Se anticipa alta en 24–48 horas según evolución clínica.",
    },
    {
    ...
    },
    {
      ...
      native: "Se orientó al paciente sobre la importancia de la adherencia al tratamiento y la cesación tabáquica.",
    },
    {
    ...
    },
    {
      ...
      native: "El paciente está estable para el alta. Resumen de alta completado. Seguimiento programado con médico de cabecera en una semana.",
    },
  ],
  vocab: [
    "progress note", "H&P", "SOAP note", "discharge summary",
    "subjective", "objective", "assessment", "plan",
    "pertinent negatives", "significant for", "pending",
    "in no acute distress", "tolerating po", "ambulating independently",
  ],
  nativeGloss: {
  ...
  sampleConversation: [
    ...
    { speaker: "ai", en: "That's conversational, but a note needs clinical precision. Try: 'Patient reports feeling improved. Vitals within normal limits — see flowsheet. Patient denies pain, fever, or new complaints.' Use 'reports' for subjective, 'within normal limits' instead of 'normal,' and 'denies' for negatives." },
    { speaker: "learner", en: "The patient denies pain, fever, or new complaints. Vitals within normal limits." },
    { speaker: "ai", en: "Much better — that reads like a US resident wrote it. For the objective section, follow up with: 'On exam, patient is alert and oriented x3, in no acute distress.' The 'no acute distress' phrase is expected in almost every note and signals you know the format." },
  ],
};
...
const teamCommunicationArea: FmgArea = {
  ...
  phrases: [
    {
      ...
      native: "Hola, soy el Dr. [nombre], el residente a cargo de [nombre del paciente] en la habitación [número]. Le llamo porque me preocupa [problema].",
    },
    {
      ...
      native: "El paciente tiene antecedentes de insuficiencia cardíaca y fue admitido ayer. Su presión arterial actual es de 90/60 y parece más letárgico que esta mañana.",
    },
    {
      ...
      native: "Creo que el paciente puede estar entrando en shock cardiogénico. Me gustaría un EKG urgente, signos vitales cada 15 minutos y suspender el diurético de la noche.",
    },
    {
    ...
    },
    {
      ...
      native: "Me gustaría solicitar una interconsulta de nefrología. La creatinina del paciente ha ido aumentando en los últimos dos días.",
    },
    {
      ...
      native: "¿Puede farmacia verificar si hay interacciones medicamentosas? El paciente está en warfarina y acabamos de agregar un antibiótico.",
    },
    {
      ...
      native: "¿Podemos involucrar a trabajo social? El paciente vive solo y me preocupa un alta segura.",
    },
    {
      ...
      native: "Gracias por la interconsulta. Lo transmitiré al equipo en las rondas de mañana por la mañana.",
    },
  ],
  vocab: [
    "SBAR", "verbal order", "read-back", "consult", "co-sign",
    "covering physician", "on call", "rapid response team",
    "escalate", "handoff", "sign-out", "nursing note",
    "pharmacy reconciliation", "social work referral",
  ],
  nativeGloss: {
  ...
  sampleConversation: [
    { speaker: "learner", en: "Hello, I am calling because the patient in bed 12 has low pressure. I think you should come see." },
    { speaker: "ai", en: "Good instinct to call, but this isn't specific enough for a US nurse. Try SBAR: 'Hi, this is Dr. [name] calling about Mr. Johnson in room 412. His BP just dropped to 88/58. He has a history of sepsis and was admitted for urosepsis. I'm concerned about clinical deterioration. I'd like you to do a full set of vitals and I'm coming to bedside now.' State your name, patient, the number, your concern, and what you want." },
    { speaker: "learner", en: "This is Dr. Ramirez calling about Mr. Johnson in room 412. His BP is 88 over 58 and I'm worried about septic shock." },
    { speaker: "ai", en: "That's a strong opener — you have the name, room, vital, and concern. Now add your recommendation: 'Please get a full set of vitals and hold any hypotensive medications. I'm coming to bedside.' Ending with a clear action request is what US nurses expect from a call like this." },
  ],
};
...
const emergencyEnglishArea: FmgArea = {
  ...
  phrases: [
    {
      ...
      native: "Necesito llamar una respuesta rápida por la señora García en la habitación 518. No responde.",
    },
    {
    ...
    },
    {
      ...
      native: "Den un miligramo de epinefrina IV en bolo ahora. Confirmen cuando esté administrado.",
    },
    {
    ...
    },
    {
      ...
      native: "El paciente recuperó circulación espontánea. Hagamos un EKG de 12 derivaciones y traslademos a UCI.",
    },
    {
    ...
    },
    {
      ...
      native: "Necesito hablar con la familia. ¿Alguien puede llevarme a la sala de espera familiar?",
    },
  ],
  vocab: [
    "code blue", "rapid response", "crash cart", "CPR",
    "ROSC", "time of death", "epinephrine", "defibrillation",
    "airway", "intubation", "vasopressor", "ICU transfer",
    "family notification", "debriefing",
  ],
  nativeGloss: {
  ...
  sampleConversation: [
    ...
    { speaker: "ai", en: "In an emergency, 'I think maybe' costs seconds you don't have. Drop the hedging: 'Call a code. Room 412. Now.' In a real code room, your voice needs to be the clearest voice in the space. Practice projecting authority, not uncertainty." },
    { speaker: "learner", en: "Call a code. Room 412. Now." },
    { speaker: "ai", en: "That's it — direct, clear, zero ambiguity. Now follow immediately with delegation: 'You — start CPR. You — get the crash cart. Someone page the attending.' Point at people if needed. Naming roles prevents everyone waiting for someone else to act." },
  ],
};
  ...
  vocabSets: [
    {
      ...
      emoji: "📋",
      words: [
        "chief complaint", "HPI", "review of systems", "past medical history",
        "social history", "family history", "physical exam", "assessment and plan",
        "pertinent negatives", "significant for", "vital signs stable",
      ],
      nativeGloss: {
    ...
    },
    {
      ...
      emoji: "🧠",
      words: [
        "differential diagnosis", "working diagnosis", "rule out",
        "most likely", "cannot rule out", "consistent with",
        "suspicious for", "in the setting of", "secondary to",
      ],
      nativeGloss: {
        "differential diagnosis": "diagnóstico diferencial",
        "working diagnosis": "diagnóstico de trabajo",
    ...
    },
    {
      ...
      emoji: "🏥",
      words: [
        "attending", "resident", "intern", "fellow", "consult",
        "handoff", "sign-out", "on call", "covering", "co-sign",
    ...
    },
    {
      ...
      emoji: "🚨",
      words: [
        "code blue", "rapid response", "crash cart", "ROSC",
        "vasopressor", "intubation", "defibrillation", "CPR",
        "airway management", "IV access", "ICU", "sepsis protocol",
      ],
      nativeGloss: {
