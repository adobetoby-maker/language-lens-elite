...
export const ORTHO_AREAS: OrthoArea[] = [
  {
    ...
    emoji: "🏥",
    blurb:
      "Outpatient visits — history, physical exam, shared decision-making, follow-ups.",
    ...
    vocab: ["pain", "swelling", "stiffness", "range of motion", "weight bearing", "tenderness", "X-ray", "physical therapy"],
    challenges: [
  ...
  },
  {
    ...
    phrases: [
      { en: "Time out — patient name, procedure, side, allergies.", intent: "Pre-incision time-out" },
    ...
    vocab: ["scalpel", "retractor", "suture", "drill", "saw", "implant", "irrigation", "cautery", "drape"],
    challenges: [
  ...
  },
  {
    ...
    vocab: ["consult", "admit", "NPO", "neurovascular", "mechanism", "displaced", "comminuted", "operative"],
    challenges: [
  ...
  },
  {
    ...
    vocab: ["AP view", "lateral", "oblique", "MRI", "CT", "fluoroscopy", "displacement", "avulsion", "lucency"],
    challenges: [
  ...
  },
  {
    ...
    phrases: [
      { en: "I'm the orthopedics resident — what do you have for me?", intent: "Arrive for consult" },
    ...
    vocab: ["reduction", "splint", "cast", "neurovascular check", "open fracture", "dislocation", "tetanus"],
    challenges: [
  ...
  },
  {
    ...
    vocab: ["ACL", "meniscus", "rotator cuff", "labrum", "sprain", "strain", "rehab", "return to play"],
    challenges: [
  ...
  },
  {
    ...
    vocab: ["arthritis", "implant", "prosthesis", "cemented", "uncemented", "revision", "infection", "DVT"],
    challenges: [
  ...
  },
  {
    ...
    vocab: ["polytrauma", "open fracture", "compartment syndrome", "external fixator", "damage control", "ICU"],
    challenges: [
  ...
  },
  {
    ...
    vocab: ["mass", "lesion", "biopsy", "benign", "malignant", "sarcoma", "metastasis", "tumor board", "limb salvage"],
    challenges: [
