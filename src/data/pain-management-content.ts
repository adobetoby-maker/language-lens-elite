...
export const PAIN_SCRIPTS: ClinicalScript[] = [
  // ── Pain History ────────────────────────────────────────────────────────
  {
    ...
    reference: "PEG Scale — Krebs EE et al., J Gen Intern Med 2009. Also: CDC 2022 Clinical Practice Guideline, Recommendation 1.",
  },
  {
    ...
    reference: "CDC Clinical Practice Guideline for Prescribing Opioids, 2022 — Recommendation 2: Goals, Benefits, and Risks.",
  },
  {
    ...
    reference: "DN4 Questionnaire — Bouhassira et al. Pain 2005. Also: IASP Neuropathic Pain Classification.",
  },
  {
    ...
    reference: "Pain Catastrophizing Scale (PCS) — Sullivan et al. 1995. CDC 2022 Guideline: psychological comorbidities as risk factors.",
  },
  {
    ...
    reference: "CDC 2022 Recommendation 1: Non-opioid therapies are preferred for chronic pain. Documentation of prior treatment required.",
  },
  ...
  // ── Interventional Consent ───────────────────────────────────────────────
  {
    ...
    reference: "ASIPP Evidence-Based Guidelines for Interventional Pain Management — Lumbar ESI, 2020.",
  },
  {
  ...
  },
  {
    ...
    reference: "The Joint Commission Universal Protocol for Preventing Wrong Site, Wrong Procedure, Wrong Person Surgery.",
  },
  {
    ...
    reference: "ASIPP Practice Guidelines — Image Guidance for Spinal Interventions. ACOG guidance on fluoroscopy in pregnancy.",
  },
  ...
  // ── Controlled Substance Agreement ──────────────────────────────────────
  {
    ...
    reference: "CDC 2022 Recommendation 5: Informed consent for opioid therapy including risks, benefits, and the treatment plan.",
  },
  {
    id: "pdmp-discussion",
    category: "Controlled Substance Agreement",
    ...
    reference: "CDC 2022 Recommendation 7: Check PDMP before prescribing and periodically during therapy. NABP PDMP — all 50 states operational.",
  },
  {
    id: "uds-explanation",
    category: "Controlled Substance Agreement",
    ...
    reference: "CDC 2022 Recommendation 8: Consider urine drug testing before starting opioids and periodically during therapy.",
  },
  {
    id: "ort-scoring",
    category: "Controlled Substance Agreement",
    ...
    reference: "Opioid Risk Tool (ORT) — Webster LR & Webster RM, Pain Medicine 2005. CDC 2022 Recommendation 4: Assess risk of opioid-related harms.",
  },
  ...
  // ── Opioid Taper ─────────────────────────────────────────────────────────
  {
    ...
    reference: "CDC 2022 Recommendation 5 and 6: Reassess benefits and harms; taper to lowest effective dose or discontinue when risks outweigh benefits. Opioid-induced hyperalgesia: Chu et al. J Pain 2008.",
  },
  {
    id: "taper-pace",
    category: "Opioid Taper",
    ...
    reference: "CDC 2022 Recommendation 6: Individualize taper pace based on patient response. HHS Guide to Opioid Tapering 2019.",
  },
  {
    ...
    reference: "CDC 2022 Recommendation 6: Do not abruptly discontinue. Patient-centered communication: SAMHSA Clinical Advisory 2020.",
  },
  ...
  // ── Spinal Cord Stimulator ────────────────────────────────────────────────
  {
    ...
    reference: "ASIPP Practice Guidelines — Spinal Cord Stimulation 2021. North RB et al., Neurosurgery 2007.",
  },
  {
    ...
    reference: "ASIPP SCS Guidelines 2021 — Trial Phase Criteria. Deer TR et al., Neuromodulation 2017 (NACC Consensus).",
  },
  {
    id: "scs-paresthesia",
    category: "Spinal Cord Stimulator",
    ...
    reference: "Kapural et al. Neurosurgery 2016 (SENZA-RCT) — HF10 vs. paresthesia-based SCS. Deer TR et al. Neuromodulation 2022.",
  },
  {
    ...
    reference: "ASIPP SCS Guidelines 2021 — Psychosocial Evaluation Requirements. Celestin J et al., Pain Med 2009.",
  },
  ...
  // ── Multidisciplinary Handoff ─────────────────────────────────────────────
  {
    ...
    reference: "Louw A et al., Phys Ther 2011 — Pain neuroscience education meta-analysis. Moseley GL, Graded Motor Imagery.",
  },
  {
    ...
    reference: "Williams AC et al., Cochrane Review 2020 — CBT for Chronic Pain. CDC 2022: Non-pharmacologic therapies preferred.",
  },
  {
    id: "mdt-epic-handoff",
    category: "Multidisciplinary Handoff",
    ...
    reference: "SAMHSA-HRSA Integrated Care Models. CDC 2022 — Concurrent management of OUD and chronic pain.",
  },
  {
    ...
    reference: "Temel JS et al., NEJM 2010 — Early palliative care in NSCLC. WHO Cancer Pain Ladder.",
  },
  ...
  // ── Difficult Conversation ────────────────────────────────────────────────
  {
    ...
    reference: "CDC 2022 Recommendation 7: PDMP-detected concerning findings should prompt patient discussion. State PDMP query requirements.",
  },
  {
    ...
    reference: "CDC 2022 — Approach aberrant results with a health-focused conversation. SAMHSA 2020 — Stigma-free communication in SUD.",
  },
  {
    ...
    reference: "CDC 2022 — Patient safety when discontinuing opioids. AMA Council on Ethical and Judicial Affairs — Patient abandonment guidelines.",
  },
  {
    ...
    reference: "CDC 2022 Recommendation 2: Establish goals and reassess them; modify treatment when goals are not being met.",
  },
];
...
export const PAIN_AREAS: ModuleArea[] = [
  {
    ...
    counterpart: "New patient presenting with chronic low back pain, neck pain, or complex regional pain syndrome.",
    ...
    phrases: [
      { en: "Tell me about the pain in your own words — when it started, what brought it on, and how it's changed your daily life.", intent: "Open-ended pain history with functional framing" },
      { en: "On a scale of zero to ten — what's your average pain over the last week, not your worst moment?", intent: "PEG item 1 — Pain intensity, averaged not peak" },
      { en: "How much has this pain interfered with your enjoyment of life? Zero means it hasn't at all, ten means completely.", intent: "PEG item 2 — Enjoyment of life" },
      { en: "And how much has it changed what you can do day to day — work, chores, moving around?", intent: "PEG item 3 — General activity interference" },
      { en: "What's worked before, even partially? And what have you tried that made things worse or had side effects you couldn't tolerate?", intent: "Establish prior treatment history for CDC documentation" },
      { en: "I'm going to ask a few questions about personal and family history — they help me understand how to prescribe safely for you.", intent: "Introduce Opioid Risk Tool screening without stigma" },
      { en: "My goal for you isn't a zero pain score — that's usually not realistic with chronic pain. My goal is for you to function better and have a better quality of life. Let's define together what that looks like.", intent: "Set realistic functional goals per CDC 2022 Recommendation 2" },
      { en: "Before your next visit, I'm ordering a urine drug screen and checking the prescription monitoring database — this is routine for all my patients before I prescribe anything controlled.", intent: "Introduce UDS and PDMP proactively, normalize it" },
    ],
    vocab: [
      "PEG scale",
  ...
  },
  {
    ...
    counterpart: "Patient preparing for lumbar ESI, cervical medial branch block, or celiac plexus block.",
    ...
    phrases: [
      { en: "The injection delivers anti-inflammatory medication directly to the source of the nerve irritation — it's more targeted than anything you take by mouth.", intent: "Explain ESI mechanism vs. oral medication" },
      { en: "About 50 to 70 percent of patients get meaningful relief. That might last weeks or months. Some don't respond — and that's useful information too, because it tells us where to look next.", intent: "Quote evidence-based ESI success rates honestly" },
      { en: "I'm going to confirm the site with you before we go in — right side, L4-5 level. Please tell me if that matches where your pain is.", intent: "Universal Protocol active site verification" },
      { en: "We use live X-ray to guide the needle. You'll hear some clicks and feel some pressure — tell me if anything feels sharp or shoots down your leg.", intent: "Fluoroscopy guidance explanation and warning signs" },
      { en: "If you're diabetic, your blood sugar may run high for one to two days after — that's the steroid. It normalizes on its own, but please monitor it.", intent: "Steroid hyperglycemia consent — commonly omitted" },
      { en: "You'll be here about an hour total — 20 minutes lying on the table, then observation. Arrange a ride home; we don't let patients drive after sedation.", intent: "Logistics and post-procedure instructions" },
      { en: "Any questions before we walk back? There are no questions too small — this is your body.", intent: "Open invitation to questions before procedure start" },
    ],
    vocab: [
  ...
  },
  {
    ...
    phrases: [
      { en: "This agreement is not about not trusting you — it's the same document every patient who receives controlled substances in this practice signs. Let me walk you through it.", intent: "Normalize the CSA, reduce patient defensiveness" },
      { en: "You agree to take the medication only as prescribed — no sharing, no borrowing, and please store it in a locked box or a medicine safe at home.", intent: "Explain safe storage requirement with why" },
      { en: "I'm going to check the state prescription database before every prescription. That's state law, and it also protects you — it alerts me if there's an interaction or duplicate I don't know about.", intent: "PDMP disclosure framed as protection, not surveillance" },
      { en: "I'll ask for random urine drug screens — this confirms the medication is in your system and there's nothing unsafe interacting with it. If you're ever called for one, it's truly random and not a sign I'm concerned.", intent: "Random UDS disclosure without stigma" },
      { en: "If you lose a prescription, I cannot replace it — that's a term I enforce consistently. I know that sounds strict, but it's both a legal and safety requirement.", intent: "Lost prescription policy — state clearly upfront to prevent conflict later" },
      { en: "If you ever feel like the medication isn't working or you want to stop, call me — please don't just stop on your own. Going off opioids abruptly can be medically dangerous.", intent: "Prevent abrupt self-discontinuation" },
    ],
    vocab: [
      "controlled substance agreement",
      "PDMP",
  ...
  },
  {
    ...
    counterpart: "Patient on long-term opioid therapy who has been on a stable high dose for months or years.",
    ...
    phrases: [
      { en: "I want to have an honest conversation about your current dose — not because I want to take something away, but because the evidence says this dose may actually be making your pain worse over time.", intent: "Frame taper as clinical benefit, cite OIH" },
      { en: "What I'm proposing is a slow reduction — about 10 percent every two to four weeks. Most patients tell me that pace feels manageable. If a step is too much, we slow it down.", intent: "Taper pace, CDC 2022 individualized approach" },
      { en: "You will feel some adjustment symptoms. I want to prepare you for that honestly — restlessness, sleep disturbance, maybe some muscle aches. Those are signs of physical dependence, not addiction, and they're temporary.", intent: "Distinguish physical dependence from addiction, prepare for withdrawal symptoms" },
      { en: "I'm not reducing your dose and then stepping back. I want to see you more frequently during the taper — every four weeks instead of every three months.", intent: "Commit to closer follow-up, prevent abandonment fear" },
      { en: "The data on patients who taper successfully is genuinely encouraging — many report less pain, better sleep, sharper thinking. That's what I'm aiming for with you.", intent: "Provide hope and outcome evidence for taper" },
      { en: "Can you tell me what your biggest concern about this is? I want to address it directly before we start.", intent: "Elicit and address the specific fear rather than assuming it" },
    ],
    vocab: [
      "opioid taper",
  ...
  },
  {
    ...
    counterpart: "Patient with failed back surgery syndrome or complex regional pain syndrome who has exhausted other options.",
    ...
    phrases: [
      { en: "You've been through a lot of treatment over the years. I want to review everything carefully before I make a recommendation — because spinal cord stimulation isn't for everyone, and I want to make sure you're the right candidate.", intent: "Establish credibility by reviewing history before pitching the procedure" },
      { en: "What makes this different from most procedures: we do a trial first. You go home with temporary leads and an external battery and live your normal life for a week. If pain drops 50 percent or more, we consider it a success.", intent: "Explain the unique trial-first model of SCS" },
      { en: "There are two main types of stimulation right now. One you can feel as a tingling over the painful area. The newer one operates below sensation — you feel nothing, but studies show it works as well or better for back and leg pain.", intent: "Explain paresthesia vs. subthreshold SCS modalities" },
      { en: "I'm going to refer you to our psychologist before we schedule the trial — this is required, and it genuinely improves outcomes. She'll look at how you're coping with pain, whether there are factors that would help you succeed, and whether there's anything we should address beforehand.", intent: "Psychological evaluation framed as outcome optimization" },
      { en: "If the trial succeeds, the permanent implant is an outpatient surgery. The battery is under the skin — no external parts. You can have a follow-up MRI in some cases depending on the system.", intent: "Explain permanent implant logistics including MRI compatibility" },
      { en: "What questions do you have — about any of it? There's a lot to take in, and I'd rather you ask now than go home wondering.", intent: "Invite questions at the close of an information-dense consult" },
    ],
    vocab: [
      "spinal cord stimulator",
      "neuromodulation",
  ...
  },
  {
    ...
    counterpart: "Physical therapist, psychologist, addiction medicine specialist, or palliative care provider.",
    ...
    phrases: [
      { en: "I'm sending you a patient with a three-year history of chronic low back pain and significant fear-avoidance behavior. I'd like you to focus on pain neuroscience education before graded exercise — she's not ready for activity yet psychologically.", intent: "PT referral with specific clinical framing" },
      { en: "I'm co-managing this patient with oncology — you'll see Dr. Kim's notes in the chart. My role is analgesia. I'm asking you to address the depression and catastrophizing that's amplifying her pain experience.", intent: "Oncology pain handoff to psychology" },
      { en: "I want to do a warm handoff to addiction medicine. The patient is on 150 MME and I believe buprenorphine would serve him better. I'll stay involved in the pain piece — I just need your expertise on the transition.", intent: "Addiction medicine referral for high-dose opioid patient" },
      { en: "This is a palliative consultation, not a hospice consultation — I want you to address quality of life and pain goals directly. She has months, not weeks, and she wants to stay engaged with her family.", intent: "Palliative care referral — distinguish from hospice, state goals clearly" },
      { en: "I've spoken with the patient and prepared him for this call. He understands we work together — he knows you're not replacing me. He's expecting you to reach out this week.", intent: "Set patient expectations for the handoff before the call happens" },
    ],
    vocab: [
  ...
  },
  {
    ...
    counterpart: "Patient whose UDS or PDMP has returned a concerning result, or who has violated the controlled substance agreement.",
    ...
    phrases: [
      { en: "Your drug screen came back with something unexpected — and before I draw any conclusions, I want to hear from you. Can you help me understand this result?", intent: "Open aberrant UDS conversation with curiosity, not accusation" },
      { en: "The monitoring database shows a controlled substance prescription from a provider I'm not aware of — filled last month. That's something we need to talk about. What happened?", intent: "PDMP-detected concurrent prescribing — open the conversation" },
      { en: "I'm not here to end your care today. I'm here because something in your results tells me something is going on in your life, and I'd rather know than not know.", intent: "Reframe aberrant behavior conversation as clinical concern, not punishment" },
      { en: "What you're describing sounds like it may have become larger than pain management. That's not a failure — it's a medical condition, and there are treatments for it that can genuinely help.", intent: "Segue from aberrant behavior to OUD as a medical condition" },
      { en: "Because of what's happened, I'm not able to continue prescribing controlled substances. I want to be direct about that. But I'm not leaving you without a plan — I'm referring you to someone who can offer better treatment for what I think is happening.", intent: "Discharge from controlled substance practice — honest, with referral" },
      { en: "I'm going to write a 30-day bridge prescription so there's no abrupt stop. Your safety matters even in the middle of this. We'll use that time to get you connected with the right care.", intent: "Bridge prescription at discharge — CDC safety recommendation" },
    ],
    vocab: [
...
export const PAIN_CONTEXTS: ClinicalContext[] = [
  {
    ...
    setting: "University-based multidisciplinary pain program with co-located PT, psychology, addiction medicine, and neurosurgery.",
    patientProfile: "Complex chronic pain patients often with multiple prior treatments, significant psychological comorbidities, and high healthcare utilization. Some are referred from litigation contexts.",
    languageNote: "Academic language is acceptable but should be translated for patients. Use 'opioid use disorder' not 'addiction.' Presentations often involve trainees — teaching while consenting is a real workflow challenge.",
  },
  {
    id: "community-interventional-clinic",
    name: "Community Interventional Clinic",
    setting: "Standalone interventional pain practice — procedural volume is high, visit times short, payer mix includes commercial, Medicare, and Medicaid. Prescribers see 25–35 patients per day.",
    patientProfile: "Mix of post-surgical, musculoskeletal, and neuropathic pain. High proportion of patients on long-term opioids. PDMP and UDS compliance critical. Procedural revenue-driven environment creates pressure to treat everyone interventionally.",
    languageNote: "Keep explanations efficient — patients expect volume. Flag the cases that genuinely need slow, careful conversation and protect that time.",
  },
  {
    id: "cancer-pain-palliative",
    name: "Cancer Pain & Palliative Care",
    setting: "Embedded pain/palliative service in an oncology center or inpatient hospital. Patients range from curative intent with pain as a side effect to end-of-life comfort focus.",
    patientProfile: "Oncology patients with nociceptive tumor pain, neuropathic treatment-related pain (chemo-induced peripheral neuropathy), and existential suffering. Opioid risk stratification applies differently — benefit-risk calculation shifts toward liberal prescribing at end of life.",
    languageNote: "The word 'palliative' must be explained every time it is used. Patients hear 'giving up.' Distinguish early palliative from hospice care clearly. Avoid prognostic language unless explicitly asked.",
  },
  {
    id: "addiction-medicine-crossover",
    name: "Addiction Medicine Crossover",
    setting: "Pain patients referred to or being co-managed with addiction medicine. Setting may be a standalone MAT clinic, inpatient detox, or co-located addiction/pain program.",
    patientProfile: "Patients with concurrent opioid use disorder and legitimate chronic pain — one of the most clinically and ethically complex scenarios in medicine. Language and stigma matter enormously. Many patients have been discharged from other practices and carry deep shame.",
    languageNote: "Use 'opioid use disorder,' never 'addict.' Use 'substance use disorder' not 'abuse.' 'Physical dependence' is not the same as 'addiction' and conflating them destroys trust. Motivational interviewing register is appropriate throughout.",
  },
];
