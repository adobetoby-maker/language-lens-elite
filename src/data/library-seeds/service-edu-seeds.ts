...
export const SERVICE_EDU_SEEDS: LibrarySeed[] = [
    ...
    sentences: [
      {
        ...
        target: "Antes de que empiece el servicio, cada estación debe estar completamente surtida y limpia, sin excepciones.",
      },
      {
        en: "I need you to brunoise the onions and mince the garlic — we need twelve portions ready before eleven.",
        target: "Necesito que cortes las cebollas en brunoise y piques el ajo; necesitamos doce porciones listas antes de las once.",
      },
      {
        en: "Check the walk-in cooler and pull everything we need for tonight's specials — mark the dates on every container.",
        target: "Revisa el refrigerador de cámara y saca todo lo que necesitamos para los especiales de esta noche; anota las fechas en cada recipiente.",
      },
      {
        en: "The stock pot has been going since six this morning — taste it and adjust the seasoning before you reduce it.",
        target: "La olla de caldo lleva cocinándose desde las seis de la mañana; pruébalo y ajusta la sazón antes de reducirlo.",
      },
      {
        en: "We are low on the roasted peppers — can you roast two trays right now and get them cooling before the lunch rush?",
        target: "Nos estamos quedando sin pimientos asados; ¿puedes asar dos charolas ahora mismo y dejarlas enfriar antes de la hora pico del almuerzo?",
      },
      {
        en: "Label every prepped item with the name, today's date, and your initials — health inspector could walk in any day.",
        target: "Etiqueta cada ingrediente preparado con el nombre, la fecha de hoy y tus iniciales; el inspector de salud podría aparecer cualquier día.",
      },
      {
        en: "Knife skills matter — if you are having trouble with the julienne, ask me to show you the correct technique.",
        target: "Las habilidades con el cuchillo son importantes; si tienes problemas con el julienne, pídeme que te muestre la técnica correcta.",
      },
      {
        en: "The sauté station needs more clarified butter and a full set of mise en place before you do anything else.",
        target: "La estación de salteado necesita más mantequilla clarificada y un mise en place completo antes de hacer cualquier otra cosa.",
      },
      {
        en: "When you finish your prep, clean your cutting board, sanitize the surface, and help the garde manger station.",
        target: "Cuando termines tu preparación, limpia tu tabla de cortar, sanitiza la superficie y ayuda a la estación de garde manger.",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "Bonsoir et bienvenue. Avez-vous une réservation, ou souhaitez-vous vous installer dans la zone libre ?",
      },
      {
        en: "Tonight's specials are a pan-seared duck breast with cherry reduction and a grilled sea bass with fennel.",
        target: "Les plats du soir sont un magret de canard poêlé avec une réduction de cerises et un bar grillé au fenouil.",
      },
      {
        en: "May I start you with something to drink? We have a selection of local wines and craft cocktails.",
        target: "Puis-je vous proposer quelque chose à boire pour commencer ? Nous avons une sélection de vins locaux et de cocktails artisanaux.",
      },
      {
        en: "I apologize — that dish is no longer available tonight. May I suggest the lamb, which is excellent?",
        target: "Je suis désolé — ce plat n'est plus disponible ce soir. Puis-je vous suggérer l'agneau, qui est excellent ?",
      },
      {
        en: "Do any of your guests have food allergies or dietary restrictions I should let the kitchen know about?",
        target: "Certains de vos convives ont-ils des allergies alimentaires ou des restrictions dont je dois informer la cuisine ?",
      },
      {
        en: "Your order will be out shortly — the kitchen is plating it right now.",
        target: "Votre commande sera prête dans un instant — la cuisine est en train de la dresser.",
      },
      {
        en: "I noticed you have not touched your main course — is everything to your liking, or can I bring you something else?",
        target: "J'ai remarqué que vous n'avez pas touché à votre plat principal — est-ce que tout vous convient, ou puis-je vous apporter autre chose ?",
      },
      {
        en: "Can I offer you a dessert or a coffee? Our tarte tatin tonight is made with caramelized Normandy apples.",
        target: "Puis-je vous proposer un dessert ou un café ? Notre tarte tatin du soir est préparée avec des pommes caramélisées de Normandie.",
      },
      {
        en: "Here is your bill — the service charge is included, but additional gratuities are always appreciated.",
        target: "Voici votre addition — le service est compris, mais un pourboire supplémentaire est toujours apprécié.",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "Guten Abend. Willkommen in unserem Restaurant. Haben Sie eine Reservierung, oder sind Sie heute Abend ohne Voranmeldung hier?",
      },
      {
        en: "Your table is ready. Please follow me — I will bring you the menus right away.",
        target: "Ihr Tisch ist bereit. Bitte folgen Sie mir — ich bringe Ihnen sofort die Speisekarten.",
      },
      {
        en: "Tonight's specials include a venison ragout with red cabbage and our seasonal asparagus soup.",
        target: "Zu den heutigen Tagesgerichten gehören ein Wildragout mit Rotkohl und unsere saisonale Spargelsuppe.",
      },
      {
        en: "Do you have any food allergies or intolerances we should be aware of when preparing your meal?",
        target: "Haben Sie Lebensmittelallergien oder Unverträglichkeiten, die wir bei der Zubereitung Ihres Gerichts berücksichtigen sollen?",
      },
      {
        en: "May I recommend our house Riesling with the fish — it pairs exceptionally well.",
        target: "Darf ich unseren Haus-Riesling zum Fisch empfehlen? Er passt außerordentlich gut dazu.",
      },
      {
        en: "I am so sorry for the delay — the kitchen is handling a large party and your order is next to go out.",
        target: "Es tut mir sehr leid wegen der Verzögerung — die Küche betreut gerade eine große Gesellschaft, und Ihre Bestellung kommt als nächstes.",
      },
      {
      ...
      },
      {
        ...
        target: "Als Dessert darf ich Ihnen unsere Schwarzwälder Kirschtorte oder die Käseauswahl mit regionalen Spezialitäten empfehlen?",
      },
      {
        en: "Here is your receipt. Thank you for your visit — we hope to welcome you again soon.",
        target: "Hier ist Ihre Rechnung. Vielen Dank für Ihren Besuch — wir hoffen, Sie bald wieder begrüßen zu dürfen.",
      },
    ],
  },
  ...
  // Italian — restaurant
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "La selezione di antipasti di stasera include prosciutto e melone, bruschetta al pomodoro e burrata fresca.",
      },
      {
        en: "As a first course I can recommend the tagliatelle al ragù — it is made fresh this morning.",
        target: "Come primo piatto vi consiglio le tagliatelle al ragù — sono fatte fresche stamattina.",
      },
      {
        en: "Do any of your guests have allergies? Some of our dishes contain gluten, shellfish, or nuts.",
        target: "Qualcuno dei vostri ospiti ha allergie? Alcuni dei nostri piatti contengono glutine, crostacei o frutta secca.",
      },
      {
        en: "We have an excellent local Chianti Classico that goes beautifully with the bistecca.",
        target: "Abbiamo un ottimo Chianti Classico locale che si abbina perfettamente alla bistecca.",
      },
      {
        en: "I apologize — we have run out of the branzino tonight. The grilled swordfish is just as fresh and very popular.",
        target: "Mi scuso — stasera abbiamo terminato il branzino. Il pesce spada alla griglia è altrettanto fresco e molto apprezzato.",
      },
      {
      ...
      },
      {
        ...
        target: "Per il dolce, il tiramisù è la specialità della casa — preparato ogni giorno con vero mascarpone.",
      },
      {
  ...
  // Portuguese — restaurant
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "No nosso restaurante o serviço é rodízio — os passadores virão à sua mesa com cortes diferentes de carne durante toda a refeição.",
      },
      {
        en: "The salad bar and hot buffet are included in the prix fixe — please help yourselves.",
        target: "A salada e o buffet quente estão incluídos no preço fixo — por favor, sirvam-se à vontade.",
      },
      {
        en: "The green card means you are ready for more meat, and the red card means you would like to pause.",
        target: "O cartão verde significa que você está pronto para mais carne, e o cartão vermelho significa que deseja uma pausa.",
      },
      {
        en: "Do you have any dietary restrictions or food allergies? Some of our marinades contain gluten.",
        target: "Vocês têm alguma restrição alimentar ou alergia? Algumas das nossas marinadas contêm glúten.",
      },
      {
        en: "Tonight we have picanha, fraldinha, costela, and the house special — garlic lamb chops.",
        target: "Esta noite temos picanha, fraldinha, costela e o especial da casa — costeletas de cordeiro ao alho.",
      },
      {
      ...
      },
      {
        ...
        target: "Para a sobremesa, posso sugerir a mousse de maracujá ou o tradicional pudim de leite?",
      },
      {
    ...
    sentences: [
      {
        ...
        target: "Gracias por venir hoy. Todo lo que comparta conmigo es confidencial y está protegido por el privilegio abogado-cliente.",
      },
      {
        ...
        target: "Para solicitar asilo en los Estados Unidos, debe demostrar que ha sido perseguido, o que tiene un temor fundado de persecución, por motivos de raza, religión, nacionalidad, opinión política o pertenencia a un grupo social determinado.",
      },
      {
        en: "Can you tell me, in your own words, why you left your country and why you cannot return?",
        target: "¿Puede contarme, en sus propias palabras, por qué salió de su país y por qué no puede regresar?",
      },
      {
        ...
        target: "El plazo de presentación de un año es crucial; las solicitudes de asilo deben presentarse dentro del año siguiente a la llegada a los Estados Unidos.",
      },
      {
        ...
        target: "Para respaldar su caso, necesitaremos cualquier evidencia que tenga: informes policiales, expedientes médicos, fotografías, declaraciones de testigos o artículos periodísticos.",
      },
      {
        en: "USCIS will schedule an interview with an asylum officer — I will prepare you for the questions they are likely to ask.",
        target: "El USCIS programará una entrevista con un oficial de asilo; yo lo prepararé para las preguntas que probablemente le harán.",
      },
      {
        en: "If your asylum case is denied, you have the right to appeal before the Board of Immigration Appeals.",
        target: "Si su solicitud de asilo es denegada, tiene derecho a apelar ante la Junta de Apelaciones de Inmigración.",
      },
      {
        en: "While your case is pending, you may be eligible for an Employment Authorization Document after 180 days.",
        target: "Mientras su caso está pendiente, puede ser elegible para un Documento de Autorización de Empleo después de 180 días.",
      },
      {
        en: "Do you have any family members who entered with you or who are currently in danger in your home country?",
        target: "¿Tiene familiares que hayan entrado con usted o que actualmente estén en peligro en su país de origen?",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "Merci de votre visite. Je comprends que vous souhaitez des conseils sur votre statut d'immigration aux États-Unis.",
      },
      {
        en: "Can you tell me when you first entered the United States and on what type of visa?",
        target: "Pouvez-vous me dire quand vous êtes entré aux États-Unis pour la première fois et avec quel type de visa ?",
      },
      {
        en: "A tourist visa, or B-2 visa, allows a stay of up to six months and cannot be used for employment.",
        target: "Un visa touristique, ou visa B-2, autorise un séjour allant jusqu'à six mois et ne peut pas être utilisé à des fins professionnelles.",
      },
      {
        ...
        target: "Si votre période d'admission autorisée a expiré, vous êtes considéré en situation irrégulière, ce qui peut affecter vos futures demandes de visa.",
      },
      {
        en: "Your employer can sponsor you for an H-1B visa if your position qualifies as a specialty occupation.",
        target: "Votre employeur peut vous parrainer pour un visa H-1B si votre poste est qualifié d'occupation spécialisée.",
      },
      {
        ...
        target: "Pour déposer une pétition auprès de l'USCIS, nous aurons besoin de votre passeport, de votre enregistrement d'entrée I-94, de vos déclarations fiscales et d'une lettre de votre employeur.",
      },
      {
        ...
        target: "Les délais de traitement à l'USCIS peuvent aller de plusieurs mois à plus d'un an — je vous conseillerai de demander un traitement accéléré si le temps est critique.",
      },
      {
        en: "If your petition is approved, you will receive a notice and can then apply for your visa at a U.S. consulate.",
        target: "Si votre pétition est approuvée, vous recevrez une notification et pourrez ensuite demander votre visa auprès d'un consulat américain.",
      },
      {
        en: "Do you have any questions about what I have explained, or is there anything you would like me to clarify?",
        target: "Avez-vous des questions sur ce que j'ai expliqué, ou y a-t-il quelque chose que vous souhaiteriez que je clarifie ?",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "Guten Morgen. Bitte nehmen Sie Platz. Alles, was wir heute besprechen, unterliegt der anwaltlichen Schweigepflicht.",
      },
      {
        ...
        target: "Ich verstehe, dass Sie sich mit einem Studentenvisum in den Vereinigten Staaten aufhalten und Möglichkeiten prüfen möchten, nach Ihrem Studium hier zu bleiben.",
      },
      {
        en: "A green card, or permanent resident card, grants you the right to live and work permanently in the United States.",
        target: "Eine Green Card, also eine Daueraufenthaltsgenehmigung, gewährt Ihnen das Recht, dauerhaft in den Vereinigten Staaten zu leben und zu arbeiten.",
      },
      {
        ...
        target: "Es gibt verschiedene Wege zur Green Card: über Beschäftigung, Familienzusammenführung, die Diversity-Visa-Lotterie oder den Flüchtlings- und Asylstatus.",
      },
      {
        en: "For an employment-based green card, your employer must file an I-140 petition with USCIS on your behalf.",
        target: "Für eine beschäftigungsbasierte Green Card muss Ihr Arbeitgeber in Ihrem Namen eine I-140-Petition beim USCIS einreichen.",
      },
      {
        en: "The USCIS case number will allow us to track the status of your petition online at any time.",
        target: "Die USCIS-Aktennummer ermöglicht es uns, den Status Ihrer Petition jederzeit online zu verfolgen.",
      },
      {
        en: "If a hearing is scheduled, I will accompany you and represent your interests before the immigration judge.",
        target: "Sollte eine Anhörung angesetzt werden, werde ich Sie begleiten und Ihre Interessen vor dem Einwanderungsrichter vertreten.",
      },
      {
        ...
        target: "Ein Abschiebungsverfahren kann eingeleitet werden, wenn Sie gegen die Bedingungen Ihres Visums verstoßen — es ist unbedingt erforderlich, dass Sie Ihren erlaubten Aufenthalt nicht überschreiten.",
      },
      {
        ...
        target: "Ich werde Ihnen eine Checkliste mit allen Dokumenten zusenden, die wir vor der Einreichung zusammenstellen müssen. Bitte unterschreiben Sie nichts, ohne mich vorher zu konsultieren.",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "Benvenuto. Si accomodi. Prima di iniziare, voglio spiegarle che la nostra conversazione è completamente riservata.",
      },
      {
        en: "Can you describe your current immigration status and how long you have been in the United States?",
        target: "Può descrivermi il suo attuale status immigratorio e da quanto tempo si trova negli Stati Uniti?",
      },
      {
        en: "A green card grants permanent residency, which means you can live and work in the United States indefinitely.",
        target: "La Green Card concede la residenza permanente, il che significa che può vivere e lavorare negli Stati Uniti a tempo indeterminato.",
      },
      {
        en: "USCIS requires that you provide documentation of your entry, your current address, and any prior immigration violations.",
        target: "Il USCIS richiede che lei fornisca documentazione del suo ingresso, del suo indirizzo attuale e di eventuali precedenti violazioni immigratorie.",
      },
      {
        en: "If you have a U.S. citizen or permanent resident spouse, they can file a petition on your behalf.",
        target: "Se ha un coniuge cittadino americano o residente permanente, questi può presentare una petizione a suo nome.",
      },
      {
        ...
        target: "Il processo di naturalizzazione richiede cinque anni di residenza permanente, presenza fisica continuativa e il superamento di un esame di inglese e di educazione civica.",
      },
      {
        en: "Missing your hearing date is extremely serious — it can result in a deportation order issued in absentia.",
        target: "Non presentarsi alla data dell'udienza è estremamente grave — può comportare un'ordinanza di deportazione emessa in contumacia.",
      },
      {
        ...
        target: "Le raccomando di portare il passaporto, tutti i timbri visto precedenti, il registro I-94 e tutti i documenti giudiziari al nostro prossimo incontro.",
      },
      {
        en: "Do you have any questions so far? I want to make sure you fully understand the process before we proceed.",
        target: "Ha domande finora? Voglio assicurarmi che abbia compreso appieno il processo prima di procedere.",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "本日はお越しいただきありがとうございます。どうぞおかけください。ここでお話しいただく内容はすべて弁護士・依頼人間の秘匿特権により保護されています。",
      },
      {
      ...
      },
      {
        ...
        target: "許可された在留期間が過ぎている場合、あなたはアメリカ合衆国に不法滞在していると見なされます。",
      },
      {
  ...
  // Portuguese — legal immigration
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Entendo que você está preocupado com seu status imigratório. Pode me contar como e quando entrou nos Estados Unidos?",
      },
      {
        ...
        target: "Se você entrou sem inspeção, ainda pode ter opções legais dependendo de seus vínculos familiares e tempo de permanência.",
      },
      {
        ...
        target: "Uma declaração de suporte financeiro é necessária para comprovar que seu patrocinador tem renda suficiente para que você não se torne um ônus para o governo.",
      },
      {
        en: "USCIS will require your birth certificate, marriage certificate if applicable, passport, and two passport photos.",
        target: "O USCIS exigirá sua certidão de nascimento, certidão de casamento se aplicável, passaporte e duas fotos para passaporte.",
      },
      {
        ...
        target: "O agendamento de biometria é obrigatório — o USCIS coletará suas impressões digitais e foto para fins de verificação de antecedentes.",
      },
      {
        en: "If your petition is approved, you will receive a notice of approval and instructions for the next steps in the process.",
        target: "Se sua petição for aprovada, você receberá um aviso de aprovação e instruções sobre os próximos passos no processo.",
      },
      {
        en: "A deportation order can be appealed, but the window to file is short — usually thirty days from the date of the order.",
        target: "Uma ordem de deportação pode ser apelada, mas o prazo para protocolar é curto — geralmente trinta dias a partir da data da ordem.",
      },
      {
        ...
        target: "Entrarei em contato assim que recebermos uma resposta do USCIS. Por favor, informe meu escritório caso você mude de endereço.",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "Gracias por venir hoy, señora Ramírez. Le agradecemos que se haya tomado el tiempo para asistir a la reunión del IEP de Miguel.",
      },
      {
        ...
        target: "Un IEP, o Programa de Educación Individualizada, es un plan escrito que describe los servicios especiales y apoyos que recibirá su hijo.",
      },
      {
        en: "Based on the evaluation, Miguel qualifies for speech therapy twice a week and extended time on tests.",
        target: "Según la evaluación, Miguel califica para recibir terapia del habla dos veces por semana y tiempo adicional en los exámenes.",
      },
      {
        en: "We also recommend that he sit at the front of the classroom to minimize distractions during instruction.",
        target: "También recomendamos que se siente al frente del salón de clases para minimizar las distracciones durante la instrucción.",
      },
      {
        ...
        target: "Como padre de familia, usted es un miembro pleno del equipo del IEP, y su aportación y firma son necesarias antes de que podamos implementar el plan.",
      },
      {
        en: "We will review the IEP at least once a year, but you can request a meeting at any time if you have concerns.",
        target: "Revisaremos el IEP al menos una vez al año, pero puede solicitar una reunión en cualquier momento si tiene inquietudes.",
      },
      {
        en: "Do you have any questions about the goals we have written for Miguel this year?",
        target: "¿Tiene alguna pregunta sobre los objetivos que hemos redactado para Miguel este año?",
      },
      {
        ...
        target: "Si en algún momento no está de acuerdo con el IEP, tiene derecho a solicitar mediación o presentar una queja ante el departamento de educación estatal.",
      },
      {
        en: "We are all working toward the same goal — making sure Miguel has every opportunity to succeed.",
        target: "Todos trabajamos hacia el mismo objetivo: asegurarnos de que Miguel tenga todas las oportunidades para tener éxito.",
      },
    ],
  },
  ...
  // French — k12: field trip
  {
    ...
    subtitle: "K–12 Classroom · organizing a field trip and communicating with students and parents",
    language: "French",
    targetLabel: "Français",
    flag: "🇫🇷",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Classe, j'ai une bonne nouvelle — le mois prochain, nous allons faire une sortie scolaire au musée d'histoire naturelle.",
      },
      {
        en: "Please bring home this permission slip and have your parent or guardian sign it by Friday.",
        target: "Veuillez rapporter ce formulaire d'autorisation à la maison et le faire signer par votre parent ou tuteur avant vendredi.",
      },
      {
        en: "The bus will depart from the front of the school at eight-thirty sharp — please do not be late.",
        target: "Le car partira devant l'école à huit heures et demie précises — veuillez ne pas être en retard.",
      },
      {
        en: "You will need to bring a packed lunch, a water bottle, and comfortable shoes — we will be walking for most of the day.",
        target: "Vous devrez apporter un déjeuner préparé, une bouteille d'eau et des chaussures confortables — nous marcherons pendant la majeure partie de la journée.",
      },
      {
        en: "We will be split into three groups — please stay with your assigned chaperone at all times.",
        target: "Nous serons répartis en trois groupes — restez avec votre accompagnateur désigné à tout moment.",
      },
      {
        ...
        target: "Au musée, vous observerez des expositions sur la préhistoire, le climat et la géologie qui sont directement liées à notre unité de sciences actuelle.",
      },
      {
        en: "I will send a letter home to parents with the full itinerary, emergency contact procedures, and arrival time.",
        target: "J'enverrai une lettre aux parents avec le programme complet, les procédures d'urgence et l'heure d'arrivée.",
      },
      {
        en: "Students with medical needs or allergies must inform me before the trip so I can coordinate with the nurse.",
        target: "Les élèves ayant des besoins médicaux ou des allergies doivent m'en informer avant la sortie afin que je puisse coordonner avec l'infirmière.",
      },
      {
        ...
        target: "Cette sortie est un privilège — les élèves ayant eu trois absences non justifiées ou plus devront avoir une conversation séparée avant d'y participer.",
      },
    ],
  },
  ...
  // German — k12
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Heute fahren wir mit unserer Einheit zur Weimarer Republik fort — bitte schlagen Sie Ihr Lehrbuch auf Seite siebenundvierzig auf.",
      },
      {
        en: "Who can summarize what we discussed in last Thursday's lesson? Raise your hand if you remember.",
        target: "Wer kann zusammenfassen, was wir in der Stunde letzten Donnerstag besprochen haben? Heben Sie die Hand, wenn Sie sich erinnern.",
      },
      {
        en: "Your essays are due at the beginning of class on Wednesday — late submissions will be penalized one grade level.",
        target: "Ihre Aufsätze müssen zu Beginn der Stunde am Mittwoch abgegeben werden — verspätete Abgaben werden um eine Note abgewertet.",
      },
      {
        en: "Lucas, please stop talking while your classmate is speaking — everyone deserves to be heard.",
        target: "Lucas, hören Sie bitte auf zu reden, während Ihr Mitschüler spricht — jeder verdient es, gehört zu werden.",
      },
      {
        en: "I will pair you up for today's group activity — the goal is to compare and contrast two primary source documents.",
        target: "Ich werde Sie für die heutige Gruppenarbeit einteilen — das Ziel ist es, zwei Primärquellen zu vergleichen und gegenüberzustellen.",
      },
      {
        en: "If you are struggling with the material, please come see me after class or arrange a tutoring session.",
        target: "Wenn Sie Schwierigkeiten mit dem Stoff haben, kommen Sie bitte nach der Stunde zu mir oder vereinbaren Sie eine Nachhilfestunde.",
      },
      {
        en: "Your mid-term grade will include participation, your essay, and the written exam at the end of the month.",
        target: "Ihre Zwischennote setzt sich aus Beteiligung, Ihrem Aufsatz und der schriftlichen Prüfung am Ende des Monats zusammen.",
      },
      {
        en: "Before we finish, are there any questions about the assignment or the topics covered today?",
        target: "Bevor wir schließen — gibt es Fragen zur Aufgabe oder zu den heute behandelten Themen?",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "Buongiorno, ragazzi. Per favore sistematevi e tirate fuori i quaderni — cominciamo subito.",
      },
      {
        en: "Today's lesson is on the Italian Risorgimento — we will look at the roles of Garibaldi, Mazzini, and Cavour.",
        target: "La lezione di oggi riguarda il Risorgimento italiano — esamineremo i ruoli di Garibaldi, Mazzini e Cavour.",
      },
      {
        en: "For homework, you need to read chapter nine and answer the questions at the end of the chapter.",
        target: "Per i compiti a casa dovete leggere il capitolo nove e rispondere alle domande alla fine del capitolo.",
      },
      {
      ...
      },
      {
        ...
        target: "Ottima risposta, Sofia. Puoi approfondire e spiegare perché l'unificazione fu significativa per i cittadini comuni?",
      },
      {
        en: "I will be distributing the graded tests from last week — please review my comments and come to me with any questions.",
        target: "Distribuirò i test corretti della settimana scorsa — vi prego di leggere i miei commenti e di venire da me se avete domande.",
      },
      {
        en: "The written exam is in three weeks. I will provide a study guide at the end of this week.",
        target: "L'esame scritto è tra tre settimane. Fornirò una guida allo studio entro la fine di questa settimana.",
      },
      {
        en: "If anyone is struggling with the material, please let me know — we can arrange extra support during the lunch break.",
        target: "Se qualcuno ha difficoltà con il materiale, fatemi sapere — possiamo organizzare un supporto aggiuntivo durante la pausa pranzo.",
      },
      {
        en: "Before the bell, make sure your name and class section are written on every assignment you hand in.",
        target: "Prima del suono della campanella, assicuratevi che il vostro nome e la sezione siano scritti su ogni compito che consegnate.",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target: "おはようございます、みなさん。席についてください。教科書の53ページを開いてください。",
      },
      {
      ...
      },
      {
        ...
        target: "次の10分間は全員静かにプリントに取り組んでください。その後、一緒に答え合わせをします。",
      },
      {
    ...
    sentences: [
      {
        ...
        target: "Boa tarde, turma. Por favor se acalmem e guardem os celulares antes de começarmos.",
      },
      {
        en: "This semester we will cover three major units: ecology, genetics, and the human body systems.",
        target: "Neste semestre vamos abordar três unidades principais: ecologia, genética e os sistemas do corpo humano.",
      },
      {
        en: "For each unit there will be a project, a quiz, and a written exam — participation in class also counts for your grade.",
        target: "Em cada unidade haverá um projeto, um teste rápido e uma prova escrita — a participação em aula também conta para a nota.",
      },
      {
        en: "Luana, your assignment is two days late. Come speak with me after class so we can figure out a plan.",
        target: "Luana, sua tarefa está dois dias atrasada. Venha falar comigo depois da aula para que possamos traçar um plano.",
      },
      {
        ...
        target: "Na reunião de pais e professores do mês que vem, discutirei o progresso de cada aluno, seus pontos fortes e as áreas que precisam de apoio.",
      },
      {
        ...
        target: "Alunos com um PEI ou plano 504 receberão os acomodamentos descritos em seus documentos — por favor, me lembrem no início de qualquer avaliação.",
      },
      {
        ...
        target: "Seu diário de leitura deve ser entregue toda segunda-feira de manhã — registre o título, o autor e pelo menos três frases sobre o que leu.",
      },
      {
        ...
        target: "Encorajo todos os alunos a visitarem a biblioteca escolar pelo menos uma vez por semana — a leitura fora da sala de aula faz uma diferença real.",
      },
      {
  ...
  // Korean — café barista taking an order (A2)
  {
    ...
    sentences: [
      ...
      { en: "I would like one iced Americano and one hot latte, please.", target: "아이스 아메리카노 한 잔하고 따뜻한 라떼 한 잔 주세요." },
      { en: "Would you like the Americano as a regular or a large size?", target: "아메리카노는 보통 사이즈로 드릴까요, 큰 사이즈로 드릴까요?" },
      { en: "Large, please. And can I have less ice in it?", target: "큰 사이즈로요. 그리고 얼음은 좀 적게 넣어 주세요." },
      { en: "Sure. For the latte, would you like regular milk or oat milk?", target: "네, 알겠습니다. 라떼는 일반 우유로 드릴까요, 귀리 우유로 드릴까요?" },
      { en: "Oat milk, please. Is there an extra charge for that?", target: "귀리 우유로 부탁드려요. 추가 요금이 있나요?" },
      { en: "Yes, it is five hundred won extra. The total is eleven thousand won.", target: "네, 오백 원 추가됩니다. 총 만 천 원입니다." },
      { en: "Will you have it here or to take away?", target: "매장에서 드시고 가실 건가요, 포장이세요?" },
      { en: "To take away, please. Can I get a carrier?", target: "포장해 주세요. 캐리어 하나 받을 수 있을까요?" },
      { en: "Of course. Your drinks will be ready in about three minutes.", target: "물론이죠. 음료는 삼 분쯤 후에 준비됩니다." },
    ],
  },
  ...
  // Korean — university office hours conversation (B2)
  {
    ...
    level: "B2",
    sentences: [
      { en: "Professor, thank you for taking the time to meet with me during your office hours.", target: "교수님, 면담 시간에 시간을 내 주셔서 감사합니다." },
      { en: "Of course. I read the proposal you sent last week — please tell me what your central question is.", target: "별말씀을요. 지난주에 보내 주신 연구 제안서를 읽어 봤습니다. 중심 연구 질문이 무엇인지 말씀해 보세요." },
      { en: "I would like to investigate how social media use is influencing the political participation of Korean college students.", target: "한국 대학생들의 정치 참여에 소셜 미디어 사용이 어떻게 영향을 미치는지 연구하고 싶습니다." },
      { en: "It is a worthwhile topic, but the scope is still too broad for a master's thesis.", target: "가치 있는 주제이지만, 석사 논문으로는 아직 범위가 너무 넓습니다." },
      { en: "I suggest you narrow it down to a specific platform and a specific kind of political behavior.", target: "특정 플랫폼과 특정 종류의 정치적 행동으로 범위를 좁혀 보시기를 권합니다." },
      { en: "I was thinking of focusing on YouTube and on offline protest participation rather than online opinions.", target: "온라인 의견보다는 유튜브와 오프라인 시위 참여에 초점을 맞추려고 생각하고 있었습니다." },
      { en: "That is a much more manageable design, and there is enough existing literature to build on.", target: "그게 훨씬 다루기 쉬운 설계이고, 토대로 삼을 만한 선행 연구도 충분합니다." },
      { en: "For your methodology, will you use a survey, in-depth interviews, or both?", target: "연구 방법으로는 설문 조사, 심층 인터뷰, 아니면 둘 다 사용하실 건가요?" },
      { en: "I plan to use a survey of about three hundred students and follow-up interviews with twelve of them.", target: "약 삼백 명의 학생을 대상으로 설문 조사를 하고 그중 열두 명과 후속 인터뷰를 진행할 계획입니다." },
      { en: "Good. Submit a revised proposal in two weeks, and we will meet again to refine the interview guide.", target: "좋습니다. 이 주 안에 수정된 제안서를 제출해 주시면, 다시 만나서 인터뷰 가이드를 다듬어 봅시다." },
    ],
  },
];
