...
export const TRADES_SEEDS: LibrarySeed[] = [
  // ── FRAMER ──────────────────────────────────────────────────────────────────

  {
    id: "seed-es-framer-layout",
    title: "Framer — Trazado y Encuadre",
    subtitle: "Instrucciones de layout en obra",
    language: "Spanish",
    targetLabel: "Español",
    flag: "🇲🇽",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Marca una línea de tiza desde la esquina hasta la señal en dieciséis pies.",
      },
      {
      ...
      },
      {
        ...
        target: "La pared de carga corre paralela a la cumbrera — no la muevas sin aprobación.",
      },
      {
      ...
      },
      {
        ...
        target: "Aploma la esquina antes de clavarla — usa el nivel en las dos caras.",
      },
      {
  ...
  {
    id: "seed-fr-framer-lumber",
    title: "Charpentier — Commande de matériaux",
    subtitle: "Commande de bois de charpente",
    language: "French",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Pouvez-vous livrer le chargement de bois lundi matin avant sept heures ?",
      },
      {
        en: "We're short on joist hangers — add a box of the LUS210 to the order.",
        target: "Il nous manque des étriers de solive — ajoutez une boîte de LUS210 à la commande.",
      },
      {
      ...
      },
      {
        ...
        target: "La poutre faîtière doit être un quatre par douze, pas un deux par douze.",
      },
      {
  ...
  {
    id: "seed-de-framer-studs",
    title: "Zimmermann — Ständerwerk und Sparren",
    subtitle: "Arbeit mit Ständern und Dachsparren",
    language: "German",
    targetLabel: "Deutsch",
    flag: "🇩🇪",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Hier bauen wir eine tragende Wand, also Doppelständer an jeder Ecke.",
      },
      {
      ...
      },
      {
        ...
        target: "Die Rohöffnung für das Fenster ist zwei Zoll breiter gerahmt als das Fenstermaß.",
      },
      {
  ...
  {
    id: "seed-it-framer-beams",
    title: "Carpentiere — Travi e Struttura",
    subtitle: "Installazione di travi portanti",
    language: "Italian",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Abbassa la trave lentamente — due persone per ogni estremità, tienila in bolla.",
      },
      {
      ...
      },
      {
        ...
        target: "Il bloccaggio a metà campata impedisce ai travetti di torcersi sotto carico.",
      },
      {
    ...
    sentences: [
      {
        ...
        target: "壁を打ち付ける前に、水準器を使って完全に垂直になっているか確認してください。",
      },
      {
        en: "The corner post must be plumb in both directions — check with the level on all four faces.",
        target: "隅柱は両方向で垂直でなければなりません — 四面すべてで水準器を確認してください。",
      },
      {
        en: "Snap a chalk line to mark the stud layout at sixteen inches on center.",
        target: "墨付けで16インチ間隔の柱の位置をマークしてください。",
      },
      {
        en: "The wall is out of plumb by half an inch — brace it before we continue.",
        target: "壁が半インチ傾いています — 続ける前に仮筋交いを入れてください。",
      },
      {
        en: "Check the diagonal measurement to confirm the floor deck is square.",
        target: "対角線の寸法を確認して、床デッキが直角になっているか確かめてください。",
      },
      {
        en: "The ridge board has to be level — adjust the temporary support post.",
        target: "棟木は水平でなければなりません — 仮の支持柱を調整してください。",
      },
      {
        en: "Once all walls are plumb and braced, we can start setting the roof rafters.",
        target: "すべての壁が垂直で仮筋交いが入ったら、垂木の取り付けを始めます。",
      },
      {
        en: "This header is bowed — we need a straighter piece before we set it.",
        target: "この梁は曲がっています — 取り付ける前に真っ直ぐな材料が必要です。",
      },
      {
        en: "Mark the sheathing layout with a pencil so we know where the studs are.",
        target: "柱の位置が分かるように、鉛筆で構造用面材の割り付けをマークしてください。",
      },
    ],
  },
  {
    id: "seed-pt-framer-sheathing",
    title: "Carpinteiro — Fechamento e Revestimento",
    subtitle: "Aplicação do revestimento estrutural",
    language: "Portuguese",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Preguie o OSB a cada seis polegadas nas bordas e a cada doze polegadas no miolo.",
      },
      {
        en: "Stagger the joints on adjacent rows — don't line them up with the row below.",
        target: "Defase as juntas entre fiadas adjacentes — não alinhe com a fileira abaixo.",
      },
      {
        en: "Leave an eighth-inch gap between panels to allow for expansion.",
        target: "Deixe um espaço de um oitavo de polegada entre as chapas para expansão.",
      },
      {
      ...
      },
      {
        ...
        target: "Hoje vamos envolver a casa — grampeie bem a manta impermeável sem deixar folgas.",
      },
      {
      ...
      },
      {
        ...
        target: "As chapas de revestimento estrutural devem ter as fibras orientadas na vertical.",
      },
      {
        en: "Once the sheathing is complete, we can schedule the framing inspection.",
        target: "Com o revestimento concluído, podemos agendar a vistoria da estrutura.",
      },
    ],
  },
  ...
  {
    id: "seed-es-plumber-leak",
    title: "Plomero — Diagnóstico de Fugas",
    subtitle: "Localización y reparación de fugas",
    language: "Spanish",
    targetLabel: "Español",
    flag: "🇲🇽",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Necesito cerrar el suministro principal de agua antes de poder reparar esta fuga.",
      },
      {
      ...
      },
      {
        ...
        target: "Esa unión nunca se soldó bien — tendremos que cortarla y rehacer el trabajo.",
      },
      {
        en: "The P-trap under the sink is cracked — that's where the water is coming from.",
        target: "El sifón bajo el lavabo está agrietado — de ahí viene el agua.",
      },
      {
      ...
      },
      {
        ...
        target: "Abre agua en cada accesorio y revisa el medidor para ver si todavía se mueve.",
      },
      {
  ...
  {
    id: "seed-fr-plumber-pipe",
    title: "Plombier — Tuyauterie et Raccords",
    subtitle: "Installation de tuyaux et raccordements",
    language: "French",
    targetLabel: "Français",
    flag: "🇫🇷",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Appliquez du flux sur le raccord et sur l'extrémité du tuyau avant de chauffer.",
      },
      {
      ...
      },
      {
        ...
        target: "Utilisez un manchon, pas un union, sur cette portion cachée derrière le mur.",
      },
      {
      ...
      },
      {
        ...
        target: "Test de pression à cent psi pendant dix minutes avant de fermer le mur.",
      },
      {
  ...
  {
    id: "seed-de-plumber-valve",
    title: "Klempner — Absperrung und Ventile",
    subtitle: "Absperrventile und Druckregulierung",
    language: "German",
    targetLabel: "Deutsch",
    flag: "🇩🇪",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Das Sicherheitsventil am Boiler tropft — tausch es aus, bevor es ganz versagt.",
      },
      {
  ...
  {
    id: "seed-it-plumber-drain",
    title: "Idraulico — Scarichi e Fognature",
    subtitle: "Pulizia e riparazione di scarichi",
    language: "Italian",
    targetLabel: "Italiano",
    flag: "🇮🇹",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "L'ispezione di pulizia è sotto quel coperchio vicino alla fondazione — aprila.",
      },
      {
      ...
      },
      {
        ...
        target: "Quel raccordo ABS è incrinato — taglialo e incolla un nuovo giunto.",
      },
      {
  ...
  {
    id: "seed-ja-plumber-heater",
    title: "配管工 — 給湯器とウォーターヒーター",
    subtitle: "給湯器の設置と交換",
    language: "Japanese",
    targetLabel: "日本語",
    flag: "🇯🇵",
    ...
    sentences: [
      {
        ...
        target: "給湯器は12年経っています — 故障する前に交換する時期です。",
      },
      {
        en: "Shut off the gas supply and cold water inlet before disconnecting the unit.",
        target: "ユニットを切り離す前に、ガス供給と冷水入口を閉めてください。",
      },
      {
        en: "The new unit is a fifty-gallon tank — make sure the platform can support the weight.",
        target: "新しいユニットは50ガロンタンクです — 台が重量を支えられるか確認してください。",
      },
      {
        en: "Connect the cold supply on the right and the hot outlet on the left.",
        target: "右側に冷水供給、左側に温水出口を接続してください。",
      },
      {
        en: "The temperature and pressure relief valve must discharge into a drain or to the exterior.",
        target: "温度圧力逃し弁は排水管か外部に排出しなければなりません。",
      },
      {
        en: "Set the thermostat to one hundred twenty degrees Fahrenheit to prevent scalding.",
        target: "やけどを防ぐために、サーモスタットを華氏120度に設定してください。",
      },
      {
      ...
      },
      {
        ...
        target: "現場を離れる前に、石鹸水で全ての接続部を確認してください。",
      },
      {
        en: "The expansion tank is required by code on all closed water systems.",
        target: "法律により、すべての密閉給水システムに膨張タンクが必要です。",
      },
    ],
  },
  {
    id: "seed-pt-plumber-sewer",
    title: "Encanador — Esgoto e Coleta",
    subtitle: "Instalação de tubulação de esgoto",
    language: "Portuguese",
    targetLabel: "Português",
    flag: "🇧🇷",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "A prefeitura exige uma vistoria antes de aterrar a vala de esgoto.",
      },
    ],
  },
  ...
  {
    id: "seed-es-drywall-mud",
    title: "Yesero — Masilla y Acabados",
    subtitle: "Aplicación de masilla y acabados",
    language: "Spanish",
    targetLabel: "Español",
    flag: "🇲🇽",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "La unión necesita un mínimo de tres capas antes de estar lista para el primer.",
      },
      {
      ...
      },
      {
        ...
        target: "Esa esquinera está torcida — quítala y reponla antes de cubrir con masilla.",
      },
      {
        en: "Feather the edges out at least eight inches on each side of the seam.",
        target: "Desvanece los bordes al menos ocho pulgadas a cada lado de la unión.",
      },
      {
  ...
  {
    id: "seed-fr-drywall-taping",
    title: "Plaquiste — Entoilage et Joints",
    subtitle: "Entoilage et finition des joints",
    language: "French",
    targetLabel: "Français",
    flag: "🇫🇷",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Appliquez l'enduit de joint sur le joint, puis pressez la bande avec le couteau.",
      },
      {
        en: "Wipe excess compound from the tape in one smooth stroke — no ridges.",
        target: "Enlevez l'excédent d'enduit de la bande en un seul coup lisse — aucune crête.",
      },
      {
      ...
      },
      {
        ...
        target: "La couche de finition doit être si fine qu'on peut presque voir à travers.",
      },
      {
  ...
  {
    id: "seed-de-drywall-texture",
    title: "Trockenbauer — Spachtel und Textur",
    subtitle: "Oberflächenbehandlung und Texturierung",
    language: "German",
    targetLabel: "Deutsch",
    flag: "🇩🇪",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Wir sprühen eine Orangenhaut-Textur — stell den Kompressor auf dreißig PSI ein.",
      },
      {
        en: "Test the texture pattern on a scrap board before spraying the wall.",
        target: "Teste das Texturmuster auf einem Restholz, bevor du die Wand sprühst.",
      },
      {
      ...
      },
      {
        ...
        target: "Schleif den Glättputz in langen, gleichmäßigen Zügen ab — kein Kreisschleifen.",
      },
      {
      ...
      },
      {
        ...
        target: "Misch das Texturgut auf eine dünne, gleichmäßige Konsistenz — keine Klumpen.",
      },
      {
        en: "Check the surface under a raking light before calling the job done.",
        target: "Prüf die Oberfläche unter Streiflicht, bevor du den Job als fertig erklärst.",
      },
    ],
  },
  {
    id: "seed-it-drywall-corner",
    title: "Cartongessista — Spigoli e Angoli",
    subtitle: "Profili angolari e finiture",
    language: "Italian",
    targetLabel: "Italiano",
    flag: "🇮🇹",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Chioda il profilo angolare ogni venti centimetri così non si curva o sposta.",
      },
      {
      ...
      },
      {
        ...
        target: "Sfuma lo stucco dal profilo per almeno venticinque centimetri su ogni lato.",
      },
      {
      ...
      },
      {
        ...
        target: "Tre mani su tutti i profili e lascia asciugare ognuna prima di carteggiare.",
      },
      {
  ...
  {
    id: "seed-ja-drywall-sand",
    title: "ドライウォール職人 — 研磨と仕上げ",
    subtitle: "パテ研磨と最終仕上げ",
    language: "Japanese",
    targetLabel: "日本語",
    flag: "🇯🇵",
    ...
    sentences: [
      {
        ...
        target: "乾いたパテを滑らかに研磨し、湿った布で全ての粉塵を拭き取ってください。",
      },
      {
        en: "Don't over-sand — you'll cut through the tape and have to start the seam over.",
        target: "研磨し過ぎないように — テープを削り取ってしまうと継ぎ目をやり直しになります。",
      },
      {
      ...
      },
      {
        ...
        target: "仕上げのパテは非常に薄くします — テープが透けて見えるくらいが目安です。",
      },
      {
        en: "Check for imperfections with a low-angle work light before priming.",
        target: "下塗りをする前に、斜め照明を使って凹凸を確認してください。",
      },
      {
        en: "Prime the entire surface with drywall primer so the paint absorbs evenly.",
        target: "塗料が均一に吸収されるように、全面にドライウォール用プライマーを塗ってください。",
      },
      {
        en: "Dust control matters — wear a respirator when sanding and open a window.",
        target: "粉塵対策は重要です — 研磨時はマスクを着用し窓を開けてください。",
      },
      {
        en: "The screw heads need to be set just below flush and filled with compound.",
        target: "ネジ頭は表面よりわずかに深く埋め込み、パテで充填してください。",
      },
      {
  ...
  {
    id: "seed-pt-drywall-fasteners",
    title: "Drywall — Fixação e Ancoragem",
    subtitle: "Parafusos, buchas e fixação",
    language: "Portuguese",
    targetLabel: "Português",
    flag: "🇧🇷",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Aperte os parafusos até a cabeça fazer uma covinha no papel sem rasgá-lo.",
      },
      {
      ...
      },
      {
        ...
        target: "Marque as posições dos montantes no chão e no teto antes de pendurar a chapa.",
      },
      {
      ...
      },
      {
        ...
        target: "Tampe todas as covinhas com no mínimo duas demãos de massa antes de lixar.",
      },
    ],
  },
  ...
  {
    id: "seed-es-electrician-wiring",
    title: "Electricista — Cableado Residencial",
    subtitle: "Instalación de cableado en construcción nueva",
    language: "Spanish",
    targetLabel: "Español",
    flag: "🇲🇽",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Apaga el breaker y verifica con un probador antes de tocar cualquier cable.",
      },
      {
      ...
      },
      {
        ...
        target: "El cable de tierra siempre va al tornillo verde del tomacorriente.",
      },
      {
      ...
      },
      {
        ...
        target: "El conducto hacia el subtablero necesita sujetarse cada cuatro pies.",
      },
    ],
  },
  {
    id: "seed-fr-electrician-circuit",
    title: "Électricien — Circuits et Disjoncteurs",
    subtitle: "Calcul de charge et protection de circuit",
    language: "French",
    targetLabel: "Français",
    flag: "🇫🇷",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Calculez la charge avant d'ajouter d'autres circuits à ce tableau.",
      },
      {
      ...
      },
      {
        ...
        target: "Ne reliez jamais le neutre et la masse ensemble sauf au tableau principal.",
      },
    ],
  },
  {
    id: "seed-de-electrician-panel",
    title: "Elektriker — Verteilung und Schalttafel",
    subtitle: "Unterverteiler und Schaltkasten",
    language: "German",
    targetLabel: "Deutsch",
    flag: "🇩🇪",
    section: "culture",
  ...
  {
    id: "seed-it-electrician-conduit",
    title: "Elettricista — Cavidotti e Tubazioni",
    subtitle: "Posa di conduit e tubazioni per cavi",
    language: "Italian",
    targetLabel: "Italiano",
    flag: "🇮🇹",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Tira il cavo con la sonda passafilo — fai alimentare dall'altro lato da qualcuno.",
      },
      {
      ...
      },
      {
        ...
        target: "Fissa il conduit ogni tre metri e entro novanta centimetri da ogni cassetta.",
      },
      {
  ...
  {
    id: "seed-ja-electrician-grounding",
    title: "電気工 — アース接地と安全",
    subtitle: "接地工事と漏電保護",
    language: "Japanese",
    targetLabel: "日本語",
    ...
    sentences: [
      {
        ...
        target: "すべての金属製電気ボックスは接地導体に結合されなければなりません。",
      },
      {
        en: "The ground electrode conductor connects the panel to the ground rod at the foundation.",
        target: "接地電極導体は、分電盤を基礎の接地棒に接続します。",
      },
      {
        en: "Test the ground rod resistance — it must be under twenty-five ohms.",
        target: "接地棒の抵抗を測定してください — 25オーム以下でなければなりません。",
      },
      {
        en: "GFCI protection is required in bathrooms, kitchens, garages, and outdoor circuits.",
        target: "浴室、台所、ガレージ、屋外回路にはGFCI保護が必要です。",
      },
      {
        en: "The green wire is always the equipment ground — never use it as a neutral.",
        target: "緑色のワイヤーは常にアース線です — 中性線として使用しないでください。",
      },
      {
        en: "Bond all metallic pipes and ducts to the electrical system grounding.",
        target: "すべての金属パイプと配管を電気システムのアースに結合してください。",
      },
      {
        en: "A GFCI outlet can protect multiple downstream outlets — check the wiring diagram.",
        target: "GFCIコンセントは複数の下流コンセントを保護できます — 配線図を確認してください。",
      },
      {
        en: "Verify continuity of the ground path before energizing any new circuit.",
        target: "新しい回路に電気を通す前に、接地経路の導通を確認してください。",
      },
      {
  ...
  {
    id: "seed-pt-electrician-outlet",
    title: "Eletricista — Tomadas e Interruptores",
    subtitle: "Instalação de tomadas e pontos de luz",
    language: "Portuguese",
    targetLabel: "Português",
    flag: "🇧🇷",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "O fio fase vai no parafuso dourado, o neutro no prateado e o terra no verde.",
      },
      {
      ...
      },
      {
        ...
        target: "Teste cada tomada com um testador antes de fechar a parede.",
      },
      {
      ...
      },
      {
        ...
        target: "Ligue os interruptores de três vias com um cabo de três fios entre eles.",
      },
      {
  ...
  {
    id: "seed-es-landscaper-irrigation",
    title: "Paisajista — Sistema de Riego",
    subtitle: "Instalación y ajuste de riego",
    language: "Spanish",
    targetLabel: "Español",
    flag: "🇲🇽",
    section: "culture",
  ...
  {
    id: "seed-fr-landscaper-plants",
    title: "Paysagiste — Plantation et Entretien",
    subtitle: "Sélection et plantation d'arbustes",
    language: "French",
    targetLabel: "Français",
    flag: "🇫🇷",
    section: "culture",
  ...
  {
    id: "seed-de-landscaper-grading",
    title: "Landschaftsgärtner — Erdarbeiten und Gefälle",
    subtitle: "Geländemodellierung und Wasserableitung",
    language: "German",
    targetLabel: "Deutsch",
    flag: "🇩🇪",
    section: "culture",
    ...
    sentences: [
      {
        ...
        target: "Das Gelände muss vom Fundament weg abfallen — mindestens zwei Prozent Gefälle.",
      },
      {
      ...
      },
      {
        ...
        target: "Die Mulde leitet das Wasser zur Ecke, wo wir das trockene Bachbett anlegen.",
      },
      {
      ...
      },
      {
        ...
        target: "Das Erosionsschutzvlies kommt vor dem Mutterboden auf diesen Hang.",
      },
      {
  ...
  {
    id: "seed-it-landscaper-mulch",
    title: "Giardiniere — Pacciamatura e Drenaggio",
    subtitle: "Applicazione di pacciame e cura del suolo",
    language: "Italian",
    targetLabel: "Italiano",
    flag: "🇮🇹",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Il pacciame in gomma dura meglio nelle aree gioco ma non migliora il terreno.",
      },
      {
    ...
    sentences: [
      {
        ...
        target: "まず枯れ枝を取り除いてから、内側から外側に向けて樹冠を整えます。",
      },
      {
        en: "Make your cut just outside the branch collar — don't leave a stub.",
        target: "枝の付け根の部分のすぐ外側で切ってください — 切り残しを作らないように。",
      },
      {
        en: "Never remove more than a third of the canopy in a single season.",
        target: "一シーズンで樹冠の三分の一以上は絶対に取り除かないでください。",
      },
      {
        en: "Sharpen the pruning shears before each job — clean cuts heal faster.",
        target: "作業前に剪定バサミを研いでください — 切り口がきれいだと早く癒合します。",
      },
      {
        en: "Disinfect your tools between trees to prevent spreading disease.",
        target: "木から木への病気の伝染を防ぐため、木ごとに道具を消毒してください。",
      },
      {
        en: "The hedge needs to be wider at the base than the top to prevent the bottom from dying out.",
        target: "生垣は下部の方が上部より広くなるように刈り込まないと、下が枯れてきます。",
      },
      {
        en: "Spring-flowering shrubs should be pruned right after they bloom, not in fall.",
        target: "春咲きの低木は、秋ではなく花が終わった直後に剪定してください。",
      },
      {
        en: "These ornamental trees are on a two-year pruning cycle — they were done last spring.",
        target: "これらの観賞用樹木は2年ごとの剪定サイクルです — 昨年の春に剪定しました。",
      },
      {
  ...
  {
    id: "seed-pt-landscaper-lawn",
    title: "Paisagista — Gramado e Manutenção",
    subtitle: "Tração de gramado e cuidados semanais",
    language: "Portuguese",
    targetLabel: "Português",
    flag: "🇧🇷",
    section: "culture",
    ...
    sentences: [
      ...
      },
      {
        ...
        target: "Nunca remova mais de um terço do comprimento da lâmina em um único corte.",
      },
      {
      ...
      },
      {
        ...
        target: "Sobressemeie as áreas ralas após a aeração e cubra com um centímetro de composto.",
      },
      {
      ...
      },
      {
        ...
        target: "Sopre os aparos da calçada e do caminho — não os deixe manchar.",
      },
      {
