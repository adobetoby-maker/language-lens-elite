    ...
    sentences: [
      {
        ...
        target:
          "Las balatas del eje delantero tienen solo dos milímetros — muy por debajo del límite seguro.",
      },
      {
        en: "I need to turn the rotors if they're within spec, or replace them if they're under minimum thickness.",
        target:
          "Necesito tornear los discos si están dentro de especificación, o reemplazarlos si están por debajo del espesor mínimo.",
      },
      {
        en: "We also found brake fluid that's dark and contaminated — a flush is strongly recommended.",
        target:
          "También encontramos líquido de frenos oscuro y contaminado — se recomienda un cambio completo.",
      },
      {
        en: "The rear calipers are seized and not releasing evenly, which is causing premature pad wear.",
        target:
          "Las pinzas traseras están agarrotadas y no sueltan de manera uniforme, lo que provoca desgaste prematuro de las balatas.",
      },
      {
        en: "I'm writing up the repair order now — parts and labor come to about $380.",
        target:
          "Estoy haciendo la orden de trabajo ahora — partes y mano de obra suman aproximadamente $380.",
      },
      {
        en: "We carry OEM-equivalent pads, or I can source factory parts if you prefer.",
        target:
          "Tenemos balatas equivalentes OEM, o puedo conseguir piezas originales si lo prefiere.",
      },
      {
        en: "The job will take about two hours once the parts arrive — I can have you out by noon.",
        target:
          "El trabajo tomará unas dos horas una vez que lleguen las piezas — puedo tenerlo listo antes del mediodía.",
      },
      {
        en: "After the brake job, I'll do a road test to confirm proper pedal feel and stopping distance.",
        target:
          "Después del trabajo de frenos, haré una prueba de carretera para confirmar el tacto del pedal y la distancia de frenado.",
      },
      {
        en: "Do you want me to also check the parking brake cable while it's all apart?",
        target:
          "¿Quiere que también revise el cable del freno de mano mientras está todo desmontado?",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "J'ai branché l'outil de diagnostic et récupéré trois codes de défaut — deux sont actifs, un est en attente.",
      },
      {
      ...
      },
      {
        ...
        target:
          "On commencera par remplacer la bobine d'allumage et la bougie sur ce cylindre avant d'aller plus loin.",
      },
      {
        en: "If the misfire comes back after that, we'll need to do a compression and leak-down test.",
        target:
          "Si le raté revient après ça, il faudra faire un test de compression et de perte de charge.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Je recommande de traiter d'abord le raté d'allumage, puis d'effacer les codes et de retester la sonde.",
      },
      {
        en: "Total estimate for both repairs is around €290 with parts and one hour of labor.",
        target:
          "L'estimation totale pour les deux réparations est d'environ 290 € avec les pièces et une heure de main-d'œuvre.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Das Automatikgetriebeöl ist dunkelbraun und riecht verbrannt — es muss sofort gewechselt werden.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Wir nehmen die Ölwanne ab, reinigen den Magneten, wechseln den Filter und füllen mit dem richtigen Spezifikationsöl auf.",
      },
      {
        en: "The solenoid pack is showing wear — I'd like to do a pressure test to confirm before recommending replacement.",
        target:
          "Das Magnetventilpaket zeigt Verschleiß — ich möchte einen Drucktest durchführen, bevor ich einen Austausch empfehle.",
      },
      {
        en: "Torque converter lockup hesitation is often the first sign of solenoid problems.",
        target:
          "Zögerlichkeit beim Einrasten des Drehmomentwandlers ist oft das erste Anzeichen von Magnetventilproblemen.",
      },
      {
        en: "The repair order will document every step, including fluid type, quantity, and torque specs.",
        target:
          "Der Reparaturauftrag wird jeden Schritt dokumentieren, einschließlich Öltyp, Menge und Anzugsmomente.",
      },
      {
        en: "After service, I'll test drive it through all shift points to verify smooth operation.",
        target:
          "Nach der Wartung mache ich eine Probefahrt durch alle Schaltpunkte, um den reibungslosen Betrieb zu überprüfen.",
      },
      {
        en: "If the hesitation persists after service, we may be looking at a valve body rebuild.",
        target:
          "Wenn das Zögern nach der Wartung weiterbesteht, müssen wir möglicherweise den Ventilkörper überholen.",
      },
      {
        en: "Total for the transmission service is €185, including labor and OEM-spec ATF.",
        target:
          "Die Getriebeinspektion kostet insgesamt 185 €, einschließlich Arbeit und OEM-spezifischem Automatikgetriebeöl.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "I tuoi pneumatici anteriori sono usurati in modo non uniforme sul bordo interno — è un segnale classico di campanatura negativa.",
      },
      {
        en: "Before we do new tires, let's get an alignment to find out how far out of spec you are.",
        target:
          "Prima di montare gomme nuove, facciamo un assetto per capire quanto siete fuori specifica.",
      },
      {
        en: "I'll put it on the alignment rack and take a baseline reading on all four corners.",
        target:
          "Lo metterò sulla plancia di assetto e prenderò una lettura di base su tutti e quattro gli angoli.",
      },
      {
        en: "The caster and toe values are adjustable, but camber on this model requires an aftermarket kit.",
        target:
          "I valori di caster e convergenza sono regolabili, ma la campanatura su questo modello richiede un kit aftermarket.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Dopo l'assetto, il volante dovrebbe stare perfettamente centrato alla velocità autostradale.",
      },
      {
        en: "The torque spec on the lug nuts is 110 foot-pounds — I always verify with a torque wrench.",
        target:
          "Il valore di coppia per i dadi delle ruote è 150 Nm — verifico sempre con una chiave dinamometrica.",
      },
      {
        en: "Full four-wheel alignment and tire rotation will be about €95.",
        target:
          "L'assetto completo a quattro ruote e la rotazione pneumatici costeranno circa 95 €.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "O óleo na vareta está preto e sujo — você está com cerca de 2.000 quilômetros de atraso para a troca.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Também vou trocar o filtro de óleo e fazer uma inspeção completa de múltiplos pontos enquanto está no elevador.",
      },
      {
        en: "Your air filter is very dirty — it's restricting airflow and affecting fuel economy.",
        target:
          "Seu filtro de ar está muito sujo — está restringindo o fluxo de ar e afetando a economia de combustível.",
      },
      {
        en: "The serpentine belt shows surface cracking — it's not critical yet, but worth noting.",
        target:
          "A correia serpentina mostra rachaduras superficiais — ainda não é crítico, mas vale registrar.",
      },
      {
        en: "Coolant level is good, but the color is orange-brown, which means it's due for a flush.",
        target:
          "O nível do líquido de arrefecimento está bom, mas a cor está alaranjada e marrom, o que indica que precisa de troca.",
      },
      {
        en: "I'll print the full inspection report so you can see everything we checked today.",
        target:
          "Vou imprimir o relatório completo de inspeção para que você veja tudo que verificamos hoje.",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "Orílese a la báscula — necesito verificar su peso bruto vehicular y el peso por eje.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Asegúrese de que su descanso de 30 minutos esté correctamente anotado — los inspectores lo revisan.",
      },
      {
        en: "Your manifest matches the bill of lading — load looks good from a paperwork standpoint.",
        target:
          "Su manifiesto coincide con el conocimiento de embarque — la carga está bien desde el punto de vista documental.",
      },
      {
        en: "I need to verify your hazmat placard matches what's listed on the shipping papers.",
        target:
          "Necesito verificar que su placa de materiales peligrosos coincida con lo indicado en los documentos de envío.",
      },
      {
        en: "You're cleared to go — have a safe run and watch for construction on I-80 eastbound.",
        target:
          "Está autorizado para continuar — tenga un viaje seguro y preste atención a la obra en la I-80 en dirección este.",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "Dispatch, ici le véhicule 47 — je suis chargé et je quitte le dépôt, direction Lyon.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Reçu — mettez à jour votre ETA dans le système de suivi et avertissez le destinataire.",
      },
      {
        en: "I'm stopping at the rest area near Vienne — I need my mandatory 45-minute break.",
        target:
          "Je m'arrête à l'aire de repos près de Vienne — j'ai besoin de ma pause obligatoire de 45 minutes.",
      },
      {
        en: "Can you confirm the dock number at Lyon? The manifest says dock 7 but the receiver said dock 12.",
        target:
          "Pouvez-vous confirmer le numéro de quai à Lyon ? Le manifeste indique le quai 7 mais le destinataire a dit le quai 12.",
      },
      {
        en: "I'll call the Lyon dock directly to confirm — stand by on channel 9.",
        target:
          "Je vais appeler directement le quai de Lyon pour confirmer — restez sur le canal 9.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Bitte halten Sie Ihren CMR-Frachtbrief, die Zollerklärung und Ihren Führerschein bereit.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Die Ladung besteht aus 18 Paletten Kfz-Teilen — der Gesamtdeklarationswert beträgt 42.000 €.",
      },
      {
        en: "Pull around to bay 3 — we need to do a physical inspection of the cargo.",
        target:
          "Fahren Sie bitte zu Halle 3 — wir müssen eine physische Kontrolle der Ladung durchführen.",
      },
      {
        en: "The seals on the trailer match the numbers on the transit document — everything checks out.",
        target:
          "Die Plomben am Auflieger stimmen mit den Nummern auf dem Versandpapier überein — alles ist in Ordnung.",
      },
      {
        en: "Your cabotage permit is valid for two more days — make sure you exit Germany before it expires.",
        target:
          "Ihre Kabotage-Genehmigung ist noch zwei Tage gültig — stellen Sie sicher, dass Sie Deutschland vor dem Ablauf verlassen.",
      },
      {
        en: "The toll transponder for German autobahns must be activated before you proceed.",
        target:
          "Das Mautgerät für deutsche Autobahnen muss aktiviert sein, bevor Sie weiterfahren.",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "Fate retromarcia fino alla banchina numero 4 — iniziamo a caricare tra circa 20 minuti.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Il manifesto indica 240 casse di olio d'oliva — assicurati che il conteggio dei pallet corrisponda prima di partire.",
      },
      {
        en: "The stretch wrap on pallet 3 is damaged — we need to rewrap it before loading.",
        target:
          "Il film estensibile sul pallet 3 è danneggiato — dobbiamo avvolgerlo di nuovo prima del carico.",
      },
      {
        en: "What's the maximum load height for your trailer? We need to know before we stack.",
        target:
          "Qual è l'altezza massima del carico per il tuo rimorchio? Dobbiamo saperlo prima di impilare.",
      },
      {
        en: "Temperature in the reefer unit is set to 4 degrees Celsius — confirm on your end.",
        target:
          "La temperatura nell'unità refrigerante è impostata a 4 gradi Celsius — conferma dalla tua parte.",
      },
      {
        en: "Total weight loaded is 19.4 tonnes — you are well within your axle weight limits.",
        target:
          "Il peso totale caricato è 19,4 tonnellate — sei ampiamente entro i limiti di peso per asse.",
      },
      {
        en: "Here's your delivery receipt — keep a copy and leave the original at the destination.",
        target:
          "Ecco la tua ricevuta di consegna — tieni una copia e lascia l'originale alla destinazione.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target:
          "Tem um posto de combustível com pátio de caminhões no quilômetro 355 se precisar descansar.",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "Júntense alrededor de los planos — necesitamos repasar el diseño de la cimentación antes de que su cuadrilla comience.",
      },
      {
        en: "The structural engineer revised the rebar schedule — the updated drawings are what we're working from today.",
        target:
          "El ingeniero estructural revisó el plan de varilla — los planos actualizados son con los que trabajamos hoy.",
      },
      {
        en: "On sheet A3, the footing depth along the north wall changes from 18 inches to 24 inches.",
        target:
          "En la hoja A3, la profundidad del cimiento a lo largo de la pared norte cambia de 18 pulgadas a 24 pulgadas.",
      },
      {
        en: "Do NOT use the old drawings — I saw someone with a revision-1 set this morning and that's a problem.",
        target:
          "NO usen los planos anteriores — vi a alguien con un juego de revisión-1 esta mañana y eso es un problema.",
      },
      {
        en: "The electrical subcontractor needs to coordinate conduit sleeves before the slab is poured.",
        target:
          "El subcontratista eléctrico necesita coordinar los tubos conduit antes de que se vierta la losa.",
      },
      {
        en: "What is your crew's pour date? We need to confirm with the ready-mix plant 48 hours in advance.",
        target:
          "¿Cuál es la fecha de colado de su cuadrilla? Necesitamos confirmar con la planta de concreto con 48 horas de anticipación.",
      },
      {
        en: "The permit card stays on the fence post until the building inspector closes it out.",
        target:
          "La tarjeta del permiso se queda en el poste de la cerca hasta que el inspector de edificación la cierre.",
      },
      {
        en: "If you hit any underground utilities during excavation, stop immediately and call the line locating service.",
        target:
          "Si encuentran servicios subterráneos durante la excavación, deténganse de inmediato y llamen al servicio de localización de líneas.",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "L'inspecteur du bâtiment arrive à 8h00 — j'ai besoin que toutes les équipes aient leurs zones propres et accessibles.",
      },
      {
        en: "The rough framing inspection covers floor, wall, and roof framing — everything must be visible.",
        target:
          "L'inspection du gros œuvre porte sur le plancher, les murs et la charpente — tout doit être visible.",
      },
      {
        en: "Make sure all temporary bracing is still in place — the inspector will check lateral stability.",
        target:
          "Assurez-vous que tous les étrésillons temporaires sont encore en place — l'inspecteur vérifiera la stabilité latérale.",
      },
      {
        en: "The permit must be posted on the exterior fence — is it still there after last night's wind?",
        target:
          "Le permis doit être affiché sur la clôture extérieure — est-il encore là après le vent d'hier soir ?",
      },
      {
        en: "Subcontractors: your work areas need to be clear of debris before the inspector walks through.",
        target:
          "Sous-traitants : vos zones de travail doivent être dégagées des débris avant le passage de l'inspecteur.",
      },
      {
        en: "If the inspector finds a deficiency, we stop work in that section until it's corrected and re-inspected.",
        target:
          "Si l'inspecteur constate une déficience, nous arrêtons le travail dans cette section jusqu'à correction et nouvelle inspection.",
      },
      {
        en: "The schedule shows we need this inspection passed by Thursday to stay on track for the concrete pour.",
        target:
          "Le calendrier montre que nous devons passer cette inspection avant jeudi pour respecter le programme du coulage de béton.",
      },
      {
        en: "Any questions about what the inspector is looking for? I've done 40 of these — ask me now.",
        target:
          "Des questions sur ce que l'inspecteur cherche ? J'en ai fait 40 — posez vos questions maintenant.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Wir liegen derzeit drei Tage hinter dem Zeitplan bei den Fundamentarbeiten — das müssen wir aufholen.",
      },
      {
        en: "The concrete subcontractor cannot begin until the formwork is completed and inspected.",
        target:
          "Der Betonsubunternehmer kann nicht beginnen, bis die Schalung fertiggestellt und abgenommen ist.",
      },
      {
        en: "I need your crew to work an extra two hours tomorrow to keep the formwork on schedule.",
        target:
          "Ich brauche Ihre Mannschaft, um morgen zwei Stunden länger zu arbeiten, damit die Schalung im Zeitplan bleibt.",
      },
      {
        en: "The electrical crew is coming on Tuesday — the rough framing must be done before they arrive.",
        target:
          "Die Elektromannschaft kommt am Dienstag — der Rohbau muss fertig sein, bevor sie ankommen.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Aktualisieren Sie den Projektzeitplan täglich im Baustellenordner — der Generalunternehmer überprüft ihn jeden Morgen.",
      },
      {
        en: "Material deliveries for the week are: rebar Tuesday, formwork panels Wednesday, concrete Friday.",
        target:
          "Materiallieferungen für die Woche: Bewehrungsstahl Dienstag, Schalungsplatten Mittwoch, Beton Freitag.",
      },
      {
        en: "Any subcontractor who needs a schedule change must submit a written request by end of day.",
        target:
          "Jeder Nachunternehmer, der eine Terminänderung benötigt, muss bis Tagesende einen schriftlichen Antrag einreichen.",
      },
      {
        en: "Let's meet again at 3:00 PM to assess progress and adjust tomorrow's assignments.",
        target:
          "Treffen wir uns wieder um 15:00 Uhr, um den Fortschritt zu bewerten und die Aufgaben für morgen anzupassen.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Il permesso edilizio è stato approvato — possiamo iniziare la demolizione lunedì mattina.",
      },
      {
        en: "Keep the permit posted on the exterior hoarding — the municipality can stop the job if it's missing.",
        target:
          "Tieni il permesso esposto sul pannello esterno — il comune può fermare i lavori se manca.",
      },
      {
        en: "We need to notify the utility companies 72 hours before we start any underground excavation.",
        target:
          "Dobbiamo notificare le aziende di servizi 72 ore prima di iniziare qualsiasi scavo sotterraneo.",
      },
      {
        en: "The structural engineer must sign off on the rebar placement before we pour the slab.",
        target:
          "L'ingegnere strutturale deve approvare il posizionamento del ferro prima che coleiamo la soletta.",
      },
      {
        en: "There is an asbestos survey requirement before any demolition work on the east wing.",
        target:
          "È richiesta una perizia amianto prima di qualsiasi lavoro di demolizione sull'ala est.",
      },
      {
        en: "All workers must have their competence cards on them during the inspection.",
        target:
          "Tutti i lavoratori devono avere con sé il tesserino di idoneità durante l'ispezione.",
      },
      {
        en: "Safety coordinator: I need the risk assessment document updated before Friday.",
        target:
          "Coordinatore della sicurezza: ho bisogno del documento di valutazione dei rischi aggiornato entro venerdì.",
      },
      {
        en: "Any change to the scope of work that affects structure or fire safety needs a permit amendment.",
        target:
          "Qualsiasi modifica al progetto che riguardi la struttura o la sicurezza antincendio richiede una variante al permesso.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "よく聞いてください。金曜日のコンクリート打設に絶対的な締め切りがあります。全員が集中する必要があります。",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "Antes de começar, preciso fazer o DDS — diálogo diário de segurança — para as tarefas de hoje.",
      },
      {
        en: "We're working at heights today — everyone on the scaffold must be tied off at 100%.",
        target:
          "Hoje trabalhamos em altura — todos no andaime precisam estar com 100% de ancoragem.",
      },
      {
        en: "The subcontractor for plumbing roughed-in needs to coordinate with the framing crew on the second floor.",
        target:
          "O subempreiteiro de encanamento de instalação precisa coordenar com a equipe de estrutura no segundo andar.",
      },
      {
      ...
      },
      {
        ...
        target:
          "A concretagem está programada para quinta-feira às 6h — garanta que o ferreiro esteja pronto na noite anterior.",
      },
      {
        en: "We have a deadline penalty clause — every day past Friday costs the company R$5,000.",
        target:
          "Temos uma cláusula de multa por prazo — cada dia após sexta-feira custa R$5.000 à empresa.",
      },
      {
        en: "The municipal inspector will be here at 2 PM — all permits and inspection logs must be visible.",
        target:
          "O fiscal municipal estará aqui às 14h — todos os alvarás e registros de vistoria devem estar visíveis.",
      },
      {
        en: "Any questions? Good — let's get to work and make this a clean, safe day on the job.",
        target:
          "Alguma pergunta? Ótimo — vamos trabalhar e fazer deste dia um dia limpo e seguro na obra.",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target:
          "Antes de ordeñar, haz una prueba previa en cada cuarto y revisa si hay coágulos o decoloración.",
      },
      {
        en: "If you see stringy or flaky milk, flag that cow and pull a sample for the California Mastitis Test.",
        target:
          "Si ves leche fibrosa o con escamas, marca esa vaca y toma una muestra para la prueba de mastitis de California.",
      },
      {
        en: "All cows positive on CMT go into the hospital pen — do not add their milk to the bulk tank.",
        target:
          "Todas las vacas positivas en CMT van al corral de hospital — no agreguen su leche al tanque de almacenamiento.",
      },
      {
        en: "Teat dip after every cow — pre-dip, dry with a clean towel, then attach the unit.",
        target:
          "Sella los pezones después de cada vaca — predipping, seca con una toalla limpia y luego coloca la unidad.",
      },
      {
        en: "The milking unit vacuum should be set at 42 kPa — check the gauge at the start of each shift.",
        target:
          "El vacío de la unidad de ordeño debe estar a 42 kPa — revisa el manómetro al inicio de cada turno.",
      },
      {
        en: "Average milking time per cow should be between 4 and 6 minutes — anything longer may indicate problems.",
        target:
          "El tiempo promedio de ordeño por vaca debe ser entre 4 y 6 minutos — cualquier tiempo mayor puede indicar problemas.",
      },
      {
        en: "Record milk weight for each cow in the herd management system after every milking.",
        target:
          "Registra el peso de leche de cada vaca en el sistema de gestión de hato después de cada ordeño.",
      },
      {
        en: "We're targeting a somatic cell count below 200,000 — the last test was 185,000, so keep it up.",
        target:
          "Estamos apuntando a un conteo de células somáticas por debajo de 200,000 — el último fue 185,000, así que sigan así.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "La nutritionniste a révisé la ration totale mélangée — la nouvelle formule augmente l'ensilage de maïs de 2 kilos par vache.",
      },
      {
        en: "Make sure the TMR mixer runs for at least 12 minutes to get a consistent blend.",
        target:
          "Assurez-vous que le mélangeur TMR tourne au moins 12 minutes pour obtenir un mélange homogène.",
      },
      {
        en: "The dry cows get a different ration — do not mix them with the lactating herd at the feed bunk.",
        target:
          "Les vaches taries ont une ration différente — ne les mélangez pas avec le troupeau en lactation à l'auge.",
      },
      {
        en: "Fresh heifers need extra attention the first 30 days — watch their dry matter intake closely.",
        target:
          "Les génisses fraîches nécessitent une attention particulière les 30 premiers jours — surveillez de près leur consommation de matière sèche.",
      },
      {
        en: "The pasture grass is going to seed — time to cut and bale the back fields this week.",
        target:
          "L'herbe des pâtures monte en graine — il est temps de couper et botteler les champs du fond cette semaine.",
      },
      {
        en: "Grain price is up — the nutritionist will look at substituting distillers grains to keep feed cost down.",
        target:
          "Le prix des céréales a augmenté — la nutritionniste va étudier la substitution par des drêches de distillerie pour réduire le coût alimentaire.",
      },
      {
        en: "Log every feed delivery in the farm record book — include date, supplier, quantity, and lot number.",
        target:
          "Consignez chaque livraison d'aliments dans le registre de la ferme — incluez la date, le fournisseur, la quantité et le numéro de lot.",
      },
      {
        en: "During the heat wave, push feed twice daily to keep intake up — cows go off feed in the heat.",
        target:
          "Pendant la canicule, poussez l'alimentation deux fois par jour pour maintenir la consommation — les vaches réduisent leur prise alimentaire par la chaleur.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Wir haben eine liegende Kuh in Box 7 — sie frisst seit heute Morgen nichts mehr und hat 40,4°C Temperatur.",
      },
      {
        en: "Her rumen sounds are reduced on the left flank — I suspect left displacement of the abomasum.",
        target:
          "Ihre Pansengeräusche sind auf der linken Flanke reduziert — ich vermute eine linksseitige Labmagenverlagerung.",
      },
      {
        en: "Can you come out today? She's in early lactation and production has already dropped significantly.",
        target:
          "Können Sie heute kommen? Sie befindet sich in der frühen Laktation und die Milchleistung ist bereits deutlich gesunken.",
      },
      {
        en: "I also have four heifers ready for their pre-breeding reproductive exams.",
        target:
          "Ich habe auch vier Färsen bereit für ihre Reproduktionsuntersuchungen vor der Belegung.",
      },
      {
        en: "The vaccination schedule for the dry cows is due this week — BVD, IBR, and leptospirosis boosters.",
        target:
          "Der Impfplan für die trockenstehenden Kühe ist diese Woche fällig — BVD-, IBR- und Leptospirose-Auffrischungen.",
      },
      {
        en: "We've had three cases of digital dermatitis in the past month — I'd like to start a footbath program.",
        target:
          "Wir hatten im letzten Monat drei Fälle von Mortellaro — ich möchte ein Klauenbadprogramm einführen.",
      },
      {
        en: "Please write the withdrawal time on the milk discard card so nobody adds the treated cow to the tank.",
        target:
          "Bitte schreiben Sie die Wartezeit auf die Milchabgabekarte, damit niemand die behandelte Kuh in den Tank gibt.",
      },
      {
        en: "The bulk tank somatic cell count was 240,000 last pickup — we need to find the problem cows.",
        target:
          "Der somatische Zellgehalt des Sammeltanks lag beim letzten Abtransport bei 240.000 — wir müssen die Problemkühe finden.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Il camion del latte arriva alle 5 — assicurati che il serbatoio del latte sia a 4 gradi Celsius.",
      },
      {
        en: "Check the tank agitator is running — milk must be stirred to stay at a uniform temperature.",
        target:
          "Controlla che l'agitatore del serbatoio funzioni — il latte deve essere agitato per mantenere una temperatura uniforme.",
      },
      {
        en: "The sampler will take a bacteria count and fat test — our last result was 3.8% fat, which is excellent.",
        target:
          "Il campionatore farà un conteggio batterico e un test del grasso — il nostro ultimo risultato era 3,8% di grasso, ottimo.",
      },
      {
        en: "Any cow treated with antibiotics must be milked last and her milk discarded for the withdrawal period.",
        target:
          "Qualsiasi vacca trattata con antibiotici deve essere munte per ultima e il suo latte scartato per il periodo di sospensione.",
      },
      {
        en: "The calf born last night is strong and nursing well — record her birth weight and tag number.",
        target:
          "Il vitello nato ieri notte è forte e si nutre bene — registra il suo peso alla nascita e il numero del tag.",
      },
      {
        en: "Colostrum from first-milking cows must be fed within 2 hours of calving for maximum immunity.",
        target:
          "Il colostro delle vacche al primo parto deve essere somministrato entro 2 ore dal parto per la massima immunità.",
      },
      {
        en: "We are producing 28 liters per cow per day this week — that's two liters above our target.",
        target:
          "Questa settimana produciamo 28 litri per vacca al giorno — due litri sopra il nostro obiettivo.",
      },
      {
        en: "The dairy cooperative will pay a quality premium if our SCC stays below 200,000 this quarter.",
        target:
          "La cooperativa lattiero-casearia pagherà un premio qualità se il nostro SCC rimane sotto 200.000 questo trimestre.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "朝の搾乳は4時30分に始まります。その前にすべての搾乳施設の機器を洗浄して準備しておいてください。",
      },
      {
        en: "Pre-dip every teat, wipe dry with a clean individual cloth, then attach the milking unit.",
        target:
          "各乳頭を前搾り消毒し、清潔な個別タオルで拭き取り、搾乳ユニットを取り付けてください。",
      },
      {
      ...
      },
      {
        ...
        target:
          "育成牛グループのワクチン接種は火曜日に予定されています。獣医の記録を準備しておいてください。",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "O pasto da frente está superpastejado — precisamos mover o rebanho para o piquete leste hoje.",
      },
      {
        en: "Check all the electric fence lines before opening the gate — we had a short circuit last week.",
        target:
          "Verifique todas as linhas de cerca elétrica antes de abrir o portão — tivemos um curto-circuito semana passada.",
      },
      {
        en: "Water troughs in the east paddock need to be cleaned and refilled before the herd moves in.",
        target:
          "Os bebedouros do piquete leste precisam ser limpos e reabastecidos antes da chegada do rebanho.",
      },
      {
      ...
      },
      {
        ...
        target:
          "O período de descanso do pasto é de 35 dias — marque a data de entrada no quadro do piquete.",
      },
      {
        en: "We should apply nitrogen fertilizer to the resting paddocks to accelerate regrowth.",
        target:
          "Devemos aplicar adubo nitrogenado nos piquetes em descanso para acelerar a rebrota.",
      },
      {
        en: "A calf got separated from its mother last night — do a head count and check the fences.",
        target:
          "Um bezerro se separou da mãe ontem à noite — faça a contagem e verifique as cercas.",
      },
      {
        en: "Breed identification and ear tag records must be updated every time an animal moves paddocks.",
        target:
          "Os registros de identificação racial e brinco devem ser atualizados toda vez que um animal mudar de piquete.",
      },
    ],
  },
...

  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target:
          "Dividanse en dos grupos — uno empuja desde el arroyo, el otro rodea por los encinos.",
      },
      {
        en: "Don't rush the cattle — slow and steady gets them to the corral without stress.",
        target:
          "No apresuren al ganado — despacio y sin prisa los lleva al corral sin estresarlos.",
      },
      {
        en: "Once they're penned, we'll sort the calves for branding and the cows for preg-check.",
        target:
          "Una vez encerrados, separamos los becerros para herrar y las vacas para revisión de preñez.",
      },
      {
        en: "Have the branding iron hot and the vaccine syringes filled before the first calf goes in the chute.",
        target:
          "Ten el fierro bien caliente y las jeringas de vacuna listas antes de que entre el primer becerro al brete.",
      },
      {
        en: "Brand goes on the left hip — two-inch brand, clean contact, and hold for three seconds.",
        target:
          "La marca va en la anca izquierda — fierro de dos pulgadas, buen contacto, y sostén tres segundos.",
      },
      {
        en: "Tag every calf with the ranch number in the right ear and the birth year code in the left.",
        target:
          "Ponle arete a cada becerro con el número del rancho en la oreja derecha y el código del año en la izquierda.",
      },
      {
        en: "Any calf that looks off, flag it and we'll have the vet look at it before you turn it out.",
        target:
          "Cualquier becerro que se vea mal, márcalo y que el veterinario lo revise antes de soltarlo.",
      },
      {
        en: "Good work today, boys — let's get the horses put up and check on the water troughs before dark.",
        target:
          "Buen trabajo hoy, muchachos — guardemos los caballos y revisemos los bebederos antes de que anochezca.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Le bétail s'est échappé sur la ligne de clôture nord cette nuit — il faut trouver la brèche et la réparer aujourd'hui.",
      },
      {
        en: "Load the truck with fence posts, wire, staples, and the post driver before we head out.",
        target:
          "Chargez le camion avec des poteaux, du fil de fer, des agrafes et le marteau de poteau avant qu'on parte.",
      },
      {
        en: "The wire is down in three sections near the creek — looks like a bull pushed through.",
        target:
          "Le fil est tombé en trois endroits près du ruisseau — on dirait qu'un taureau a forcé le passage.",
      },
      {
        en: "Splice the wire with a good tight fence knot — I don't want that section giving way again.",
        target:
          "Épissez le fil avec un bon nœud de clôture bien serré — je ne veux pas que cette section cède à nouveau.",
      },
      {
        en: "Set the corner post first, then work the line posts at 10-foot spacing back toward the gate.",
        target:
          "Posez d'abord le poteau d'angle, puis travaillez les poteaux de ligne à 3 mètres d'intervalle vers la porte.",
      },
      {
        en: "While you're out there, check the water trough in the north pasture — it's been low all week.",
        target:
          "Pendant que vous êtes là-bas, vérifiez l'abreuvoir dans le pâturage nord — il est bas toute la semaine.",
      },
      {
        en: "Move the herd to the south pasture until the fence is repaired and tested.",
        target:
          "Déplacez le troupeau vers le pâturage sud jusqu'à ce que la clôture soit réparée et testée.",
      },
      {
        en: "Keep an eye on the new calves while you ride the fence — it's easy to miss one hiding in the brush.",
        target:
          "Gardez un œil sur les nouveaux veaux pendant que vous parcourez la clôture — on en oublie facilement un caché dans les broussailles.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Ich habe 40 Mastbullen marktreif — sie bringen durchschnittlich 580 Kilo auf dem Huf.",
      },
      {
        en: "What's your price per kilo for slaughter weight? I saw the market was at €2.80 last week.",
        target:
          "Was ist Ihr Preis pro Kilo Schlachtgewicht? Ich sah, dass der Markt letzte Woche bei 2,80 € lag.",
      },
      {
        en: "These cattle are all certified beef breed, vaccinated, and grass-finished for the last 90 days.",
        target:
          "Dieses Vieh ist alles zertifizierte Fleischrasse, geimpft und die letzten 90 Tage auf der Weide ausgemästet.",
      },
      {
        en: "I can arrange delivery to your yard by Thursday if we agree on a price today.",
        target:
          "Ich kann die Lieferung bis Donnerstag zu Ihrem Hof arrangieren, wenn wir uns heute auf einen Preis einigen.",
      },
      {
        en: "The transport permit and ear tag records are all in order — ready for inspection.",
        target:
          "Die Transportgenehmigung und die Ohrmarkendokumentation sind alle in Ordnung — bereit zur Überprüfung.",
      },
      {
        en: "I'll need a signed bill of sale and the movement document before the cattle leave the ranch.",
        target:
          "Ich benötige einen unterzeichneten Kaufvertrag und das Verbringungsdokument, bevor das Vieh den Hof verlässt.",
      },
      {
        en: "If you take the whole lot of 40, I'll sharpen my pencil on the per-kilo price.",
        target:
          "Wenn Sie die ganze Partie von 40 Stück nehmen, mache ich beim Kilopreis ein besseres Angebot.",
      },
      {
        en: "Deal — I'll have my transport driver call you in the morning to arrange the loading time.",
        target:
          "Einverstanden — mein Transporter wird Sie morgen früh anrufen, um die Ladezeit zu vereinbaren.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "L'erba del pascolo nord è scesa a 5 centimetri — è ora di spostare la mandria nel campo est.",
      },
      {
        en: "Open the gate and drive them slowly — don't let the lead cows get too far ahead of the herd.",
        target:
          "Apri il cancello e spingi lentamente — non lasciare che le vacche di testa si allontanino troppo dal resto.",
      },
      {
        en: "Make sure the saddle girth is tight before you start — we've got rough terrain ahead.",
        target:
          "Assicurati che la cinghia della sella sia stretta prima di iniziare — davanti abbiamo terreno accidentato.",
      },
      {
        en: "The young bull escaped through the creek fence — we need to locate him before nightfall.",
        target:
          "Il giovane toro è scappato attraverso la recinzione del torrente — dobbiamo trovarlo prima del tramonto.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Quelle tre manze devono essere separate — andranno nel recinto separato per la monta la settimana prossima.",
      },
      {
        en: "Brand inspection certificates need to be updated before we can sell any animals at market.",
        target:
          "I certificati di ispezione del marchio devono essere aggiornati prima di poter vendere animali al mercato.",
      },
      {
        en: "After we move the herd, check the old pasture for any calves that got left behind.",
        target:
          "Dopo aver spostato la mandria, controlla il vecchio pascolo per eventuali vitelli rimasti indietro.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "群れをメインの囲いに追い込んでください。今日は離乳のために子牛を選別する必要があります。",
      },
      {
      ...
      },
      {
        ...
        target:
          "最初の動物が通路に入る前に、ヘッドゲートが正しく設定されているか確認してください。",
      },
      {
      ...
      },
      {
        ...
        target:
          "子牛の作業が終わったら、西側のフェンスラインを確認してください。昨日牛が押し付けていました。",
      },
      {
      ...
      },
      {
        ...
        target:
          "今日はよく頑張りました。群れは健康そうで、子牛たちは予定より早く体重が増えています。",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Hoje vamos mover o gado para o pasto dos fundos — ensile e esteja pronto para montar às 6h.",
      },
      {
        en: "The herd has about 180 head — we need three riders on each side to keep them together.",
        target:
          "O rebanho tem cerca de 180 cabeças — precisamos de três peões de cada lado para mantê-los juntos.",
      },
      {
        en: "Watch for the bull at the back of the herd — he's been aggressive this week.",
        target:
          "Fique de olho no touro na parte traseira do rebanho — ele está agressivo essa semana.",
      },
      {
        en: "The back pasture water tank needs the float valve replaced before we move them in.",
        target:
          "O tanque de água do pasto dos fundos precisa da válvula de boia trocada antes de movê-los para lá.",
      },
      {
        en: "Branding day is next Saturday — we'll need the chute oiled and the irons ready.",
        target:
          "O dia de marcação é no próximo sábado — precisamos do brete lubrificado e os ferros prontos.",
      },
      {
        en: "Keep the young steers separate from the breeding cows — they're going to a different pasture.",
        target:
          "Mantenha os novilhos jovens separados das vacas de cria — eles vão para um pasto diferente.",
      },
      {
        en: "After the move, do a head count against the register — I want to know if anyone is missing.",
        target:
          "Depois da movimentação, faça uma contagem contra o registro — quero saber se falta algum.",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "Antes de que entre la primera canal al piso, todas las superficies deben estar desinfectadas y secas.",
      },
      {
        en: "Your knife must be sterilized in the hot water cabinet between every carcass — no exceptions.",
        target:
          "Tu cuchillo debe esterilizarse en el gabinete de agua caliente entre cada canal — sin excepciones.",
      },
      {
        en: "If you nick the intestine on the evisceration line, stop and call the USDA inspector immediately.",
        target:
          "Si perforase el intestino en la línea de evisceración, para y llama al inspector del USDA de inmediato.",
      },
      {
        en: "Contaminated carcasses go to the retain rail — they do not move forward until QA clears them.",
        target:
          "Las canales contaminadas van al riel de retención — no avanzan hasta que control de calidad las libere.",
      },
      {
        en: "Keep your apron, gloves, and sleeves clean throughout the shift — change them if they get contaminated.",
        target:
          "Mantén tu mandil, guantes y mangas limpios durante todo el turno — cámbialos si se contaminan.",
      },
      {
        en: "Cold storage temperature must stay between 0 and 4 degrees Celsius — log it every two hours.",
        target:
          "La temperatura del almacén frío debe mantenerse entre 0 y 4 grados Celsius — regístrala cada dos horas.",
      },
      {
        en: "The USDA inspector is making rounds today — keep your work area clean and your paperwork current.",
        target:
          "El inspector del USDA está haciendo rondas hoy — mantén tu área de trabajo limpia y tu documentación al día.",
      },
      {
        en: "If you see a safety hazard, stop work and report it before anyone gets injured.",
        target:
          "Si ves un peligro de seguridad, detén el trabajo e infórmalo antes de que alguien se lastime.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "La commande du restaurant demande 40 kilos de faux-filet taillé à 2,5 centimètres.",
      },
      {
        en: "Start with the loin section — separate the faux-filet from the entrecôte before you portion.",
        target:
          "Commencez par la section du faux-filet — séparez le faux-filet de l'entrecôte avant de portionner.",
      },
      {
        en: "Trim the fat cap to 5 millimeters — the client specifically requested lean presentation.",
        target:
          "Taillez la couverture de gras à 5 millimètres — le client a expressément demandé une présentation maigre.",
      },
      {
        en: "The butcher's yield on a whole sirloin is about 70% after bone and trim — plan accordingly.",
        target:
          "Le rendement boucher d'un aloyau entier est d'environ 70 % après os et parure — planifiez en conséquence.",
      },
      {
        en: "Label every tray with the cut name, weight, date, and lot number before it goes to cold storage.",
        target:
          "Étiquetez chaque barquette avec le nom de la découpe, le poids, la date et le numéro de lot avant de l'envoyer en chambre froide.",
      },
      {
        en: "The primal arrived this morning — it needs to rest at 2°C for 48 hours before we break it down.",
        target:
          "Le morceau primaire est arrivé ce matin — il doit reposer à 2°C pendant 48 heures avant qu'on le découpe.",
      },
      {
        en: "If the weight comes in under the order spec, we'll need to make up the difference from the reserve stock.",
        target:
          "Si le poids est inférieur à la spécification de la commande, il faudra combler la différence avec le stock de réserve.",
      },
      {
        en: "The trimmings and fat go to the grind pile — they'll be processed into 80/20 ground beef tomorrow.",
        target:
          "Les parures et les graisses vont à la pile de hachage — elles seront transformées en bœuf haché 80/20 demain.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Der Bundesinspektor hat Lot 7 zurückgehalten — nicht versenden, bis die Sperre aufgehoben ist.",
      },
      {
        en: "The temperature deviation alarm went off in cold storage room 3 — we need to pull the logger data.",
        target:
          "Der Temperaturabweichungsalarm in Kühlraum 3 hat ausgelöst — wir müssen die Logger-Daten abrufen.",
      },
      {
        en: "Product affected by the deviation must be placed on hold pending a food safety assessment.",
        target:
          "Von der Abweichung betroffenes Produkt muss bis zur Lebensmittelsicherheitsbewertung gesperrt werden.",
      },
      {
        en: "Sanitation records for the past 72 hours need to be pulled for the inspector's review.",
        target:
          "Die Hygieneprotokolle der letzten 72 Stunden müssen für die Inspektion herausgezogen werden.",
      },
      {
        en: "Every carcass that passes the ante-mortem and post-mortem inspection gets a USDA stamp.",
        target:
          "Jeder Schlachtkörper, der die Ante- und Post-mortem-Untersuchung besteht, erhält einen USDA-Stempel.",
      },
      {
        ...
        target:
          "Wenn der Inspektor einen Schlachtkörper verwirft, muss er nach dem vorgeschriebenen Protokoll entsorgt werden — nichts davon kommt ins Hack.",
      },
      {
        en: "Update the HACCP log before the end of every shift — it must be signed by the QA supervisor.",
        target:
          "Aktualisieren Sie das HACCP-Protokoll vor Ende jeder Schicht — es muss vom QS-Vorgesetzten unterzeichnet werden.",
      },
      {
        en: "Corrective action for the cold storage deviation must be documented within 24 hours.",
        target:
          "Die Korrekturmaßnahme für die Kühlraumabweichung muss innerhalb von 24 Stunden dokumentiert werden.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Oggi iniziamo con i quarti posteriori — prima separazione del girello, dello scamone e del controfiletto.",
      },
      {
        en: "Use the boning knife for the round section — the heavy knife will tear the muscle tissue.",
        target:
          "Usa il coltello da disosso per la parte del girello — il coltello pesante strapperà il tessuto muscolare.",
      },
      {
        en: "All packaging must show the cut name, net weight, pack date, and use-by date.",
        target:
          "Tutta la confezione deve mostrare il nome del taglio, il peso netto, la data di confezionamento e la data di scadenza.",
      },
      {
        en: "The vacuum sealer needs to be recalibrated — the last three packs had air pockets.",
        target:
          "Il sigillatrice sottovuoto deve essere ricalibrata — gli ultimi tre pacchi avevano bolle d'aria.",
      },
      {
        en: "Ground product must reach an internal temperature of 71 degrees Celsius during cooking — make sure it's on the label.",
        target:
          "Il prodotto macinato deve raggiungere una temperatura interna di 71 gradi Celsius durante la cottura — assicurati che sia sull'etichetta.",
      },
      {
        en: "The retail tray orders need to be in the cold storage van by 3 PM for the morning delivery run.",
        target:
          "Gli ordini per i vassoi al dettaglio devono essere nel furgone frigorifero entro le 15:00 per la consegna mattutina.",
      },
      {
        en: "Never leave raw product at room temperature for more than 30 minutes — cold chain is everything.",
        target:
          "Non lasciare mai il prodotto crudo a temperatura ambiente per più di 30 minuti — la catena del freddo è tutto.",
      },
      {
        en: "Today's yield on the hindquarter lot was 68% — slightly below target, review your trim waste.",
        target:
          "La resa di oggi sul lotto dei quarti posteriori è stata del 68% — leggermente sotto il target, rivedi gli scarti di rifinitura.",
      },
    ],
  },
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        target:
          "今朝はUSDA検査官がフロアにいます。作業ステーションを清潔に整理しておいてください。",
      },
      {
      ...
      },
      {
        ...
        target:
          "シルバースキンを綺麗にトリミングしてください。小売規格では結合組織が2ミリメートルを超えてはなりません。",
      },
      {
        en: "Cold storage must stay between 0 and 4 degrees — check the thermometer log every two hours.",
        target:
          "冷蔵庫は0〜4度に保たなければなりません。2時間ごとに温度計のログを確認してください。",
      },
      {
    ...
    sentences: [
      {
        ...
        target:
          "O pedido de produção de hoje exige 200 quilos de picanha e 150 quilos de fraldinha.",
      },
      {
        en: "Start by breaking down the hindquarter — separate the rump cap before you trim the fat.",
        target:
          "Comece desmembrando o quarto traseiro — separe o coxão de cima antes de aparar a gordura.",
      },
      {
        en: "The fat cap on picanha must be kept at exactly 1 centimeter — that is the restaurant spec.",
        target:
          "A capa de gordura da picanha deve ser mantida em exatamente 1 centímetro — essa é a especificação do restaurante.",
      },
      {
        en: "Weigh each piece on the calibrated scale and label it before it goes into cold storage.",
        target:
          "Pese cada peça na balança calibrada e rotule antes de colocar no armazenamento a frio.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Qualquer apara com tendão ou tecido conjuntivo excessivo vai para o moedor — não para a bandeja de varejo.",
      },
      {
        en: "Cold chain temperature log must be filled out every two hours and signed by the QA technician.",
        target:
          "O registro de temperatura da cadeia fria deve ser preenchido a cada duas horas e assinado pelo técnico de qualidade.",
      },
      {
        en: "Report any equipment malfunction immediately — a dull blade or a faulty vacuum sealer affects yield and safety.",
        target:
          "Relate qualquer mau funcionamento de equipamento imediatamente — uma lâmina cega ou seladora com defeito afeta o rendimento e a segurança.",
      },
    ],
  },
    ...
    sentences: [
      {
        ...
        target:
          "Bonjour, c'est Marc du bureau de répartition — je vous appelle pour m'excuser du retard d'aujourd'hui.",
      },
      {
        en: "Our driver was held up by a serious accident on the A6 motorway near Beaune.",
        target:
          "Notre chauffeur a été retenu par un grave accident sur l'autoroute A6 près de Beaune.",
      },
      {
      ...
      },
      {
        ...
        target:
          "Je comprends que cela affecte votre équipe de déchargement et votre planning de production en aval.",
      },
      {
        en: "We can offer a credit on the freight invoice to compensate for the inconvenience.",
        target:
          "Nous pouvons vous accorder un avoir sur la facture de transport pour compenser le désagrément.",
      },
      {
        en: "Going forward, we'll be rerouting all loads through the A39 to avoid that bottleneck.",
        target:
          "À l'avenir, nous redirigerons toutes les expéditions par l'A39 pour éviter ce goulot d'étranglement.",
      },
      {
        en: "I'll send you a detailed incident report and updated tracking link within the hour.",
        target:
          "Je vous enverrai un rapport d'incident détaillé et un lien de suivi mis à jour dans l'heure.",
      },
      {
        en: "Please confirm whether your dock will still be staffed when the driver arrives this evening.",
        target:
          "Pourriez-vous confirmer si votre quai sera encore en service à l'arrivée du chauffeur ce soir ?",
      },
      {
        en: "Once again, please accept our sincere apologies — we value your business and will do better.",
        target:
          "Encore une fois, veuillez accepter nos sincères excuses — nous tenons à votre clientèle et nous ferons mieux.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Vor dem Anmischen der Spritzbrühe ziehen Sie den kompletten Schutzanzug, Nitrilhandschuhe und die Atemschutzmaske an.",
      },
      {
        en: "Read the product label carefully — the dosage rate for this fungicide is 1.2 liters per hectare.",
        target:
          "Lesen Sie das Produktetikett sorgfältig — die Aufwandmenge für dieses Fungizid beträgt 1,2 Liter pro Hektar.",
      },
      {
        en: "Calibrate the sprayer before each application to ensure even coverage.",
        target:
          "Kalibrieren Sie die Spritze vor jeder Anwendung, um eine gleichmäßige Ausbringung zu gewährleisten.",
      },
      {
        en: "Do not spray when wind speeds exceed 5 meters per second — drift onto neighboring fields is a violation.",
        target:
          "Nicht spritzen, wenn die Windgeschwindigkeit 5 Meter pro Sekunde übersteigt — Abdrift auf Nachbarflächen ist ein Verstoß.",
      },
      {
        en: "Maintain the legally required buffer zone of 5 meters from any surface water.",
        target:
          "Halten Sie den gesetzlich vorgeschriebenen Abstand von 5 Metern zu jedem Oberflächengewässer ein.",
      },
      {
        en: "Record the application in the field passport: product, batch, dose, weather, and operator.",
        target:
          "Tragen Sie die Anwendung in das Feldhandbuch ein: Produkt, Charge, Dosierung, Wetterlage und Anwender.",
      },
      {
        en: "Observe the pre-harvest interval strictly — for this product it is 21 days.",
        target:
          "Beachten Sie die Wartezeit bis zur Ernte strikt — für dieses Mittel beträgt sie 21 Tage.",
      },
      {
        en: "Triple-rinse the empty container and return it to the authorized collection point.",
        target:
          "Spülen Sie den leeren Kanister dreimal aus und bringen Sie ihn zur zugelassenen Sammelstelle.",
      },
      {
        en: "After spraying, decontaminate yourself thoroughly before re-entering the farmhouse.",
        target:
          "Nach dem Spritzen gründlich dekontaminieren, bevor Sie das Wohnhaus wieder betreten.",
      },
    ],
  },
  {
    ...
    sentences: [
      {
        ...
        target:
          "Las comunidades microbianas de la rizosfera median la absorción de nutrientes mucho más allá de lo que los modelos de fertilización convencionales contemplan.",
      },
      {
        ...
        target:
          "Los hongos micorrízicos establecen relaciones simbióticas con el sistema radicular, ampliando notablemente la superficie efectiva de la planta para la absorción de agua y fósforo.",
      },
      {
        ...
        target:
          "La labranza excesiva interrumpe las redes hifales y acelera la mineralización del carbono orgánico del suelo, liberándolo como CO2 atmosférico.",
      },
      {
        ...
        target:
          "La siembra de cultivos de cobertura con especies leguminosas fija nitrógeno atmosférico y aporta un sustrato de abono verde que alimenta el microbioma entre los ciclos comerciales.",
      },
      {
        ...
        target:
          "Estudios metagenómicos recientes sugieren que la diversidad bacteriana se correlaciona más fuertemente con la estabilidad del rendimiento a largo plazo que con la productividad máxima de una sola temporada.",
      },
      {
        ...
        target:
          "Los productores que transitan hacia protocolos regenerativos suelen observar un período de recuperación de tres a cinco años antes de que los indicadores microbianos alcancen su línea base.",
      },
      {
        ...
        target:
          "Los tés de compost inoculados con cepas adaptadas localmente pueden acelerar esta transición, pero su eficacia depende de un riguroso control de calidad durante la fermentación.",
      },
      {
        ...
        target:
          "Desde el punto de vista agronómico, el suelo debe gestionarse como un ecosistema vivo y no como un sustrato inerte al que simplemente se aplican insumos.",
      },
      {
        ...
        target:
          "Los agentes de extensión deben, por tanto, traducir estas dinámicas biológicas complejas en prácticas de manejo que los productores puedan adoptar dentro de sus limitaciones económicas.",
      },
    ],
  },
];
