...
const americanFootballAreas: ModuleArea[] = [
  {
    ...
    toneNote:
      "Clipped, urgent, authoritative. Real huddle language is abbreviated and loud.",
    phrases: [
      { en: "Right 38 Power — on two, on two, ready break!", intent: "Call a run play and snap count" },
      { en: "X Post, Y Shallow Cross — protection is Slide Left.", intent: "Call a passing concept with protection" },
  ...
  },
  {
    ...
    toneNote:
      "Respectful but direct. Sideline talk is fast — coaches want answers, not excuses.",
    phrases: [
      { en: "They're playing two-deep the whole drive — I'm getting bracketed every snap.", intent: "Report coverage" },
      { en: "I can beat him on a back-shoulder fade, just give me the shot.", intent: "Request a specific route" },
      { en: "Understood — I'll adjust my stem going forward.", intent: "Accept coaching" },
      { en: "The corner is biting hard on the out route — I can run the comeback right behind him.", intent: "Identify a coverage exploit" },
      { en: "I need about two more plays to get my legs back — cramp.", intent: "Report a physical issue" },
      { en: "We need this first down — who else is healthy and ready?", intent: "Assess personnel options" },
      { en: "Heads up — their safety cheats on the motion every single time.", intent: "Share a scouting observation" },
    ],
    vocab: [
      "two-deep",
      "bracket coverage",
  ...
  },
  {
    ...
    phrases: [
      { en: "Can you pause it right there? Watch how their tight end sets his block — he telegraphs the pull.", intent: "Point out a key frame" },
      { en: "That's my assignment — I should have scraped over the top instead of going underneath.", intent: "Self-correct an error" },
      { en: "Their quarterback always stares down his first read for a full two seconds — we can get an early jump.", intent: "Identify a QB tendency" },
      { en: "On this formation — trips left — they run a bubble screen 70% of the time.", intent: "Share a formation tendency" },
      { en: "I want to see that blitz package again — I think I can time the A-gap perfectly.", intent: "Request a replay" },
      { en: "If we disguise a Cover 2 as Cover 0, they'll throw into a bracket all day.", intent: "Suggest a scheme adjustment" },
      { en: "My keys were wrong on that play — I was reading the wrong back.", intent: "Diagnose a recognition error" },
    ],
    vocab: [
      "film",
      "tendency",
  ...
  },
  {
    ...
    emoji: "🍖",
    blurb:
      "Casual pre-game fan conversation — predictions, team history, friendly trash talk.",
    counterpart: "Friendly rival fan or a new acquaintance at the tailgate.",
    learnerRole: "Home team fan at the tailgate",
    toneNote:
      "Relaxed, fun, opinionated. Light trash talk is fine — keep it playful, not hostile.",
    phrases: [
      { en: "We've been season ticket holders for fifteen years — this is finally our year.", intent: "Express fan pride and optimism" },
      { en: "Their defense is soft against the run — our backs are going to eat today.", intent: "Make a pre-game prediction" },
      { en: "You drove all the way from Ohio for this? Respect — I'll pour you a drink.", intent: "Welcome a visiting fan" },
      { en: "That call in the fourth quarter last week was robbery, plain and simple.", intent: "Complain about officiating" },
      { en: "Who are you starting in fantasy — their tight end has a great matchup.", intent: "Fantasy football cross-talk" },
      { en: "I still can't believe we let that game slip in overtime.", intent: "Lament a recent loss" },
      { en: "Our offensive line is the most underrated unit in the whole league.", intent: "Defend a position group" },
    ],
    vocab: [
      "tailgate",
      "season tickets",
  ...
  },
  {
    ...
    phrases: [
      { en: "I'm not panicking — and you shouldn't be either. We've been here before.", intent: "Calm and anchor the team" },
      { en: "Fourteen points is nothing. We score on the first drive and this game changes completely.", intent: "Reframe the deficit" },
      { en: "Offensively — we're going to come out in 11 personnel and spread them out.", intent: "Announce a halftime adjustment" },
      { en: "Their defensive end is gassing — he'll be tired in the third. Attack him.", intent: "Identify a physical advantage" },
      { en: "You've worked too hard all week to play like it doesn't matter. Show me something.", intent: "Challenge the team's effort" },
      { en: "Protect the football. One turnover and we're done. Not one.", intent: "Stress ball security" },
      { en: "Second half starts right now — the moment you walk back out of that tunnel.", intent: "Closing rallying cry" },
    ],
    vocab: [
      "halftime",
      "adjustment",
  ...
  },
  {
    ...
    phrases: [
      ...
      { en: "I'm not disputing the call — I just want to understand the ruling.", intent: "De-escalate while asking" },
      { en: "We'd like to challenge that play — we believe the receiver had both feet in bounds.", intent: "Initiate a challenge" },
      { en: "Can I get a timeout, please?", intent: "Request a timeout" },
      { en: "That was a late hit, ref — my player was already down.", intent: "Flag a missed call (firmly)" },
      { en: "How much time is on the clock right now?", intent: "Confirm game clock" },
      { en: "I understand — thank you for the clarification.", intent: "Accept a ruling gracefully" },
    ],
    vocab: [
      "challenge",
      "flag",
  ...
  },
  {
    ...
    phrases: [
      { en: "We did it together — nobody in this room should leave without being proud of that effort.", intent: "Celebrate as a team" },
      { en: "I'll take the blame on that last drive — that's on me, not on this team.", intent: "Accept individual accountability" },
      { en: "Credit to them — they came ready and they deserved it tonight.", intent: "Acknowledge the opponent" },
      { en: "We'll be back. This group is too good to let this define us.", intent: "Respond to a loss with resolve" },
      { en: "Coach put us in the right position — we executed.", intent: "Credit the coaching staff" },
      { en: "I'm proud of the way we competed even when things went sideways.", intent: "Praise team resilience" },
      { en: "We're going to look at the film tomorrow and get better — that's what we do.", intent: "Commitment to improvement" },
    ],
    vocab: [
      "accountability",
      "resilience",
...
const americanFootballVocabSets: ModuleVocabSet[] = [
  {
    ...
    emoji: "🏈",
    words: ["quarterback", "running back", "wide receiver", "tight end", "offensive lineman", "fullback", "slot receiver"],
  },
  {
    category: "Defensive Positions",
    emoji: "🛡️",
    words: ["linebacker", "cornerback", "safety", "defensive tackle", "defensive end", "nickelback"],
  },
  {
    category: "Play Types",
    emoji: "📋",
    words: ["run play", "pass play", "screen", "draw", "play action", "blitz", "zone coverage", "man coverage"],
  },
  {
    category: "Game Situations",
    emoji: "⏱️",
    words: ["red zone", "two-minute drill", "fourth down", "overtime", "kickoff", "punt", "field goal", "extra point"],
  },
];
...
const lacrosseAreas: ModuleArea[] = [
  {
    ...
    phrases: [
      ...
      { en: "Hold it — reset, reset, wait for the skip pass!", intent: "Slow down a rushed attack" },
      { en: "I'm trail — drop it back if they collapse!", intent: "Identify yourself as the trailer" },
    ...
    sampleConversation: [
      { speaker: "learner", en: "Four-on-three — push! I'm carrying left, crash the crease early!" },
  ...
  },
  {
    ...
    phrases: [
      { en: "I've got ball — who's my slide?", intent: "Identify yourself as on-ball defender and find help" },
      ...
      { en: "Stay home on your crease man — don't cheat!", intent: "Warn teammate not to slide prematurely" },
      { en: "Recovery — get to the open stick!", intent: "Call for transition back to shooters after slide" },
      { en: "Force him up, force him up — don't let him cut baseline!", intent: "Instruct angle of containment" },
    ...
    sampleConversation: [
      ...
      { speaker: "ai", en: "I'm ready! He's driving left — force him up, don't let him go baseline!" },
      ...
      { speaker: "learner", en: "Good slide — now push him wide and make him shoot under pressure." },
    ],
  },
  {
    id: "face-off-talk",
    ...
    phrases: [
      { en: "Wings — be ready for a clamp-and-kick. I'm going right.", intent: "Pre-face-off wing instruction" },
      { en: "He's been cheating early every draw — I'm going to time it.", intent: "Share a tendencies observation" },
      { en: "Set!", intent: "Standard face-off ready call" },
      { en: "Clamp! Kick right — go!", intent: "In-play call after securing the face-off" },
      { en: "I lost it — ball's loose, crash the ground ball!", intent: "Scramble after a lost face-off" },
      { en: "Pin him out — push him to the sideline!", intent: "Instruct teammate to body out the opponent" },
      { en: "Good win — push it up and get into the attack!", intent: "Transition cue after winning the face-off" },
    ],
    vocab: [
      "FOGO",
      "face-off",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Alright — I've lost the last two. He's doing a motorcycle move off the top. Wings, be ready for a fast ground ball on my right side." },
      { speaker: "ai", en: "Got it — I'll cheat a step right before the whistle." },
      { speaker: "learner", en: "Don't cheat before the whistle — they'll call an early break. Stay disciplined, just anticipate." },
      { speaker: "ai", en: "Understood. What's your counter for the motorcycle?" },
      { speaker: "learner", en: "I'm going to get lower and go under him. If I pin it, kick right immediately." },
  ...
  },
  {
    ...
    phrases: [
      { en: "Hold the ball — we're bleeding time, slow it down!", intent: "Instruct tempo control" },
      { en: "Settle! Get into your set offense — stop freelancing!", intent: "Stop disorganized play" },
      { en: "When you sub in — your one job is to shut down their dodger. Lock him up.", intent: "Mission-specific substitution instruction" },
      { en: "Great move — that's exactly what we worked on. Stay aggressive.", intent: "Positive reinforcement mid-game" },
      { en: "Talk on defense! I can't hear you from here and neither can your teammates!", intent: "Demand communication" },
      { en: "Ride hard — don't let them clear easily, make them earn it.", intent: "Instruct defensive ride" },
    ],
    vocab: [
      "tempo",
      "set offense",
    ...
    sampleConversation: [
      ...
      { speaker: "learner", en: "Their number 12 is killing us off the dodge. You have one job — take him, stay between him and the crease." },
      { speaker: "ai", en: "On 12 the whole time?" },
      { speaker: "learner", en: "All day. Don't help off him. Let someone else slide. Your job is just 12." },
  ...
  },
  {
    ...
    emoji: "🟨",
    blurb:
      "Contesting calls professionally — technical fouls, crease violations, illegal checks.",
    ...
    phrases: [
      { en: "Can I get a clarification on that call — was that a body check or a cross-check?", intent: "Ask for specific ruling" },
      { en: "He was outside the crease when he caught the ball — the foot was on the line.", intent: "Dispute a crease violation call" },
      { en: "That was a legal check — his hands were inside the elbows the whole time.", intent: "Argue an illegal check ruling" },
      { en: "What's the time remaining on the shot clock?", intent: "Verify shot clock" },
      { en: "I'm not arguing — I just want to know the rule so my players understand it.", intent: "Diplomatic dispute" },
      { en: "Can you watch for the push from behind in the crease? It's happened twice.", intent: "Alert official to a pattern" },
    ],
    vocab: [
      "crease violation",
      "cross-check",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Excuse me — can I get a clarification on that crease call? I believe his trailing foot was outside the line when he received the pass." },
      { speaker: "ai", en: "His foot broke the plane of the crease on the catch — that's a violation by rule." },
      { speaker: "learner", en: "I understand. I just want to make sure my players know what you're watching for so we can avoid it going forward." },
      { speaker: "ai", en: "Fair enough. Tell them to keep both feet clear until the ball is settled outside." },
  ...
  },
  {
    ...
    phrases: [
      { en: "I'll start with what I'm proud of — we won the ground ball battle 18 to 11.", intent: "Open with a positive" },
      { en: "We gave up three transition goals. That cannot happen against a top-five opponent.", intent: "Name a critical problem" },
      { en: "Our clears were sloppy — we practiced that Tuesday and it still fell apart today.", intent: "Connect a game mistake to practice" },
      { en: "Jackson — your defensive effort in the fourth quarter was exactly what this team needs. That's your standard now.", intent: "Name an individual for praise" },
      { en: "Thursday we're going to focus entirely on our ride and our clear. Bring your legs.", intent: "Preview next practice focus" },
      { en: "We won today, but just barely. A win is a win — but we're better than this.", intent: "Temper a win with high standards" },
    ],
    vocab: [
      "ground ball",
      "transition",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Good win today — but I need two minutes, because there are things we have to fix right now while they're fresh." },
      { speaker: "ai", en: "We're listening, Coach." },
      { speaker: "learner", en: "Ground ball battle — we won it. Ride was aggressive. Those are the positives. Here's the problem: we gave up the same transition goal pattern three times. That's a focus issue, not a talent issue." },
      { speaker: "ai", en: "The midfielders were flat-footed after we missed shots. Is that what you're seeing?" },
      { speaker: "learner", en: "Exactly. After a missed shot, everybody watches it. Thursday, we drill sprint-back after every missed shot attempt. No exceptions." },
    ],
  },
  {
    id: "club-team-tryout",
    ...
    phrases: [
      { en: "Hi Coach — I'm Alex, I play attack and midfield. Thanks for having me out today.", intent: "Professional self-introduction" },
      { en: "I've been playing since I was eight — I played varsity all three years in high school.", intent: "State experience concisely" },
      { en: "Can I ask — what's the practice and travel schedule for this team?", intent: "Ask a logistical question" },
      { en: "What are you looking for in players at this level?", intent: "Show coachability by asking for expectations" },
      { en: "I prefer attack but I'm comfortable at midfield if that's where you need me.", intent: "Show versatility" },
      { en: "I'm a hard worker — I may not be the best player here today but I'll outcompete everyone.", intent: "Sell your effort and mentality" },
    ],
    vocab: [
      "tryout",
      "club team",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Coach — I'm Alex Rivera. I play attack, three years varsity. Really excited to be here today." },
      { speaker: "ai", en: "Good to meet you, Alex. What do you think you bring to a club at this level?" },
      { speaker: "learner", en: "I'm a lefty dodger and I finish well around the crease. My weak spot is my right hand — I've been working on it all off-season." },
      { speaker: "ai", en: "I appreciate the honesty. We like players who know their game. What questions do you have for us?" },
      { speaker: "learner", en: "What does the travel schedule look like, and how many players are you taking at attack?" },
      { speaker: "ai", en: "We travel to about eight tournaments — four out of state. We're taking three attack. Give us everything today." },
    ],
  },
];
...
const lacrosseVocabSets: ModuleVocabSet[] = [
  ...
  },
  {
    category: "Stickwork",
    emoji: "🏒",
    words: ["cradle", "scoop", "clamp", "rake", "feed", "skip pass", "behind-the-back", "bounce pass"],
  },
  {
    category: "Offensive Concepts",
    emoji: "⚔️",
    words: ["dodge", "split dodge", "roll dodge", "pick", "set offense", "ride", "fast break", "extra-man opportunity"],
  },
  {
...
const rugbyAreas: ModuleArea[] = [
  {
    ...
    phrases: [
      { en: "Crouch — bind — set. Stay low and drive through.", intent: "Call the engagement sequence" },
      ...
      { en: "They're angling — reset your bind and push square.", intent: "Correct a collapsing scrum" },
      ...
      { en: "Hold it — scrum penalty, don't wheel.", intent: "Signal to hold position for a penalty advantage" },
    ],
    vocab: [
      "scrum",
      "loose-head prop",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Alright — crouch. Tight bind, lock your hips. We're going channel one on this." },
      { speaker: "ai", en: "Their tight-head is a monster — we need to hit him low and together." },
      { speaker: "learner", en: "Don't pop up. Hit through his hips, not his shoulders. Bind — set — drive!" },
      { speaker: "ai", en: "They're pushing us off — I'm losing my angle!" },
      { speaker: "learner", en: "Reset! Square your shoulders and drive with your legs — you're using your back. Leg drive, leg drive!" },
    ],
  },
  {
    id: "lineout-calls",
    ...
    phrases: [
      ...
      { en: "Color in the call means front — shape means middle — animal means back.", intent: "Explain the call system to a new player" },
      ...
      { en: "Quick throw — don't set, just go!", intent: "Call a quick lineout before defense sets" },
      { en: "They've cracked our code — we're switching to the number system.", intent: "Change the call system mid-game" },
      { en: "Lift early — I'll put it above you and let you come up to it.", intent: "Instruct the timing of the lift" },
    ],
    vocab: [
      "lineout",
      "hooker",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Listen up — Sierra, Oscar, Red. Remember: animal means back. Jumper is going back. Lifters — early drive, get him above their reach." },
      { speaker: "ai", en: "Got it — back of the lineout. Do you want a peel or straight ball to 10?" },
      { speaker: "learner", en: "Straight to 10. Hit the channels quick. If we win clean, we're running the blindside." },
      { speaker: "ai", en: "The ref just warned us about binding in the lineout. Are we clean?" },
      { speaker: "learner", en: "Inside arm under the thigh, outside arm on the hip — standard grip. We're legal, don't worry." },
    ],
  },
  {
    ...
    emoji: "🔄",
    blurb:
      "Organizing the ruck and maul — gate, bind, body position, and timing of ball away.",
    ...
    phrases: [
      { en: "Ruck! Get over the ball — stay on your feet, stay on your feet!", intent: "Secure the ruck" },
      { en: "Gate! You're coming in from the side — you'll give away a penalty!", intent: "Warn about an illegal entry" },
      { en: "Bind or you're useless — get a proper grip on his jersey!", intent: "Demand proper bind in a maul" },
      { en: "Ball away! Ball away — go wide!", intent: "Signal ball is out of the ruck" },
      { en: "Bodies over — we need one more man to win this ruck!", intent: "Call for support at the breakdown" },
      { en: "Slow the ball down — their 7 is coming, hold it in!", intent: "Warn of an incoming jackal threat" },
      { en: "Drive it! Pick and go — keep the maul moving!", intent: "Keep momentum in a driving maul" },
    ],
    vocab: [
      "ruck",
      "maul",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Ruck! Over the ball — stay on your feet. Their seven is coming to jackal — protect it!" },
      { speaker: "ai", en: "I'm coming in — do I clean him out or bind on?" },
      { speaker: "learner", en: "Clean him out first — go through him legally, chest up, drive him back off the ball." },
      { speaker: "ai", en: "He's off the ball — ruck is secure." },
      { speaker: "learner", en: "Ball away! Go wide — hit the 12 channel before they reset their defense!" },
    ],
  },
  {
    id: "referee-talk",
    ...
    phrases: [
      { en: "Ref — can you help me understand that decision? Was it a technical offside or a positional offside?", intent: "Request a detailed explanation" },
      { en: "Understood — I'll get that message to my props.", intent: "Acknowledge a scrum warning" },
      { en: "Is there a reason you're not pinging the gate infringement on their side?", intent: "Query a non-call diplomatically" },
      { en: "Thank you — we'll adjust.", intent: "Accept a ruling and move on" },
      { en: "Can I speak to you at the next stoppage about the ruck laws specifically?", intent: "Request a structured conversation" },
      { en: "My player says there was a knock-on before the intercept — is that reviewable?", intent: "Query a TMO referral" },
    ],
    vocab: [
      "captain",
      "offside",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Ref — quick one. That penalty at the ruck — was it the gate or the bind you were unhappy with?" },
      { speaker: "ai", en: "Your flanker came in from the side. He needs to come through the gate over the ball." },
      { speaker: "learner", en: "Clear — I'll get that to him now. Do we have any warnings outstanding or is it a clean slate?" },
      { speaker: "ai", en: "Clean slate on that. But I've got my eye on your prop's binding at the scrum. One more issue and it's a penalty try risk." },
  ...
  },
  {
    ...
    phrases: [
      { en: "Brilliant game — you guys made us earn everything today. Welcome to our clubhouse.", intent: "Host the opposition warmly" },
      { en: "We've got a bit of a tradition here — hope you'll join in.", intent: "Introduce a club custom" },
      { en: "Your number 8 was a menace all day — absolute class player.", intent: "Compliment an opposition player" },
      { en: "First round is on us — you traveled far to play us, we appreciate that.", intent: "Show appreciation for a touring team" },
      { en: "To the game, to rugby, and to both teams — cheers!", intent: "Propose a toast" },
      { en: "We'd love to return the fixture next season if you're open to it.", intent: "Propose a future match" },
    ],
    vocab: [
      "third half",
      "clubhouse",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Mate — that was a hell of a game. Your defensive line speed in the second half was something else. Welcome to the clubhouse — glad you made the trip." },
      { speaker: "ai", en: "Cheers. Your crowd was incredible — we felt it every time you scored. Great atmosphere." },
      { speaker: "learner", en: "We love a good home crowd. We've got a tradition — both captains give a short toast. Are you up for it?" },
      { speaker: "ai", en: "I'd be honored. You go first." },
      { speaker: "learner", en: "To the game of rugby — and to a team that gave us everything we could handle today. Cheers!" },
      { speaker: "ai", en: "To the hosts — thank you for the welcome. This is what rugby's all about." },
    ],
  },
  {
    ...
    phrases: [
      { en: "I don't need to tell you what today means — you've been carrying it all week.", intent: "Acknowledge the emotional weight without over-explaining" },
      { en: "We've put in the work. No team in this competition has trained harder than us.", intent: "Assert preparation and deservedness" },
      { en: "Leave everything on that pitch — I mean everything.", intent: "Demand full commitment" },
      { en: "When it gets hard — and it will get hard — look at the man beside you.", intent: "Invoke team unity at the difficult moment" },
      { en: "We play for this badge. We play for each other. That's all there is.", intent: "Identity statement" },
    ...
    sampleConversation: [
      { speaker: "learner", en: "Everyone quiet for a second. Look around this room. We've been through an entire season together. Today — it comes down to eighty minutes." },
      { speaker: "ai", en: "Captain — this is the biggest game most of us have ever played. How do we stay composed?" },
      { speaker: "learner", en: "You stay composed by trusting your preparation. You've done the work. When you feel nerves — that's just your body telling you it matters. Use it." },
      { speaker: "ai", en: "What about if we go down early?" },
      { speaker: "learner", en: "We stay together. We've come back before. Just do your job, trust the man next to you, and the scoreboard takes care of itself." },
  ...
  },
  {
    ...
    phrases: [
      { en: "On behalf of the whole club — welcome. We've been looking forward to this tour all season.", intent: "Formal welcome" },
      { en: "The changing rooms are through that door — we've left you plenty of space.", intent: "Orient visitors to the facility" },
      { en: "We've arranged dinner tonight for both squads — it would be great to get to know your team.", intent: "Invite social mixing" },
      { en: "Is there anything your players need — dietary requirements, equipment, extra kit?", intent: "Practical hospitality" },
      { en: "We have a small ceremony before the match — it's our tradition to present a club jersey.", intent: "Explain a pre-match tradition" },
      { en: "We hope you take home a great memory of this place — and a win wouldn't hurt either!", intent: "Lighthearted farewell remark" },
    ],
    vocab: [
      "tour",
      "host club",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Captain — welcome to our club. It's an honor to have you here. How was the travel?" },
      { speaker: "ai", en: "Long flight but we're ready. The boys are very excited. This is our first tour to this country." },
      { speaker: "learner", en: "We want to make sure it's one you remember. Tonight we've got a dinner arranged for both squads — nothing formal, just food and conversation." },
      { speaker: "ai", en: "That's very kind. Our players have been learning about the local culture — they'll have many questions." },
      { speaker: "learner", en: "We love that. We have a tradition before the match — we present a club jersey to your captain. It goes both ways — I hope you'll bring something from your club too." },
      { speaker: "ai", en: "We brought our club flag. We present it at every tour stop — it would be an honor to leave it here." },
    ],
  },
];
...
const rugbyVocabSets: ModuleVocabSet[] = [
  ...
  },
  {
    ...
    emoji: "🏉",
    words: ["third half", "club song", "tour", "hospitality", "cap", "tryline", "jersey swap", "respect"],
  },
];
...
const sportsHobbiesAreas: ModuleArea[] = [
  {
    ...
    emoji: "🏋️",
    blurb:
      "Casual gym talk — asking to work in, getting advice, talking about training routines.",
    ...
    phrases: [
      { en: "Hey — are you using this bench? Can I work in between your sets?", intent: "Ask to share equipment" },
      { en: "How many sets do you have left on the squat rack?", intent: "Politely wait for equipment" },
      { en: "Do you mind giving me a spot on this last set? It's heavy.", intent: "Ask for a spotter" },
      { en: "I've been doing this program for six weeks — my bench has gone up 20 pounds.", intent: "Share training progress" },
      { en: "What does your push-pull-legs split look like?", intent: "Ask about training program" },
      { en: "I'm trying to add more volume — do you think that's a good idea at my stage?", intent: "Seek advice" },
      { en: "That's a solid deadlift — have you been lifting long?", intent: "Give a compliment and start a conversation" },
    ],
    vocab: [
      "rep",
      "set",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Hey — are you still on the squat rack? I don't want to rush you — just trying to plan my workout." },
      { speaker: "ai", en: "Two more sets — probably eight minutes. You're welcome to warm up and jump in right after." },
      { speaker: "learner", en: "Perfect. I appreciate it. Are you following a specific program or just doing your own thing?" },
      { speaker: "ai", en: "I've been running 5/3/1 for about four months. It's been great for strength. You?" },
      { speaker: "learner", en: "I've been doing PPL — trying to add more frequency. I feel like my legs are recovering faster now." },
    ],
  },
  {
    ...
    phrases: [
      { en: "I'm thinking we do the 12-mile loop with the waterfall — it's about 1,500 feet of gain.", intent: "Propose a specific trail" },
      { en: "What's your fitness level right now? I want to pick something that challenges everyone but doesn't destroy anyone.", intent: "Assess group ability diplomatically" },
      { en: "Bring at least two liters of water — the last section has no shade.", intent: "Safety briefing on hydration" },
      { en: "We should leave by 7 AM if we want to summit before the afternoon storms roll in.", intent: "Plan departure time around weather" },
      { en: "I'll share the map link and the parking coordinates tonight.", intent: "Distribute logistics information" },
      { en: "Does anyone have trekking poles? The descent is pretty steep and they really help.", intent: "Gear recommendation" },
      { en: "If someone can't finish, we'll split up — never leave anyone alone on the trail.", intent: "State safety policy" },
    ],
    vocab: [
      "trailhead",
      "elevation gain",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Alright — so here's what I'm thinking. There's a 10-mile trail with about 2,000 feet of climb. Waterfalls, great views at the top, doable in a day." },
      { speaker: "ai", en: "That sounds amazing. But I haven't hiked in like two years — is that going to be too much for me?" },
      { speaker: "learner", en: "Honestly? It's challenging but not extreme. We go at a comfortable pace and take breaks. You'll be tired but you'll make it." },
      { speaker: "ai", en: "What do I need to bring?" },
      { speaker: "learner", en: "Good boots, two liters of water minimum, snacks, a light rain jacket, and sunscreen. I'll bring the first aid kit." },
  ...
  },
  {
    ...
    phrases: [
      { en: "That's a lovely shot — you're on the front of the green with a good look at birdie.", intent: "Compliment a partner's shot" },
      { en: "I'm going to lay up here — the wind is too strong to go for it in two.", intent: "Explain a strategic decision" },
      { en: "Can you confirm — is the red stake a lateral hazard or out of bounds?", intent: "Ask a rules question" },
      { en: "I'll take a provisional — just in case that one went left into the trees.", intent: "Announce a provisional ball" },
      { en: "Nice putt. That break from the right was tricky — I misjudged it completely.", intent: "Compliment and comment on a putt" },
      { en: "Do you want to play a little Nassau? Make the back nine interesting.", intent: "Propose a friendly wager format" },
      { en: "That's good — pick it up. You've already got the hole.", intent: "Concede a short putt" },
    ],
    vocab: [
      "birdie",
      "bogey",
    ...
    sampleConversation: [
      { speaker: "ai", en: "That went straight left — I think it might be in the trees. What should I do?" },
      { speaker: "learner", en: "Hit a provisional before we walk up there. Saves time if it's lost — just announce it out loud." },
      { speaker: "ai", en: "Good idea. Provisional!" },
      { speaker: "learner", en: "Nice. Now let's go find the first one. If it's playable, you pick up the provisional, no harm done." },
      { speaker: "ai", en: "What if I can't find it after a few minutes?" },
      { speaker: "learner", en: "Three minutes is the limit under the rules. After that, it's a lost ball — play the provisional with a one-stroke penalty." },
    ],
  },
  {
    ...
    phrases: [
      { en: "Call it before the shot — you can't call a foul after you miss.", intent: "Dispute a foul call timing" },
      { en: "Ball — I'm open on the wing. Skip it!", intent: "Call for the ball in a clear position" },
    ...
    sampleConversation: [
      ...
      { speaker: "learner", en: "Pickup rules — if you feel contact you can call it. No drama. Your ball at the top." },
      { speaker: "ai", en: "Check. And just so you know — that screen-and-roll you keep running is giving us trouble." },
  ...
  },
  {
    ...
    phrases: [
      ...
      { en: "Good dig! Now set it up — we can attack this.", intent: "Encourage after a defensive touch" },
      { en: "Their setter is tipping on the second contact — watch for that.", intent: "Share a scouting observation mid-game" },
      { en: "Serve to zone five — their passer on the left is struggling tonight.", intent: "Call a serve direction" },
      { en: "Let it go — that's out! Don't touch it!", intent: "Signal a ball is going out of bounds" },
    ],
    vocab: [
      "serve receive",
      "dig",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Zone up — serve is coming to the back row. Sarah, you take zone six, I'll take zone five." },
      { speaker: "ai", en: "Got it. What are you seeing from their server?" },
      { speaker: "learner", en: "She's been going cross-court heavy. Cheat a step right and be ready." },
      { speaker: "ai", en: "Mine! — got it. Setting you middle!" },
      { speaker: "learner", en: "Perfect pass — yes! Now get off the net, rotate and let's close this out!" },
    ],
  },
  {
    ...
    phrases: [
      { en: "Hi — I'm interested in joining your adult softball league. Can you walk me through how it works?", intent: "Initial inquiry" },
      { en: "What skill level is this league? I haven't played in a few years.", intent: "Assess appropriate skill fit" },
      { en: "Are teams formed by the league, or do I need to bring my own group?", intent: "Clarify team formation" },
      { en: "What's the registration fee, and what does it cover?", intent: "Ask about costs" },
      { en: "What night of the week are the games? I need to check my work schedule.", intent: "Confirm scheduling" },
      { en: "Is there a waitlist? I'd like to get on it even if the current season is full.", intent: "Express interest despite availability" },
      { en: "What happens if we don't have enough players one week — do we forfeit?", intent: "Ask about roster rules" },
    ],
    vocab: [
      "registration",
      "roster",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Hi — I saw the flyer for your adult soccer league. I'm interested. Is there still room?" },
      { speaker: "ai", en: "We have two spots left in the Thursday evening division. What's your experience level?" },
      { speaker: "learner", en: "I played in high school and I've done a few pickup games since, but nothing organized in about five years." },
      { speaker: "ai", en: "That's perfect for our intermediate division — it's competitive but very social. Games are 7 PM Thursdays." },
      { speaker: "learner", en: "Great. Is it a full team or would I be placed as a free agent?" },
      { speaker: "ai", en: "We'd place you with a team that needs players. Registration is $75 for the ten-week season, and it includes a jersey." },
    ],
  },
  {
    ...
    phrases: [
      { en: "Great game today — I feel like we're finally clicking as a team.", intent: "Reflect on team progress" },
      { en: "That last play was wild — I still can't believe we pulled it off.", intent: "Relive a memorable moment" },
      { en: "How long have you been playing? You've got a really natural feel for the game.", intent: "Give a genuine compliment and start a conversation" },
      { en: "Same time next week? I'm in for sure.", intent: "Commit to the next activity" },
      { en: "Are you coming to the tournament in April? We should field a full team.", intent: "Coordinate for a future event" },
      { en: "I'm starving — who wants to grab food? There's a great place two blocks away.", intent: "Organize post-activity food" },
    ],
    vocab: [
      "debrief",
      "camaraderie",
    ...
    sampleConversation: [
      { speaker: "learner", en: "Hey — great game. I'm Alex, I just joined the league last week. You've clearly been playing here a while." },
      { speaker: "ai", en: "Ha — yeah, three seasons now. You fit right in though — that play you made in the second half was clutch." },
      { speaker: "learner", en: "Thanks — I wasn't sure it was going to come together but it worked out. Do you guys usually stick around after games?" },
      { speaker: "ai", en: "Most of us go grab food or drinks down the street. You should come — good group of people." },
      { speaker: "learner", en: "I'm in. Give me five minutes to change and I'll walk over with you." },
    ],
  },
];
...
const sportsHobbiesVocabSets: ModuleVocabSet[] = [
  ...
  },
  {
    ...
    emoji: "🌲",
    words: ["trailhead", "elevation", "summit", "switchback", "tee time", "fairway", "birdie", "handicap"],
  },
  {
    category: "Court & Field Sports",
    emoji: "🏀",
    words: ["check ball", "pickup game", "serve receive", "dig", "rotation", "league", "free agent", "forfeit"],
  },
  {
    category: "Social Sports Culture",
    emoji: "🤝",
    words: ["recreational", "club", "tournament", "season", "roster", "third half", "post-game", "social"],
  },
];
...
export function getTeamSportsArea(
  moduleId: string,
  areaId: string
): ModuleArea | null {
