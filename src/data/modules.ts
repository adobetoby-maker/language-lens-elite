...
export const MODULES: AppModule[] = [
  ...
  },
  {
    ...
    emoji: "🦴",
    category: "Medical",
    blurb: "X-ray reads, op notes, patient history, and OR/staff handoff vocabulary.",
    priceCents: 1999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Trades",
    blurb:
      "Hanging, taping, mudding, and finish work — plus bilingual crew supervision and inspection prep.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Trades",
    blurb:
      "Wiring, panel work, code compliance, and bilingual team communication on residential and commercial jobs.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Trades",
    blurb:
      "Lawn care, irrigation, hardscape, and seasonal maintenance — plus crew supervision and client communication.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Trades",
    blurb:
      "Dispatch communication, delivery coordination, DOT compliance, and cross-border logistics.",
    priceCents: 999,
    aiPersona:
  ...
  // ── Agriculture ─────────────────────────────────────────────────────────
  {
    ...
    blurb:
      "Herd management, milking operations, feed coordination, and veterinary communication on the dairy.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Agriculture",
    blurb:
      "Cut specifications, USDA compliance, cold chain communication, and bilingual floor supervision.",
    priceCents: 999,
    aiPersona:
  ...
  // ── Travel ───────────────────────────────────────────────────────────────
  {
    ...
    category: "Travel",
    blurb:
      "Airport navigation, hotel check-in, restaurant ordering, directions, and everyday survival conversations abroad.",
    priceCents: 999,
    aiPersona:
  ...
  // ── Medical (additional) ─────────────────────────────────────────────────
  {
    ...
    category: "Medical",
    blurb:
      "Wellness visits, chronic disease management, preventive care, and whole-family patient communication.",
    priceCents: 1999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Medical",
    blurb:
      "Prenatal care, labor and delivery, gynecologic exams, and sensitive patient communication.",
    priceCents: 1999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Medical",
    blurb:
      "Pain assessment, procedure explanation, medication management, and opioid agreement communication.",
    priceCents: 1999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Medical",
    blurb:
      "EKG interpretation communication, cath lab handoffs, cardiac diagnosis explanation, and heart disease counseling.",
    priceCents: 1999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Medical",
    blurb:
      "Pre-op counseling, OR communication, post-op instruction, and surgical consent conversations.",
    priceCents: 1999,
    aiPersona:
  ...
  // ── Sports ───────────────────────────────────────────────────────────────
  {
    ...
    category: "Sports",
    blurb:
      "On-field communication, coaching, fan culture, and match-day vocabulary in the world's most popular sport.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "Ice and field hockey terminology, locker room communication, play-calling, and fan conversation.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "Dugout communication, pitching signals, game-day banter, and the rich vocabulary of America's pastime.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "Court communication, scoring, doubles coordination, club conversation, and match-day vocabulary.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "Lane etiquette, scoring, league night communication, and equipment conversation at the alley.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "Huddle communication, play-calling, sideline talk, and fan vocabulary for the gridiron.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "Field communication, stick work vocabulary, game strategy, and sideline talk for lacrosse players.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "Scrum calls, lineout coordination, post-match pub talk, and the passionate vocabulary of the rugby pitch.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "General recreational sports, gym talk, outdoor hobbies, and the everyday vocabulary of active leisure.",
    priceCents: 999,
    aiPersona:
  ...
  },
  {
    ...
    category: "Sports",
    blurb:
      "Boat commands, species names, captain-and-mate communication, tipping culture, and travel phrases for sport fishing in Mexico and beyond.",
    priceCents: 999,
    aiPersona:
      "You are a Mexican panga captain or fishing mate depending on the scenario. Use authentic fishing vocabulary — call out strikes, coach the angler on fighting technique, describe the water conditions, name the species, and respond to questions about the fishery naturally in the target language.",
    userRole: "Sport angler fishing with a local guide and crew in Mexico",
    challengePrompts: [
      "Run through the morning debrief with your captain — what conditions are we targeting today?",
      "A marlin just struck on the outrigger — talk your way through the fight.",
      "Teach your fishing partner to identify roosterfish by sight and Spanish name.",
      "Negotiate a fly fishing trip with a local guide who speaks only Spanish.",
      "Describe a catch to a Spanish-speaking marina worker at the dock.",
      "Tip your captain and mate in Spanish with the appropriate cultural gesture.",
      "Ask about the birds, the current, and the best zone to target dorado.",
    ],
    vocabFocus: [
      "panga",
      "captain",
